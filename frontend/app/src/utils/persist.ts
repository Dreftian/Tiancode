...
const GLOBAL_STORAGE = "tiancode.global.dat"
const WINDOW_STORAGE = "tiancode.window"
const LOCAL_PREFIX = "tiancode."
...
function workspaceStorage(dir: string) {
  ...
  return `tiancode.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `tiancode.draft.${head}.${sum}.dat`
}
