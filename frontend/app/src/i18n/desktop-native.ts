...
export const DESKTOP_NATIVE_ENGLISH = {
  "desktop.browser.chromeUnavailable": "Chrome could not be opened. Check that Google Chrome is installed.",
  ...
  "desktop.menu.documentation": "Tiancode Documentation",
  ...
  "desktop.recovery.loadFailed": "Tiancode failed to load",
  "desktop.recovery.terminated": "Tiancode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Tiancode is not responding",
  ...
  "desktop.wsl.error.tiancodeNotInstalled": "Tiancode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Tiancode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
