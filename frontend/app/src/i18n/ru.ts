...
"settings.mcpServers.group.unknown": "Неизвестные",
  ...
  "settings.voices.dictation.hold.title": "Горячая клавиша диктовки с удержанием",
  "settings.voices.dictation.hold.description": "Зажмите в любом месте рабочего стола, чтобы диктовать в позицию курсора",
  "settings.voices.dictation.recordings.title": "Недавние записи",
  "settings.voices.dictation.recordings.description": "Последние 20 записей хранятся на этом устройстве",
  "settings.voices.dictation.toggle.title": "Горячая клавиша переключения диктовки",
  "settings.voices.dictation.toggle.description": "Нажмите один раз в любом месте рабочего стола, чтобы начать диктовку, и ещё раз — чтобы остановить",
