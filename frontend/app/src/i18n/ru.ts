...
"settings.mcpServers.group.unknown": "Неизвестные",
  ...
  "settings.mcpServers.discover.presets.unreal.description": "Управление проектом Unreal Engine (Web Remote Control): открытие редактора, выполнение Python и консольных команд, чтение логов и актёров уровня. Требуется установленная папка unreal-opencode-mcp.",
