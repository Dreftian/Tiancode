...
"settings.mcpServers.group.unknown": "Неизвестные",
  ...
  "welcome.step1.subtitle": "Выберите язык и тему",
  "welcome.step2.subtitle": "Подключите провайдера ИИ",
  "welcome.step3.subtitle": "Выберите рабочую папку",
  "welcome.language.label": "Выберите язык интерфейса",
  "welcome.theme.label": "Цветовой режим",
  "welcome.theme.dark": "Тёмная",
  "welcome.theme.light": "Светлая",
  "welcome.theme.system": "Системная",
  "welcome.provider.title": "Провайдер ИИ",
  "welcome.provider.description": "Чтобы Tiancode отвечал, нужен хотя бы один провайдер моделей. Подключите облачного провайдера или позже запустите локальную модель во вкладке «Локальные модели».",
  "welcome.provider.connect": "Настроить сейчас",
  "welcome.provider.connect.desc": "Откроет настройки провайдеров сразу после завершения",
  "welcome.provider.later": "Сделаю позже",
  "welcome.provider.later.desc": "Сразу перейти в приложение — подключить можно в любой момент из настроек",
  "welcome.workspace.title": "Рабочая папка",
  "welcome.workspace.description": "Tiancode работает внутри папки проекта. Выберите, с чего начать.",
