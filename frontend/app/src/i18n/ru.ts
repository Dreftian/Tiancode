export const dict = {
  ...
  "settings.computerUse.autoApprove": "Разрешить агенту управлять приложениями",
  "settings.computerUse.autoApprove.description": "Автоматически одобрять действия computer use, когда их запрашивает модель",
  "settings.computerUse.autoApprove.note": "Прямое управление приложениями зависит от провайдера модели; Tiancode позволяет автоматически одобрять действия computer use, когда модель их поддерживает.",
  "settings.computerUse.screenshot": "Захват экрана включён: можно снять экран, окно или режим реального времени и прикрепить к разговору.",
...
"settings.mcpServers.group.unknown": "Неизвестные",
  ...
  "prompt.optimize.empty": "Пожалуйста, сначала введите текст",
  "prompt.optimize.optimizing": "Оптимизация ввода...",
  ...
  "settings.intelligence.autoSkill": "Автодистилляция навыков (/learn)",
  "settings.intelligence.autoSkill.desc": "Предлагает автоматически упаковывать удачные сложные сценарии в переиспользуемые файлы SKILL.md.",
  "settings.intelligence.section.codegraph": "Граф кода и AST",
  ...
  "settings.intelligence.monaco": "Просмотр различий Monaco",
  "settings.intelligence.monaco.desc": "Показывает построчное сравнение с подсветкой синтаксиса до применения патчей.",
  "settings.intelligence.section.safety": "Безопасность веба и выполнения",
  "settings.intelligence.cleanWeb": "Чистое извлечение веб-страниц (движок Firecrawl)",
  "settings.intelligence.cleanWeb.desc": "Удаляет скрипты, cookie и меню, превращая страницы в чистый Markdown для LLM.",
  "settings.intelligence.guardrails": "Ограждения и конвейер сокрытия секретов",
  "settings.intelligence.guardrails.desc": "Маскирует пароли, токены и приватные ключи перед отправкой запросов внешним провайдерам.",
  "settings.intelligence.sandbox": "Режим выполнения в песочнице",
