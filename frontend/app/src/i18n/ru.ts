export const dict = {
  ...
  "settings.connections.description": "Подключите Tiancode к Telegram, WhatsApp, Discord, Slack и вебхукам для удаленных оповещений и мобильного взаимодействия.",
  "settings.connections.telegram.title": "Шлюз Telegram Bot",
  "settings.connections.telegram.token": "Bot Token",
  "settings.connections.telegram.tokenMissing": "Введите токен бота Telegram",
  "settings.connections.telegram.testSuccess": "Успешно подключено к Telegram!",
  "settings.connections.telegram.chatId": "Chat ID / Пользователь",
  "settings.connections.telegram.pairing": "Двустороннее сопряжение",
  "settings.connections.telegram.pairingDescription": "Позволяет Tiancode принимать команды и подтверждать действия из Telegram.",
  "settings.connections.telegram.notifyBuilds": "Уведомления о сборке",
  "settings.connections.whatsapp.title": "Шлюз WhatsApp",
  "settings.connections.whatsapp.phone": "Номер WhatsApp / ID",
  "settings.connections.whatsapp.phoneMissing": "Введите номер телефона WhatsApp",
  "settings.connections.whatsapp.pairedSuccess": "Код сопряжения создан",
  "settings.connections.whatsapp.pairingMode": "Способ сопряжения",
  "settings.connections.whatsapp.notifyBuilds": "Уведомления о сборках и тестах",
  "settings.connections.whatsapp.notifyErrors": "Оповещения о критических ошибках",
  "settings.connections.discord.title": "Discord",
  "settings.connections.discord.authMode": "Метод подключения",
  "settings.connections.discord.channel": "Канал оповещений",
  "settings.connections.discord.notifyBuilds": "Уведомления о коммитах и сборках",
  "settings.connections.discord.missingTarget": "Укажите Webhook URL или токен Discord",
  "settings.connections.discord.testSuccess": "Тестовое сообщение отправлено в Discord",
  "settings.connections.slack.title": "Slack",
  "settings.connections.slack.webhook": "Incoming Webhook URL",
  "settings.connections.slack.channel": "Канал по умолчанию",
  "settings.connections.slack.notifyBackground": "Уведомления о фоновых задачах",
  "settings.connections.slack.missingUrl": "Введите URL вебхука Slack",
  "settings.connections.slack.testSuccess": "Вебхук Slack подтвержден",
  ...
  "settings.connections.webhooks.missingUrl": "Введите URL эндпоинта",
  "settings.connections.webhooks.testSuccess": "Тестовый пейлоад отправлен",
