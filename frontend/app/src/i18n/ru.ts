export const dict = {
  ...
  "settings.browser.allowControl": "Разрешить Tiancode управлять встроенным браузером",
  "settings.browser.allowControl.description": "Показывать встроенный браузер в приложении для просмотра приложений и сайтов в реальном времени",
...
"settings.mcpServers.group.unknown": "Неизвестные",
  ...
  "settings.computerUse.tools.description": "Tiancode не может двигать мышь или нажимать клавиши. Он может сделать снимок экрана и прочитать или записать буфер обмена — и только из настольного приложения.",
