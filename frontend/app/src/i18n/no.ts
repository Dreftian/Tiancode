...
export const dict = {
  ...
  "desktop.menu.documentation": "Tiancode-dokumentasjon",
  ...
  "desktop.recovery.loadFailed": "Tiancode kunne ikke lastes inn",
  "desktop.recovery.terminated": "Tiancode-vinduet ble uventet avsluttet",
  ...
  "desktop.wsl.error.installTiancode": "Installasjonen av Tiancode mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.tiancodeMissing": "tiancode er ikke installert i denne distribusjonen",
  "desktop.wsl.error.tiancodeCannotRun": "tiancode er installert, men kunne ikke kjøres",
  "desktop.wsl.error.tiancodeNotInstalled": "Tiancode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Tiancode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.tiancode.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.tiancode.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.tiancodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Tiancode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Tiancode.",
  ...
  "provider.connect.tiancodeZen.line1":
    "Tiancode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.tiancodeZen.visit.prefix": "Besøk ",
  "provider.connect.tiancodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.tiancodeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Tiancode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Tiancode.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i tiancode.json",
  ...
  "dialog.server.description": "Bytt hvilken Tiancode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Tiancode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Tiancode-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (tiancode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Tiancode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Tiancode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Tiancode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Tiancode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Tiancode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Tiancode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Tiancode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Tiancode starter",
  ...
  "settings.updates.toast.latest.title": "Tiancode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Tiancode.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Tiancode...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Tiancode i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Tiancode...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Tiancode i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Tiancode i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Tiancode",
  ...
  "wsl.onboarding.distroStatus.tiancodeMissing": "Tiancode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Tiancode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Tiancode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Tiancode på nytt.",
  ...
  "help.tabs.introduction": "Tiancode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
  ...
  "a11y.closeTab": "Lukk fane",
  "a11y.clearSearch": "Tøm søk",
  "a11y.edit": "Rediger",
  ...
  "chat.message.speak.failed": "Kunne ikke lese svaret høyt",
  "preview.title": "Intern nettleser",
  "preview.open": "Åpne intern nettleser",
  "preview.close": "Lukk nettleser",
  "preview.back": "Tilbake",
  "preview.forward": "Frem",
  "preview.reload": "Last inn på nytt",
  "preview.go": "Gå",
  "preview.url": "Nettadresse",
  "settings.general.row.minimizeToTray.title": "Minimer til systemstatusfeltet",
  "settings.general.row.minimizeToTray.description": "Lukking av vinduet minimerer til systemstatusfeltet i stedet for å avslutte",
  "settings.general.row.fileWatcher.title": "Filoppdateringer i sanntid",
  "settings.general.row.fileWatcher.description": "Oppdaterer filtreet og git-endringer automatisk.",
  "settings.general.fileWatcher.restart.confirm": "Starte Tiancode på nytt for å bruke endringen av filoppdateringer i sanntid?",
  "session.export.button": "Eksporter samtale til Markdown",
  "session.export.title": "Eksporter samtale",
  "session.export.success": "Samtale eksportert",
  "session.export.failed": "Kunne ikke eksportere samtalen",
  "settings.general.section.data": "Data",
  "settings.general.row.autoBackup.title": "Automatisk sikkerhetskopiering",
  "settings.general.row.autoBackup.description": "Daglig kopi av sesjoner og konfigurasjon (bevarer de siste 7 dagene)",
  "settings.general.row.backupNow.title": "Sikkerhetskopier nå",
  "settings.general.row.backupNow.description": "Lag en umiddelbar kopi av dataene dine",
  "settings.general.row.backupNow.button": "Opprett sikkerhetskopi",
  "settings.general.row.restore.title": "Gjenopprett",
  "settings.general.row.restore.description": "Gjenopprett en tidligere sikkerhetskopi (appen starter på nytt)",
  "settings.general.row.restore.button": "Gjenopprett",
  "settings.general.backup.now.success": "Sikkerhetskopi opprettet",
  "settings.general.backup.now.failed": "Det er ennå ingen data å sikkerhetskopiere",
  "settings.general.backup.restore.confirm": "Gjenopprette sikkerhetskopi {name}? Nåværende sesjoner og konfigurasjon vil bli erstattet.",
  "settings.general.backup.restore.success": "Sikkerhetskopi gjenopprettet",
  "settings.general.backup.restore.failed": "Kunne ikke gjenopprette sikkerhetskopien",
  "settings.general.row.loginItem.title": "Start ved pålogging",
  "settings.general.row.loginItem.description": "Åpne Tiancode automatisk når du logger på Windows",
  "settings.section.extensions": "Utvidelser",
  "settings.tab.plugins": "Programtillegg",
  "settings.tab.skills": "Ferdigheter",
  ...
  "settings.skills.description": "Importer ferdigheter fra datamaskinen din, eller last ned publiserte ferdigheter fra nettet.",
  "settings.skills.section.installed": "Installert",
  "settings.skills.autoSelect.title": "Auto-velg ferdigheter",
  "settings.skills.autoSelect.description": "Velg automatisk ferdighetene som matcher prosjektet ditt (rammeverk, verktøy osv.) i hver samtale",
  "settings.skills.section.import": "Importer ferdighet",
  "settings.skills.empty": "Ingen ferdigheter installert ennå",
  "settings.skills.import.folder.title": "Importer fra mappe",
  "settings.skills.import.folder.description": "Velg en ferdighetsmappe som inneholder en SKILL.md-fil",
  "settings.skills.import.folder.button": "Velg mappe",
  "settings.skills.import.url.title": "Last ned fra URL",
  "settings.skills.import.url.description": "Lim inn en URL til en publisert ferdighet for å laste den ned",
  "settings.skills.import.url.placeholder": "https://example.com/skills/my-skill",
  "settings.skills.import.url.button": "Last ned",
  "settings.skills.search.google": "Søk etter publiserte ferdigheter på Google",
  "settings.skills.importing": "Importerer...",
  "settings.skills.import.success": "Ferdighet importert",
  "settings.skills.import.failed": "Import av ferdighet mislyktes",
  "settings.subAgents.title": "Underagenter",
  "settings.subAgents.description": "Opprett dine egne underagenter som hovedagenten kan delegere til.",
  "settings.subAgents.list.new": "Ny underagent",
  "settings.subAgents.list.search.placeholder": "Søk etter underagenter",
  "settings.subAgents.list.search.clear": "Tøm søk",
  "settings.subAgents.list.filter.all": "Alle",
  "settings.subAgents.list.filter.enabled": "Aktivert",
  "settings.subAgents.list.filter.disabled": "Deaktivert",
  "settings.subAgents.list.group.user": "Brukerunderagenter",
  "settings.subAgents.list.group.builtin": "Innebygde underagenter",
  "settings.subAgents.list.builtin.hint": "kan ikke redigeres her",
  "settings.subAgents.list.empty": "Ingen underagenter funnet",
  "settings.subAgents.list.footer": "{{count}} underagenter · {{enabled}} aktivert",
  "settings.subAgents.list.model.inherit": "arv",
  "settings.subAgents.list.tools.all": "Alle verktøy",
  "settings.subAgents.list.tools.summary": "{{count}} verktøy",
  "settings.subAgents.list.edit": "Rediger underagent",
  "settings.subAgents.list.delete": "Slett underagent",
  ...
  "settings.subAgents.form.field.color": "Farge",
  "settings.subAgents.form.color.yellow": "Gul",
  "settings.subAgents.form.color.red": "Rød",
  "settings.subAgents.form.color.orange": "Oransje",
  "settings.subAgents.form.color.green": "Grønn",
  ...
  "settings.subAgents.form.model.custom": "Egendefinert...",
  "settings.subAgents.form.field.description": "Beskrivelse",
  "settings.subAgents.form.field.description.placeholder": "Kort beskrivelse som vises til modellen",
  "settings.subAgents.form.field.tools": "Tillatte verktøy",
  "settings.subAgents.form.tools.all": "Alle tillatelser som standard",
  "settings.subAgents.form.tools.custom": "Egendefinerte tillatte verktøy",
  "settings.subAgents.form.tools.sensitive": "sensitiv",
  ...
  "settings.subAgents.form.field.prompt.placeholder": "Beskriv denne underagentens rolle og regler...",
  "settings.subAgents.form.field.injectAgentsMd": "Injiser AGENTS.md",
  "settings.subAgents.form.field.injectAgentsMd.description": "Inkluder AGENTS.md-filen fra arbeidsområdet i denne underagentens kontekst",
  "settings.subAgents.form.workspace.unsupported": "Oppretting eller redigering på arbeidsområdenivå støttes ikke",
  "settings.subAgents.form.save": "Lagre",
  "settings.subAgents.form.saving": "Lagrer...",
  "settings.subAgents.form.cancel": "Avbryt",
  "settings.subAgents.form.delete": "Slett",
  "settings.subAgents.form.delete.confirm": "Slette underagent \"{{name}}\"?",
  "settings.subAgents.form.success": "Underagent opprettet",
  "settings.subAgents.form.failed": "Oppretting av underagent mislyktes",
  "settings.subAgents.form.updated": "Underagent oppdatert",
  "settings.subAgents.form.updateFailed": "Oppdatering av underagent mislyktes",
  "settings.subAgents.form.deleted": "Underagent slettet",
  "settings.subAgents.form.deleteFailed": "Sletting av underagent mislyktes",
  "settings.subAgents.native.build": "Standardagenten. Utfører verktøy basert på konfigurerte tillatelser.",
  "settings.subAgents.native.plan": "Planmodus. Forbyr alle redigeringsverktøy.",
  "settings.subAgents.native.general": "Allmenn agent for å undersøke komplekse spørsmål og utføre oppgaver i flere trinn.",
  "settings.subAgents.native.explore": "Rask agent spesialisert på å utforske kodebaser og finne filer.",
  "settings.subAgents.native.compaction": "Intern agent for å komprimere sesjonshistorikk.",
  "settings.subAgents.native.title": "Intern agent for å generere samtaletitler.",
  "settings.subAgents.native.summary": "Intern agent for å oppsummere sesjoner.",
  "settings.plugins.title": "Programtillegg",
  "settings.plugins.description": "Utvid agenten med npm-pakker eller lokale plugin-filer som kobler seg på livssyklushendelser.",
  "settings.plugins.note.title": "Hva er et programtillegg?",
  "settings.plugins.note.description": "Programtillegg kjører inne i agentprosessen og reagerer på livssyklushendelser som sesjonsinaktivitet, verktøyutførelse og oppsett av shell-miljø.",
  "settings.plugins.section.installed": "Installert",
  "settings.plugins.section.add": "Legg til programtillegg",
  "settings.plugins.empty": "Ingen programtillegg installert ennå",
  ...
  "settings.plugins.add.button": "Legg til",
  "settings.plugins.add.success": "Programtillegg lagt til",
  "settings.plugins.add.failed": "Kunne ikke legge til programtillegg",
  "settings.plugins.remove": "Fjern",
  "settings.plugins.remove.confirm": "Fjerne programtillegg \"{{name}}\"?",
  "settings.plugins.remove.success": "Programtillegg fjernet",
  "settings.plugins.remove.failed": "Fjerning av programtillegg mislyktes",
  "settings.plugins.origin.npm": "npm · krever Tian-konvensjon",
  "settings.plugins.origin.local": "lokal",
  "settings.plugins.catalog.npm.title": "Populære npm-apper",
  "settings.plugins.catalog.npm.description": "Verifiserte pakker som følger Tians plugin-konvensjon.",
  "settings.plugins.catalog.npm.note": "npm-pakker må implementere Tians plugin-konvensjon",
  "settings.plugins.catalog.local.title": "Lokale programtillegg",
  "settings.plugins.catalog.local.description": "Programtillegg som leveres med dette repositoryet under .tiancode/plugins.",
  "settings.plugins.catalog.add": "Legg til",
  "settings.plugins.catalog.installed": "Installert",
  "settings.plugins.catalog.npm.biome.description": "Rask linter og formater for JavaScript og TypeScript.",
  "settings.plugins.catalog.npm.playwrightMcp.description": "Nettleserautomatisering og E2E-testing av webapplikasjoner.",
  "settings.plugins.catalog.npm.octokitRest.description": "GitHub API-klient for pull requests, issues og repositories.",
  "settings.plugins.catalog.npm.slackWebApi.description": "Offisiell Slack Web API-klient for meldinger og samtaler.",
  "settings.plugins.catalog.npm.notionClient.description": "Offisiell Notion API-klient for sider, databaser og blokker.",
  "settings.plugins.catalog.npm.sentryCli.description": "Sentry-feilovervåking, releases og opplasting av source maps.",
  "settings.plugins.catalog.npm.agentNotify.description": "Sender varsler når agentoppgaver fullføres eller mislykkes.",
  "settings.plugins.catalog.npm.chimeClaude.description": "Telegram-varsler om agentens livssyklushendelser.",
  "settings.plugins.catalog.local.envGuard.description": "Beskytter .env-filer mot utilsiktede redigeringer.",
  "settings.plugins.catalog.local.commitHelper.description": "Hjelper med å utforme konvensjonelle commit-meldinger.",
  "settings.plugins.catalog.local.notifyIdle.description": "Varsler deg når en sesjon blir inaktiv.",
  "settings.plugins.catalog.local.shellEnv.description": "Injiserer miljøvariabler i shell-verktøyprosesser.",
  "settings.plugins.catalog.local.permissionGuard.description": "Blokkerer risikable verktøykall som krever eksplisitt godkjenning.",
  "settings.plugins.template.title": "Nytt programtillegg",
  "settings.plugins.template.description": "Genererer et plugin-skrelett med de vanligste livssyklus-hookene. Kopier det inn i en fil og legg det til ovenfor.",
  "settings.plugins.template.copy": "Kopier",
  "settings.plugins.template.copied": "Mal kopiert til utklippstavlen",
  "settings.mcpServers.title": "MCP-servere",
  "settings.mcpServers.description": "Koble agenten til eksterne verktøy gjennom Model Context Protocol (MCP)-servere.",
  "settings.mcpServers.section.servers": "Servere",
  "settings.mcpServers.section.add": "Legg til server",
  "settings.mcpServers.edit.title": "Rediger server",
  "settings.mcpServers.empty": "Ingen MCP-servere konfigurert ennå",
  "settings.mcpServers.add.button": "Legg til server",
  "settings.mcpServers.save.button": "Lagre",
  "settings.mcpServers.cancel.button": "Avbryt",
  "settings.mcpServers.saving": "Lagrer...",
  ...
  "settings.mcpServers.type.remote": "Ekstern (HTTP/SSE)",
  ...
  "settings.mcpServers.field.command.hint": "Tips: npx, uvx, node eller cmd /c npx på Windows",
  "settings.mcpServers.field.environment": "Miljø (KEY=VALUE per linje)",
  "settings.mcpServers.field.environment.placeholder": "API_KEY=sk-...",
  "settings.mcpServers.field.cwd": "Arbeidsmappe (valgfritt)",
  "settings.mcpServers.field.timeout": "Timeout i sekunder (valgfritt)",
  "settings.mcpServers.field.url": "URL",
  "settings.mcpServers.field.url.placeholder": "https://example.com/mcp",
  "settings.mcpServers.field.headers": "Headere (KEY=VALUE per linje)",
  "settings.mcpServers.field.oauth": "OAuth",
  "settings.mcpServers.presets.title": "Forhåndsinnstillinger",
  ...
  "settings.mcpServers.presets.sequentialThinking": "Sekvensiell tenkning",
  ...
  "settings.mcpServers.status.connected": "Tilkoblet",
  "settings.mcpServers.status.disabled": "Deaktivert",
  "settings.mcpServers.status.failed": "Feil",
  "settings.mcpServers.status.needs_auth": "Krever pålogging",
  "settings.mcpServers.status.needs_client_registration": "Krever registrering",
  "settings.mcpServers.status.unknown": "Ukjent",
  "settings.mcpServers.action.connect": "Koble til",
  "settings.mcpServers.action.disconnect": "Koble fra",
  ...
  "settings.mcpServers.remove.confirm": "Fjerne server \"{{name}}\"?",
  "settings.mcpServers.add.success": "Server lagret",
  "settings.mcpServers.add.failed": "Lagring av server mislyktes",
  "settings.mcpServers.export.success": "Konfigurasjon kopiert til utklippstavlen",
  "settings.mcpServers.export.failed": "Kopiering av konfigurasjon mislyktes",
  "settings.mcpServers.search.placeholder": "Søk etter servere...",
  "settings.mcpServers.search.empty": "Ingen servere samsvarer med søket ditt",
  "settings.mcpServers.group.connected": "Tilkoblet",
  "settings.mcpServers.group.errors": "Feil",
  "settings.mcpServers.group.disabled": "Deaktivert",
  "settings.mcpServers.group.unknown": "Ukjent",
  "settings.mcpServers.tools.count": "{{count}} verktøy",
  "settings.mcpServers.save.changes": "Lagre endringer",
  "settings.mcpServers.discover.title": "Oppdag",
  "settings.mcpServers.discover.description": "Populære MCP-servere du kan legge til med ett klikk.",
  "settings.mcpServers.discover.requiresKey": "Krever API-nøkkel — rediger etter tilføying",
  "settings.mcpServers.discover.presets.android-emulator.name": "Android Emulator",
  "settings.mcpServers.discover.presets.android-emulator.description": "Kontroller Android-emulatorer, skjermer og apper fra agenten.",
  "settings.mcpServers.discover.presets.node-repl.name": "Node REPL",
  "settings.mcpServers.discover.presets.node-repl.description": "Kjør JavaScript i en Node.js REPL-økt.",
  "settings.mcpServers.discover.presets.ios-simulator.name": "iOS Simulator",
  "settings.mcpServers.discover.presets.ios-simulator.description": "Styr iOS-simulatoren og appene dens (krever Xcode).",
  "settings.mcpServers.discover.presets.chrome-devtools.name": "Chrome DevTools",
  "settings.mcpServers.discover.presets.chrome-devtools.description": "Inspiser, feilsøk og automatiser Chrome-sider.",
  "settings.mcpServers.discover.presets.playwright.name": "Playwright",
  "settings.mcpServers.discover.presets.playwright.description": "Nettleserautomatisering og ende-til-ende-webtesting.",
  "settings.mcpServers.discover.presets.context7.name": "Context7",
  "settings.mcpServers.discover.presets.context7.description": "Oppdatert dokumentasjon for populære biblioteker og rammeverk.",
  "settings.mcpServers.discover.presets.agent-vision.name": "Agent Vision",
  "settings.mcpServers.discover.presets.agent-vision.description": "Gir modeller uten visjon øyne: analyser bilder, skjermbilder og dokumenter (OCR) med en hvilken som helst OpenAI-kompatibel visjons-API (OpenAI, Gemini, Qwen-VL). Legg til VISION_API_KEY under Miljø i servereditoren etter aktivering.",
  "capture.menu.title": "Ta skjermbilde",
  "capture.screen": "Hele skjermen",
  "capture.window": "App-vindu",
  "capture.area": "Velg område…",
  "capture.preview": "Intern nettleser",
  "capture.area.title": "Velg området som skal fanges (Enter for å bekrefte, Esc for å avbryte)",
  "capture.area.cancel": "Avbryt",
  "capture.area.confirm": "Fang område",
  "settings.mcpServers.discover.presets.aikido.name": "Aikido",
  "settings.mcpServers.discover.presets.aikido.description": "Skann kode og avhengigheter for sikkerhetsproblemer.",
  "settings.mcpServers.discover.presets.airwallex.name": "Airwallex",
  "settings.mcpServers.discover.presets.airwallex.description": "API-er for betalinger, treasury og kortutstedelse.",
  "settings.mcpServers.discover.presets.canva.name": "Canva",
  "settings.mcpServers.discover.presets.canva.description": "Opprett og rediger Canva-design (OAuth).",
  "settings.mcpServers.discover.presets.circle.name": "Circle",
  "settings.mcpServers.discover.presets.circle.description": "USDC-betalinger og utviklerstyrte lommebøker.",
  "settings.mcpServers.discover.presets.appwrite.name": "Appwrite",
  "settings.mcpServers.discover.presets.appwrite.description": "Autentisering, databaser og lagring for appene dine (OAuth).",
  "settings.mcpServers.discover.presets.apollo.name": "Apollo",
  "settings.mcpServers.discover.presets.apollo.description": "Spør ditt Apollo GraphOS-graf (OAuth).",
  "settings.mcpServers.discover.presets.graphos-tools.name": "GraphOS Tools",
  "settings.mcpServers.discover.presets.graphos-tools.description": "Administrer Apollo GraphOS-arbeidsområder og -skjemaer.",
  "settings.mcpServers.discover.presets.atlan.name": "Atlan",
  "settings.mcpServers.discover.presets.atlan.description": "Søk i datakatalogen din og governance-aktiva (OAuth).",
  "settings.mcpServers.discover.presets.awsknowledge.name": "AWS Knowledge",
  "settings.mcpServers.discover.presets.awsknowledge.description": "AWS-dokumentasjon og kunnskapsbase for tjenester.",
  "settings.github.title": "Github",
  "settings.github.description": "Koble til GitHub-kontoen din for å klone repositories, opprette nye og kjøre git-operasjoner på prosjektene dine.",
  "settings.github.loading": "Laster...",
  "settings.github.connect.title": "Koble til GitHub",
  "settings.github.connect.description": "Lim inn en personal access token for å autentisere mot GitHub. Token-en lagres lokalt og brukes til kloning og autentiserte git-operasjoner.",
  "settings.github.connect.token.placeholder": "github_pat_... eller ghp_...",
  "settings.github.connect.hint": "Opprett en token på github.com/settings/tokens (fine-grained med repo-omfang)",
  "settings.github.connect.button": "Koble til",
  "settings.github.connecting": "Kobler til...",
  "settings.github.connect.success": "GitHub-konto tilkoblet",
  "settings.github.connect.failed": "Tilkobling til GitHub mislyktes. Sjekk token-en og prøv igjen.",
  "settings.github.connected.title": "Tilkoblet som",
  "settings.github.disconnect.button": "Koble fra",
  "settings.github.disconnect.confirm": "Koble fra GitHub-kontoen din? Den lagrede token-en vil bli fjernet.",
  "settings.github.disconnect.success": "GitHub-konto frakoblet",
  "settings.github.disconnect.failed": "Frakobling fra GitHub mislyktes",
  "settings.github.refresh": "Oppdater",
  "settings.github.repos.title": "Repositories",
  "settings.github.repos.search.placeholder": "Søk i dine repositories...",
  "settings.github.repos.empty": "Ingen repositories funnet",
  ...
  "settings.github.repo.clone.failed": "Kloning av repository mislyktes",
  "settings.github.create.title": "Opprett repository",
  ...
  "settings.github.create.button": "Opprett",
  "settings.github.create.success": "Repository opprettet",
  "settings.github.create.failed": "Oppretting av repository mislyktes",
  "settings.github.project.title": "Nåværende prosjekt",
  "settings.github.project.noRemote": "Dette prosjektet har ennå ingen git remote — opprett et repository på GitHub og legg til remoten.",
  "settings.github.commit.placeholder": "Commit-melding...",
  "settings.github.commit.button": "Commit",
  "settings.github.commit.success": "Committet",
  "settings.github.commit.failed": "Commit mislyktes",
  "settings.github.push.button": "Push",
  "settings.github.push.success": "Pushet",
  "settings.github.push.failed": "Push mislyktes",
  "settings.github.pull.button": "Pull",
  "settings.github.pull.success": "Pull-et",
  "settings.github.pull.failed": "Pull mislyktes",
  "settings.voices.title": "Stemmer",
  "settings.voices.description": "Velg en stemme for å lese assistentens svar høyt, og test den gratis stemmemodellen.",
  "settings.voices.desktopOnly": "Stemmer er tilgjengelige i desktop-appen.",
  "settings.voices.loading": "Laster...",
  "settings.voices.download.title": "Stemmemodell ikke installert",
  "settings.voices.download.description": "Last ned den gratis kokoro-stemmemodellen (~325MB) for å syntetisere tale på datamaskinen. Stemmer forlater aldri enheten din.",
  "settings.voices.download.button": "Last ned stemmemodell",
  "settings.voices.download.downloading": "Laster ned stemmemodell...",
  "settings.voices.download.progress": "Laster ned {{file}}",
  "settings.voices.download.failed": "Nedlasting av stemmemodellen mislyktes",
  "settings.voices.ready.title": "Velg en stemme",
  "settings.voices.voices.empty": "Ingen stemmer tilgjengelige",
  "settings.voices.voice.probe": "Test",
  "settings.voices.voice.speaking": "Stopp",
  "settings.voices.voice.probe.failed": "Avspilling av denne stemmen mislyktes",
  "settings.voices.voice.unsupported": "Kun engelsk",
  "settings.voices.select.title": "Aktiv stemme",
  "settings.voices.autoSpeak.title": "Les svar høyt",
  "settings.voices.autoSpeak.description": "Leser modellens svar høyt i sanntid mens det genereres, med den valgte stemmen.",
  "settings.voices.gender.female": "Kvinne",
  "settings.voices.gender.male": "Mann",
  "settings.voices.filter.all": "Alle",
  "settings.voices.filter.female": "Kvinne",
  "settings.voices.filter.male": "Mann",
  "settings.voices.filter.spanish": "Spansk",
  "settings.voices.pagination.prev": "Forrige",
  "settings.voices.pagination.next": "Neste",
  "settings.voices.pagination.page": "Side {{current}} av {{total}}",
  "settings.voices.voice.info": "Stemmedetaljer",
  "settings.voices.voice.download": "Last ned",
  "settings.voices.voice.downloading": "Laster ned…",
  "settings.voices.voice.delete": "Slett",
  "settings.voices.voice.delete.confirm": "Slette de nedlastede filene for {{name}}?",
  "settings.voices.voice.builtin": "Innebygd",
  "settings.voices.voice.engine.kokoro": "Kokoro",
  "settings.voices.voice.engine.piper": "Piper",
  "settings.voices.voice.license": "Lisens",
  "settings.voices.voice.enabled": "Aktivert",
  "settings.voices.voice.size": "{{size}} MB",
  "settings.voices.voice.download.success": "Stemme lastet ned",
  "settings.voices.voice.download.failed": "Nedlasting av stemme mislyktes",
  "settings.voices.voice.delete.success": "Stemme slettet",
  "settings.voices.voice.delete.failed": "Sletting av stemme mislyktes",
  "settings.tab.modelsHub": "Lokale modeller",
  "settings.modelsHub.title": "Lokale modeller",
  "settings.modelsHub.description": "Søk og last ned GGUF-modeller fra HuggingFace for å kjøre AI lokalt, som LM Studio.",
  "settings.modelsHub.search.placeholder": "Søk etter modeller... f.eks. llama 3.2",
  "settings.modelsHub.search.button": "Søk",
  "settings.modelsHub.empty": "Ingen modeller funnet. Prøv et annet søk.",
  "settings.modelsHub.download": "Last ned",
  "settings.modelsHub.download.downloading": "Laster ned",
  "settings.modelsHub.download.paused": "Pauset",
  "settings.modelsHub.download.resume": "Fortsett",
  "settings.modelsHub.download.delete": "Slett",
  "settings.modelsHub.download.completed": "Fullført",
  "settings.modelsHub.download.failed": "Mislyktes",
  "settings.modelsHub.downloads.title": "Nedlastinger",
  "settings.modelsHub.recommended": "Anbefalt",
  "settings.modelsHub.detail.files": "Filer",
  "settings.modelsHub.runtime.title": "Runtime",
  "settings.modelsHub.runtime.description": "Lokale inferens-runtimes oppdaget på denne maskinen.",
  "settings.modelsHub.runtime.available": "Tilgjengelig",
  "settings.modelsHub.runtime.notDetected": "Ikke oppdaget",
  "settings.modelsHub.provider.setup": "Sett opp som provider",
  "settings.modelsHub.provider.ready": "Lokal provider klar (modell: {name})",
  "settings.modelsHub.provider.failed": "Kunne ikke sette opp den lokale provideren",
  "settings.modelsHub.recommended.title": "Anbefalt modell for GPU-en din",
  "settings.modelsHub.recommended.forYourGpu": "basert på oppdaget VRAM",
  "settings.modelsHub.recommended.download": "Last ned",
  "settings.modelsHub.runtime.hint": "Kjør lokale modeller gjennom Ollama eller LM Studio og legg dem til som provider under Providers.",
  "settings.modelsHub.runtime.install": "Installer",
  "settings.modelsHub.runtime.install.downloading": "Laster ned",
  "settings.modelsHub.runtime.install.installing": "Installerer…",
  "settings.modelsHub.runtime.install.success": "{{name}} installert. Åpne appen én gang for å fullføre oppsettet.",
  "settings.modelsHub.runtime.install.failed": "Installasjon av runtime mislyktes",
  "settings.modelsHub.system.ram": "RAM",
  "settings.modelsHub.system.vram": "GPU-minne (VRAM)",
  "settings.modelsHub.system.vramFree": "ledig:",
  "settings.modelsHub.memory.title": "Minnemodus",
  "settings.modelsHub.memory.gpu": "Bruk GPU-minne (VRAM) som primært",
  "settings.modelsHub.memory.ram": "Bruk system-RAM som reserve",
  "settings.modelsHub.system.dir": "Modellmappe",
  "settings.modelsHub.system.disk": "Ledig diskplass",
  "settings.modelsHub.system.gpu": "GPU",
  "settings.modelsHub.system.cpu": "CPU",
  "settings.modelsHub.fit.fullGpu": "Full GPU-offload mulig",
  "settings.modelsHub.fit.partialGpu": "Delvis GPU-offload mulig",
  "settings.modelsHub.fit.ramOnly": "Passer uten GPU",
  "settings.modelsHub.fit.noFit": "Vil ikke passe",
  "settings.modelsHub.desc.text-generation": "Tekstgenerering",
  "settings.modelsHub.desc.image-text-to-text": "Visjon",
  "settings.modelsHub.desc.text-to-image": "Bildegenerering",
  "settings.modelsHub.desc.image-to-image": "Bilderedigering",
  "settings.modelsHub.desc.image-classification": "Bildeklassifisering",
  "settings.modelsHub.desc.token-classification": "Token-klassifisering",
  "settings.modelsHub.desc.text-classification": "Tekstklassifisering",
  "settings.modelsHub.desc.question-answering": "Spørsmål og svar",
  "settings.modelsHub.desc.summarization": "Oppsummering",
  "settings.modelsHub.desc.translation": "Oversettelse",
  "settings.modelsHub.desc.fill-mask": "Fill-mask",
  "settings.modelsHub.desc.feature-extraction": "Feature-ekstraksjon",
  "settings.modelsHub.desc.automatic-speech-recognition": "Talegjenkjenning",
  ...
  "settings.modelsHub.desc.object-detection": "Objektdeteksjon",
  ...
  "onboarding.step": "Trinn {{current}} av {{total}}",
  "onboarding.disclaimer.p1": "Tiancode er en AI-agent som jobber sammen med deg: den kan kjøre kommandoer, redigere filer og administrere oppgaver på datamaskinen din mens du beholder kontrollen.",
  "onboarding.disclaimer.p2": "Promptene dine og filinnhold kan bli sendt til AI-modellleverandørene du konfigurerer for å generere svar.",
  "onboarding.disclaimer.p3": "Du er ansvarlig for hvordan du bruker Tiancode. Gå gjennom endringer nøye før du godtar dem, og kjør aldri kommandoer du ikke forstår.",
  "onboarding.accept": "Godta og fortsett",
  "onboarding.preferences.title": "Gjør den til din",
  "onboarding.preferences.description": "Velg hvordan Tiancode ser ut og snakker til deg. Du kan endre dette når som helst i Innstillinger.",
  ...
  "onboarding.start": "Begynn å bruke Tiancode",
