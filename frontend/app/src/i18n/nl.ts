export const dict = {
  ...
  "desktop.menu.documentation": "Tiancode-documentatie",
  ...
  "desktop.recovery.loadFailed": "Tiancode kan niet worden geladen",
  "desktop.recovery.terminated": "Het Tiancode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Tiancode reageert niet",
  ...
  "desktop.wsl.error.installTiancode": "Installatie van Tiancode is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.tiancodeMissing": "tiancode is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.tiancodeCannotRun": "tiancode is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.tiancodeNotInstalled": "Tiancode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Tiancode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.tiancode.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.tiancode.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.tiancodeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Tiancode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Tiancode te gebruiken.",
  ...
  "provider.connect.tiancodeZen.line1":
    "Tiancode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.tiancodeZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.tiancodeZen.visit.prefix": "Ga naar ",
  "provider.connect.tiancodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.tiancodeZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Tiancode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Tiancode te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in tiancode.json",
  ...
  "dialog.server.description": "Wijzig met welke Tiancode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Tiancode controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Tiancode controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Tiancode bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Tiancode bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Tiancode bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Tiancode bijwerken",
  "wsl.onboarding.tiancodeReadyIn": "Tiancode is gereed in {{distro}}.",
  "wsl.onboarding.tiancodeReady": "Tiancode is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Tiancode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Tiancode",
  ...
  "wsl.onboarding.distroStatus.tiancodeMissing": "Tiancode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Tiancode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Tiancode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Tiancode opnieuw.",
  ...
  "help.tabs.introduction": "Tiancode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Tiancode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Tiancode-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (tiancode.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Tiancode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Tiancode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Tiancode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Tiancode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Tiancode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Tiancode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Tiancode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Tiancode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Tiancode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Tiancode.",
  ...
  "a11y.closeTab": "Tabblad sluiten",
  "a11y.clearSearch": "Zoekopdracht wissen",
  "a11y.edit": "Bewerken",
  "chat.mic.start": "Dicteren met microfoon",
  ...
  "chat.message.speak.failed": "Het antwoord kon niet worden voorgelezen",
  "preview.title": "Interne browser",
  "preview.open": "Interne browser openen",
  "preview.close": "Browser sluiten",
  "preview.back": "Terug",
  "preview.forward": "Vooruit",
  "preview.reload": "Vernieuwen",
  "preview.go": "Ga",
  "preview.url": "Webadres",
  "settings.general.row.minimizeToTray.title": "Minimaliseren naar systeemvak",
  "settings.general.row.minimizeToTray.description": "Het sluiten van het venster minimaliseert de app naar het systeemvak in plaats van af te sluiten",
  "settings.general.row.fileWatcher.title": "Realtime bestandsupdates",
  "settings.general.row.fileWatcher.description": "Vernieuwt automatisch de bestandsstructuur en git-wijzigingen.",
  "settings.general.fileWatcher.restart.confirm": "Tiancode opnieuw starten om de wijziging voor realtime bestandsupdates toe te passen?",
  "session.export.button": "Conversatie exporteren naar Markdown",
  "session.export.title": "Conversatie exporteren",
  "session.export.success": "Conversatie geëxporteerd",
  "session.export.failed": "De conversatie kon niet worden geëxporteerd",
  "settings.general.section.data": "Gegevens",
  "settings.general.row.autoBackup.title": "Automatische back-up",
  "settings.general.row.autoBackup.description": "Dagelijkse kopie van sessies en configuratie (bewaart de laatste 7 dagen)",
  "settings.general.row.backupNow.title": "Nu back-up maken",
  "settings.general.row.backupNow.description": "Maak direct een kopie van je gegevens",
  "settings.general.row.backupNow.button": "Back-up maken",
  "settings.general.row.restore.title": "Herstellen",
  "settings.general.row.restore.description": "Een eerdere back-up herstellen (de app wordt opnieuw gestart)",
  "settings.general.row.restore.button": "Herstellen",
  "settings.general.backup.now.success": "Back-up gemaakt",
  "settings.general.backup.now.failed": "Nog geen gegevens om een back-up van te maken",
  "settings.general.backup.restore.confirm": "Back-up {name} herstellen? Huidige sessies en configuratie worden vervangen.",
  "settings.general.backup.restore.success": "Back-up hersteld",
  "settings.general.backup.restore.failed": "De back-up kon niet worden hersteld",
  "settings.general.row.loginItem.title": "Starten bij aanmelden",
  "settings.general.row.loginItem.description": "Tiancode automatisch openen wanneer je bij Windows aanmeldt",
  "settings.section.extensions": "Extensies",
  "settings.tab.plugins": "Plugins",
  "settings.tab.skills": "Vaardigheden",
  "settings.tab.subAgents": "Subagents",
  "settings.tab.mcpServers": "MCP-servers",
  "settings.tab.github": "GitHub",
  "settings.tab.voices": "Stemmen",
  "settings.skills.title": "Vaardigheden",
  "settings.skills.description": "Importeer vaardigheden van je computer of download gepubliceerde vaardigheden van het web.",
  "settings.skills.section.installed": "Geïnstalleerd",
  "settings.skills.autoSelect.title": "Vaardigheden automatisch selecteren",
  "settings.skills.autoSelect.description": "Selecteer automatisch de vaardigheden die bij je project passen (framework, tooling enz.) in elke conversatie",
  "settings.skills.section.import": "Vaardigheid importeren",
  "settings.skills.empty": "Nog geen vaardigheden geïnstalleerd",
  "settings.skills.import.folder.title": "Importeren uit map",
  "settings.skills.import.folder.description": "Selecteer een vaardigheidsmap met een SKILL.md-bestand",
  "settings.skills.import.folder.button": "Map kiezen",
  "settings.skills.import.url.title": "Downloaden vanaf URL",
  "settings.skills.import.url.description": "Plak de URL van een gepubliceerde vaardigheid om deze te downloaden",
  "settings.skills.import.url.placeholder": "https://example.com/skills/my-skill",
  "settings.skills.import.url.button": "Downloaden",
  "settings.skills.search.google": "Gepubliceerde vaardigheden zoeken op Google",
  "settings.skills.importing": "Importeren...",
  "settings.skills.import.success": "Vaardigheid geïmporteerd",
  "settings.skills.import.failed": "De vaardigheid kon niet worden geïmporteerd",
  "settings.subAgents.title": "Subagents",
  "settings.subAgents.description": "Maak je eigen subagents waar de hoofdagent taken aan kan delegeren.",
  "settings.subAgents.list.new": "Nieuwe subagent",
  "settings.subAgents.list.search.placeholder": "Subagents zoeken",
  "settings.subAgents.list.search.clear": "Zoekopdracht wissen",
  "settings.subAgents.list.filter.all": "Alle",
  "settings.subAgents.list.filter.enabled": "Ingeschakeld",
  "settings.subAgents.list.filter.disabled": "Uitgeschakeld",
  "settings.subAgents.list.group.user": "Gebruikerssubagents",
  "settings.subAgents.list.group.builtin": "Ingebouwde subagents",
  "settings.subAgents.list.builtin.hint": "hier niet bewerkbaar",
  "settings.subAgents.list.empty": "Geen subagents gevonden",
  "settings.subAgents.list.footer": "{{count}} subagents · {{enabled}} ingeschakeld",
  "settings.subAgents.list.model.inherit": "overerven",
  "settings.subAgents.list.tools.all": "Alle tools",
  "settings.subAgents.list.tools.summary": "{{count}} tools",
  "settings.subAgents.list.edit": "Subagent bewerken",
  "settings.subAgents.list.delete": "Subagent verwijderen",
  "settings.subAgents.form.new.title": "Nieuwe subagent",
  "settings.subAgents.form.edit.title": "{{name}} bewerken",
  "settings.subAgents.form.field.name": "Naam",
  "settings.subAgents.form.field.name.placeholder": "code-reviewer",
  "settings.subAgents.form.field.color": "Kleur",
  "settings.subAgents.form.color.yellow": "Geel",
  "settings.subAgents.form.color.red": "Rood",
  "settings.subAgents.form.color.orange": "Oranje",
  "settings.subAgents.form.color.green": "Groen",
  "settings.subAgents.form.color.cyan": "Cyaan",
  "settings.subAgents.form.color.blue": "Blauw",
  "settings.subAgents.form.color.purple": "Paars",
  "settings.subAgents.form.color.pink": "Roze",
  "settings.subAgents.form.field.model": "Model",
  "settings.subAgents.form.field.model.placeholder": "provider/model",
  "settings.subAgents.form.model.inherit": "overerven",
  "settings.subAgents.form.model.custom": "Aangepast...",
  "settings.subAgents.form.field.description": "Beschrijving",
  "settings.subAgents.form.field.description.placeholder": "Korte beschrijving die aan het model wordt getoond",
  "settings.subAgents.form.field.tools": "Toegestane tools",
  "settings.subAgents.form.tools.all": "Standaard alle rechten",
  "settings.subAgents.form.tools.custom": "Aangepaste toegestane tools",
  "settings.subAgents.form.tools.sensitive": "gevoelig",
  "settings.subAgents.form.tools.read": "Lezen",
  "settings.subAgents.form.tools.grep": "Grep",
  "settings.subAgents.form.tools.glob": "Glob",
  "settings.subAgents.form.tools.bash": "Bash",
  "settings.subAgents.form.tools.edit": "Bewerken",
  "settings.subAgents.form.tools.write": "Schrijven",
  ...
  "settings.subAgents.form.field.prompt": "Systeemprompt",
  "settings.subAgents.form.field.prompt.placeholder": "Beschrijf de rol en regels van deze subagent...",
  "settings.subAgents.form.field.injectAgentsMd": "AGENTS.md invoegen",
  "settings.subAgents.form.field.injectAgentsMd.description": "Neem het AGENTS.md-bestand van de werkruimte op in de context van deze subagent",
  "settings.subAgents.form.workspace.unsupported": "Maken of bewerken op werkruimteniveau wordt niet ondersteund",
  "settings.subAgents.form.save": "Opslaan",
  "settings.subAgents.form.saving": "Opslaan...",
  "settings.subAgents.form.cancel": "Annuleren",
  "settings.subAgents.form.delete": "Verwijderen",
  "settings.subAgents.form.delete.confirm": "Subagent \"{{name}}\" verwijderen?",
  "settings.subAgents.form.success": "Subagent aangemaakt",
  "settings.subAgents.form.failed": "De subagent kon niet worden aangemaakt",
  "settings.subAgents.form.updated": "Subagent bijgewerkt",
  "settings.subAgents.form.updateFailed": "De subagent kon niet worden bijgewerkt",
  "settings.subAgents.form.deleted": "Subagent verwijderd",
  "settings.subAgents.form.deleteFailed": "De subagent kon niet worden verwijderd",
  "settings.subAgents.native.build": "De standaardagent. Voert tools uit op basis van de geconfigureerde rechten.",
  "settings.subAgents.native.plan": "Planmodus. Staat geen bewerkingstools toe.",
  "settings.subAgents.native.general": "Algemene agent voor het onderzoeken van complexe vragen en het uitvoeren van taken met meerdere stappen.",
  "settings.subAgents.native.explore": "Snelle agent gespecialiseerd in het verkennen van codebases en het vinden van bestanden.",
  "settings.subAgents.native.compaction": "Interne agent voor het compacteren van sessiegeschiedenis.",
  "settings.subAgents.native.title": "Interne agent voor het genereren van conversatietitels.",
  "settings.subAgents.native.summary": "Interne agent voor het samenvatten van sessies.",
  "settings.plugins.title": "Plugins",
  "settings.plugins.description": "Breid de agent uit met npm-pakketten of lokale plugin-bestanden die op levenscyclusgebeurtenissen inhaken.",
  "settings.plugins.note.title": "Wat is een plugin?",
  "settings.plugins.note.description": "Plugins draaien in het agentproces en reageren op levenscyclusgebeurtenissen zoals een inactieve sessie, tooluitvoering en het instellen van de shell-omgeving.",
  "settings.plugins.section.installed": "Geïnstalleerd",
  "settings.plugins.section.add": "Plugin toevoegen",
  "settings.plugins.empty": "Nog geen plugins geïnstalleerd",
  "settings.plugins.add.label": "Pakket of lokaal bestand",
  "settings.plugins.add.placeholder": "opencode-wakatime, @my-org/custom-plugin or ./plugins/my-plugin.ts",
  "settings.plugins.add.button": "Toevoegen",
  "settings.plugins.add.success": "Plugin toegevoegd",
  "settings.plugins.add.failed": "De plugin kon niet worden toegevoegd",
  "settings.plugins.remove": "Verwijderen",
  "settings.plugins.remove.confirm": "Plugin \"{{name}}\" verwijderen?",
  "settings.plugins.remove.success": "Plugin verwijderd",
  "settings.plugins.remove.failed": "De plugin kon niet worden verwijderd",
  "settings.plugins.origin.npm": "npm · vereist Tian-conventie",
  "settings.plugins.origin.local": "lokaal",
  "settings.plugins.catalog.npm.title": "Populaire npm-apps",
  "settings.plugins.catalog.npm.description": "Geverifieerde pakketten die de plugin-conventie van Tian volgen.",
  "settings.plugins.catalog.npm.note": "npm-pakketten moeten de plugin-conventie van Tian implementeren",
  "settings.plugins.catalog.local.title": "Lokale plugins",
  "settings.plugins.catalog.local.description": "Plugins die met deze repository worden meegeleverd onder .tiancode/plugins.",
  "settings.plugins.catalog.add": "Toevoegen",
  "settings.plugins.catalog.installed": "Geïnstalleerd",
  "settings.plugins.catalog.npm.biome.description": "Snelle linter en formatter voor JavaScript en TypeScript.",
  "settings.plugins.catalog.npm.playwrightMcp.description": "Browserautomatisering en E2E-testen voor webapplicaties.",
  "settings.plugins.catalog.npm.octokitRest.description": "GitHub API-client voor pull requests, issues en repositories.",
  "settings.plugins.catalog.npm.slackWebApi.description": "Officiële Slack Web API-client voor berichten en conversaties.",
  "settings.plugins.catalog.npm.notionClient.description": "Officiële Notion API-client voor pagina's, databases en blokken.",
  "settings.plugins.catalog.npm.sentryCli.description": "Sentry-foutbewaking, releases en sourcemap-uploads.",
  "settings.plugins.catalog.npm.agentNotify.description": "Stuurt meldingen wanneer agenttaken voltooien of mislukken.",
  "settings.plugins.catalog.npm.chimeClaude.description": "Telegrammeldingen voor levenscyclusgebeurtenissen van de agent.",
  "settings.plugins.catalog.local.envGuard.description": "Beschermt .env-bestanden tegen onbedoelde wijzigingen.",
  "settings.plugins.catalog.local.commitHelper.description": "Helpt bij het opstellen van conventional commit-berichten.",
  "settings.plugins.catalog.local.notifyIdle.description": "Laat je weten wanneer een sessie inactief wordt.",
  "settings.plugins.catalog.local.shellEnv.description": "Voegt omgevingsvariabelen toe aan shell-toolprocessen.",
  "settings.plugins.catalog.local.permissionGuard.description": "Blokkeert riskante toolcalls waarvoor expliciete goedkeuring nodig is.",
  "settings.plugins.template.title": "Nieuwe plugin",
  "settings.plugins.template.description": "Genereert een plugin-skelet met de meest voorkomende levenscyclus-hooks. Kopieer het naar een bestand en voeg het hierboven toe.",
  "settings.plugins.template.copy": "Kopiëren",
  "settings.plugins.template.copied": "Template gekopieerd naar klembord",
  "settings.mcpServers.title": "MCP-servers",
  "settings.mcpServers.description": "Verbind de agent met externe tools via Model Context Protocol (MCP)-servers.",
  "settings.mcpServers.section.servers": "Servers",
  "settings.mcpServers.section.add": "Server toevoegen",
  "settings.mcpServers.edit.title": "Server bewerken",
  "settings.mcpServers.empty": "Nog geen MCP-servers geconfigureerd",
  "settings.mcpServers.add.button": "Server toevoegen",
  "settings.mcpServers.save.button": "Opslaan",
  "settings.mcpServers.cancel.button": "Annuleren",
  "settings.mcpServers.saving": "Opslaan...",
  "settings.mcpServers.field.name": "Naam",
  "settings.mcpServers.field.name.placeholder": "filesystem",
  "settings.mcpServers.field.type": "Type",
  "settings.mcpServers.type.local": "Lokaal (stdio)",
  "settings.mcpServers.type.remote": "Extern (HTTP/SSE)",
  "settings.mcpServers.field.command": "Opdracht",
  "settings.mcpServers.field.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem /path",
  "settings.mcpServers.field.command.hint": "Tip: npx, uvx, node of cmd /c npx op Windows",
  "settings.mcpServers.field.environment": "Omgeving (KEY=VALUE per regel)",
  "settings.mcpServers.field.environment.placeholder": "API_KEY=sk-...",
  "settings.mcpServers.field.cwd": "Werkmap (optioneel)",
  "settings.mcpServers.field.timeout": "Timeout in seconden (optioneel)",
  "settings.mcpServers.field.url": "URL",
  "settings.mcpServers.field.url.placeholder": "https://example.com/mcp",
  "settings.mcpServers.field.headers": "Headers (KEY=VALUE per regel)",
  "settings.mcpServers.field.oauth": "OAuth",
  "settings.mcpServers.presets.title": "Voorinstellingen",
  "settings.mcpServers.presets.filesystem": "Filesystem",
  "settings.mcpServers.presets.fetch": "Fetch",
  "settings.mcpServers.presets.memory": "Geheugen",
  "settings.mcpServers.presets.sequentialThinking": "Sequential Thinking",
  "settings.mcpServers.presets.time": "Tijd",
  ...
  "settings.mcpServers.status.connected": "Verbonden",
  "settings.mcpServers.status.disabled": "Uitgeschakeld",
  "settings.mcpServers.status.failed": "Fout",
  "settings.mcpServers.status.needs_auth": "Inloggen vereist",
  "settings.mcpServers.status.needs_client_registration": "Registratie vereist",
  "settings.mcpServers.status.unknown": "Onbekend",
  "settings.mcpServers.action.connect": "Verbinden",
  "settings.mcpServers.action.disconnect": "Verbinding verbreken",
  "settings.mcpServers.action.edit": "Bewerken",
  "settings.mcpServers.action.export": "Exporteren",
  "settings.mcpServers.action.remove": "Verwijderen",
  "settings.mcpServers.remove.confirm": "Server \"{{name}}\" verwijderen?",
  "settings.mcpServers.add.success": "Server opgeslagen",
  "settings.mcpServers.add.failed": "De server kon niet worden opgeslagen",
  "settings.mcpServers.export.success": "Configuratie gekopieerd naar klembord",
  "settings.mcpServers.export.failed": "De configuratie kon niet worden gekopieerd",
  "settings.mcpServers.search.placeholder": "Servers zoeken...",
  "settings.mcpServers.search.empty": "Geen servers gevonden voor je zoekopdracht",
  "settings.mcpServers.group.connected": "Verbonden",
  "settings.mcpServers.group.errors": "Fouten",
  "settings.mcpServers.group.disabled": "Uitgeschakeld",
  "settings.mcpServers.group.unknown": "Onbekend",
  "settings.mcpServers.tools.count": "{{count}} tools",
  "settings.mcpServers.save.changes": "Wijzigingen opslaan",
  "settings.mcpServers.discover.title": "Ontdekken",
  "settings.mcpServers.discover.description": "Populaire MCP-servers die je met één klik kunt toevoegen.",
  "settings.mcpServers.discover.requiresKey": "Vereist API-sleutel — bewerk na het toevoegen",
  "settings.mcpServers.discover.presets.android-emulator.name": "Android Emulator",
  "settings.mcpServers.discover.presets.android-emulator.description": "Bestuur Android-emulators, schermen en apps vanuit de agent.",
  "settings.mcpServers.discover.presets.node-repl.name": "Node REPL",
  "settings.mcpServers.discover.presets.node-repl.description": "Voer JavaScript uit in een Node.js REPL-sessie.",
  "settings.mcpServers.discover.presets.ios-simulator.name": "iOS Simulator",
  "settings.mcpServers.discover.presets.ios-simulator.description": "Bestuur de iOS-simulator en zijn apps (Xcode vereist).",
  "settings.mcpServers.discover.presets.chrome-devtools.name": "Chrome DevTools",
  "settings.mcpServers.discover.presets.chrome-devtools.description": "Inspecteer, debug en automatiseer Chrome-pagina's.",
  "settings.mcpServers.discover.presets.playwright.name": "Playwright",
  "settings.mcpServers.discover.presets.playwright.description": "Browserautomatisering en end-to-end webtesten.",
  "settings.mcpServers.discover.presets.context7.name": "Context7",
  "settings.mcpServers.discover.presets.context7.description": "Actuele documentatie voor populaire bibliotheken en frameworks.",
  "settings.mcpServers.discover.presets.agent-vision.name": "Agent Vision",
  "settings.mcpServers.discover.presets.agent-vision.description": "Geeft modellen zonder vision ogen: analyseer afbeeldingen, schermafbeeldingen en documenten (OCR) met elke OpenAI-compatibele vision-API (OpenAI, Gemini, Qwen-VL). Voeg na inschakelen VISION_API_KEY toe onder Environment in de servereditor.",
  "capture.menu.title": "Schermafbeelding maken",
  "capture.screen": "Volledig scherm",
  "capture.window": "App-venster",
  "capture.area": "Gebied selecteren…",
  "capture.preview": "Interne browser",
  "capture.area.title": "Selecteer het te vastleggen gebied (Enter om te bevestigen, Esc om te annuleren)",
  "capture.area.cancel": "Annuleren",
  "capture.area.confirm": "Gebied vastleggen",
  "settings.mcpServers.discover.presets.aikido.name": "Aikido",
  "settings.mcpServers.discover.presets.aikido.description": "Scan code en afhankelijkheden op beveiligingsproblemen.",
  "settings.mcpServers.discover.presets.airwallex.name": "Airwallex",
  "settings.mcpServers.discover.presets.airwallex.description": "API's voor betalingen, treasury en kaartuitgifte.",
  "settings.mcpServers.discover.presets.canva.name": "Canva",
  "settings.mcpServers.discover.presets.canva.description": "Maak en bewerk Canva-ontwerpen (OAuth).",
  "settings.mcpServers.discover.presets.circle.name": "Circle",
  "settings.mcpServers.discover.presets.circle.description": "USDC-betalingen en door ontwikkelaars beheerde wallets.",
  "settings.mcpServers.discover.presets.appwrite.name": "Appwrite",
  "settings.mcpServers.discover.presets.appwrite.description": "Auth, databases en opslag voor je apps (OAuth).",
  "settings.mcpServers.discover.presets.apollo.name": "Apollo",
  "settings.mcpServers.discover.presets.apollo.description": "Bevraag je Apollo GraphOS-graph (OAuth).",
  "settings.mcpServers.discover.presets.graphos-tools.name": "GraphOS Tools",
  "settings.mcpServers.discover.presets.graphos-tools.description": "Beheer Apollo GraphOS-werkruimten en schema's.",
  "settings.mcpServers.discover.presets.atlan.name": "Atlan",
  "settings.mcpServers.discover.presets.atlan.description": "Doorzoek je datacatalogus en governance-assets (OAuth).",
  "settings.mcpServers.discover.presets.awsknowledge.name": "AWS Knowledge",
  "settings.mcpServers.discover.presets.awsknowledge.description": "AWS-servicedocumentatie en kennisbank.",
  "settings.github.title": "GitHub",
  "settings.github.description": "Verbind je GitHub-account om repositories te klonen, nieuwe aan te maken en git-bewerkingen op je projecten uit te voeren.",
  "settings.github.loading": "Laden...",
  "settings.github.connect.title": "Verbinden met GitHub",
  "settings.github.connect.description": "Plak een personal access token om te authenticeren met GitHub. Het token wordt lokaal opgeslagen en gebruikt voor het klonen en geauthenticeerde git-bewerkingen.",
  "settings.github.connect.token.placeholder": "github_pat_... or ghp_...",
  "settings.github.connect.hint": "Maak een token aan op github.com/settings/tokens (fine-grained met repo-scope)",
  "settings.github.connect.button": "Verbinden",
  "settings.github.connecting": "Verbinden...",
  "settings.github.connect.success": "GitHub-account verbonden",
  "settings.github.connect.failed": "Verbinding met GitHub mislukt. Controleer je token en probeer het opnieuw.",
  "settings.github.connected.title": "Verbonden als",
  "settings.github.disconnect.button": "Verbinding verbreken",
  "settings.github.disconnect.confirm": "Je GitHub-account verbreken? Het opgeslagen token wordt verwijderd.",
  "settings.github.disconnect.success": "GitHub-account verbroken",
  "settings.github.disconnect.failed": "Verbinding met GitHub verbreken mislukt",
  "settings.github.refresh": "Vernieuwen",
  "settings.github.repos.title": "Repositories",
  "settings.github.repos.search.placeholder": "Zoek in je repos...",
  "settings.github.repos.empty": "Geen repositories gevonden",
  "settings.github.repo.private": "Privé",
  "settings.github.repo.public": "Openbaar",
  "settings.github.repo.clone": "Klonen",
  "settings.github.repo.cloning": "Klonen...",
  "settings.github.repo.clone.success": "Gekloond naar {{directory}}",
  "settings.github.repo.clone.failed": "De repository kon niet worden gekloond",
  "settings.github.create.title": "Repository aanmaken",
  "settings.github.create.name": "Naam",
  "settings.github.create.name.placeholder": "my-repository",
  "settings.github.create.private": "Privé",
  "settings.github.create.button": "Aanmaken",
  "settings.github.create.success": "Repository aangemaakt",
  "settings.github.create.failed": "De repository kon niet worden aangemaakt",
  "settings.github.project.title": "Huidig project",
  "settings.github.project.noRemote": "Dit project heeft nog geen git remote — maak een repository aan op GitHub en voeg de remote toe.",
  "settings.github.commit.placeholder": "Commit-bericht...",
  "settings.github.commit.button": "Commit",
  "settings.github.commit.success": "Gecommit",
  "settings.github.commit.failed": "Commit mislukt",
  "settings.github.push.button": "Push",
  "settings.github.push.success": "Push uitgevoerd",
  "settings.github.push.failed": "Push mislukt",
  "settings.github.pull.button": "Pull",
  "settings.github.pull.success": "Pull uitgevoerd",
  "settings.github.pull.failed": "Pull mislukt",
  "settings.voices.title": "Stemmen",
  "settings.voices.description": "Kies een stem om antwoorden van de assistent voor te lezen en test het gratis stemmodel.",
  "settings.voices.desktopOnly": "Stemmen zijn beschikbaar in de desktopapp.",
  "settings.voices.loading": "Laden...",
  "settings.voices.download.title": "Stemmodel niet geïnstalleerd",
  "settings.voices.download.description": "Download het gratis kokoro-stemmodel (~325MB) om spraak op je computer te genereren. Stemmen verlaten nooit je apparaat.",
  "settings.voices.download.button": "Stemmodel downloaden",
  "settings.voices.download.downloading": "Stemmodel downloaden...",
  "settings.voices.download.progress": "{{file}} downloaden",
  "settings.voices.download.failed": "Het stemmodel kon niet worden gedownload",
  "settings.voices.ready.title": "Een stem selecteren",
  "settings.voices.voices.empty": "Geen stemmen beschikbaar",
  "settings.voices.voice.probe": "Testen",
  "settings.voices.voice.speaking": "Stoppen",
  "settings.voices.voice.probe.failed": "Deze stem kon niet worden afgespeeld",
  "settings.voices.voice.unsupported": "Alleen Engels",
  "settings.voices.select.title": "Actieve stem",
  "settings.voices.autoSpeak.title": "Antwoorden voorlezen",
  "settings.voices.autoSpeak.description": "Leest het antwoord van het model in realtime voor terwijl het wordt gegenereerd, met de geselecteerde stem.",
  "settings.voices.gender.female": "Vrouw",
  "settings.voices.gender.male": "Man",
  "settings.voices.filter.all": "Alle",
  "settings.voices.filter.female": "Vrouwen",
  "settings.voices.filter.male": "Mannen",
  "settings.voices.filter.spanish": "Spaans",
  "settings.voices.pagination.prev": "Vorige",
  "settings.voices.pagination.next": "Volgende",
  "settings.voices.pagination.page": "Pagina {{current}} van {{total}}",
  "settings.voices.voice.info": "Stemdetails",
  "settings.voices.voice.download": "Downloaden",
  "settings.voices.voice.downloading": "Downloaden…",
  "settings.voices.voice.delete": "Verwijderen",
  "settings.voices.voice.delete.confirm": "De gedownloade bestanden voor {{name}} verwijderen?",
  "settings.voices.voice.builtin": "Ingebouwd",
  "settings.voices.voice.engine.kokoro": "Kokoro",
  "settings.voices.voice.engine.piper": "Piper",
  "settings.voices.voice.license": "Licentie",
  "settings.voices.voice.enabled": "Ingeschakeld",
  "settings.voices.voice.size": "{{size}} MB",
  "settings.voices.voice.download.success": "Stem gedownload",
  "settings.voices.voice.download.failed": "De stem kon niet worden gedownload",
  "settings.voices.voice.delete.success": "Stem verwijderd",
  "settings.voices.voice.delete.failed": "De stem kon niet worden verwijderd",
  "settings.tab.modelsHub": "Lokale modellen",
  "settings.modelsHub.title": "Lokale modellen",
  "settings.modelsHub.description": "Zoek en download GGUF-modellen van HuggingFace om AI lokaal te draaien, zoals LM Studio.",
  "settings.modelsHub.search.placeholder": "Zoek modellen... bijv. llama 3.2",
  "settings.modelsHub.search.button": "Zoeken",
  "settings.modelsHub.empty": "Geen modellen gevonden. Probeer een andere zoekopdracht.",
  "settings.modelsHub.download": "Downloaden",
  "settings.modelsHub.download.downloading": "Downloaden",
  "settings.modelsHub.download.paused": "Gepauzeerd",
  "settings.modelsHub.download.resume": "Hervatten",
  "settings.modelsHub.download.delete": "Verwijderen",
  "settings.modelsHub.download.completed": "Voltooid",
  "settings.modelsHub.download.failed": "Mislukt",
  "settings.modelsHub.downloads.title": "Downloads",
  "settings.modelsHub.recommended": "Aanbevolen",
  "settings.modelsHub.detail.files": "Bestanden",
  "settings.modelsHub.runtime.title": "Runtime",
  "settings.modelsHub.runtime.description": "Lokale inference-runtimes gedetecteerd op deze machine.",
  "settings.modelsHub.runtime.available": "Beschikbaar",
  "settings.modelsHub.runtime.notDetected": "Niet gedetecteerd",
  "settings.modelsHub.provider.setup": "Instellen als provider",
  "settings.modelsHub.provider.ready": "Lokale provider gereed (model: {name})",
  "settings.modelsHub.provider.failed": "De lokale provider kon niet worden ingesteld",
  "settings.modelsHub.recommended.title": "Aanbevolen model voor je GPU",
  "settings.modelsHub.recommended.forYourGpu": "op basis van je gedetecteerde VRAM",
  "settings.modelsHub.recommended.download": "Downloaden",
  "settings.modelsHub.runtime.hint": "Draai lokale modellen via Ollama of LM Studio en voeg ze toe als provider onder Providers.",
  "settings.modelsHub.runtime.install": "Installeren",
  "settings.modelsHub.runtime.install.downloading": "Downloaden",
  "settings.modelsHub.runtime.install.installing": "Installeren…",
  "settings.modelsHub.runtime.install.success": "{{name}} geïnstalleerd. Open de app eenmalig om de installatie af te ronden.",
  "settings.modelsHub.runtime.install.failed": "De runtime kon niet worden geïnstalleerd",
  "settings.modelsHub.system.ram": "RAM",
  "settings.modelsHub.system.vram": "GPU-geheugen (VRAM)",
  "settings.modelsHub.system.vramFree": "vrij:",
  "settings.modelsHub.memory.title": "Geheugenmodus",
  "settings.modelsHub.memory.gpu": "GPU-geheugen (VRAM) primair gebruiken",
  "settings.modelsHub.memory.ram": "Systeem-RAM als reserve gebruiken",
  "settings.modelsHub.system.dir": "Modellenmap",
  "settings.modelsHub.system.disk": "Vrije schijfruimte",
  "settings.modelsHub.system.gpu": "GPU",
  "settings.modelsHub.system.cpu": "CPU",
  "settings.modelsHub.fit.fullGpu": "Volledige GPU-offload mogelijk",
  "settings.modelsHub.fit.partialGpu": "Gedeeltelijke GPU-offload mogelijk",
  "settings.modelsHub.fit.ramOnly": "Past zonder GPU",
  "settings.modelsHub.fit.noFit": "Past niet",
  "settings.modelsHub.desc.text-generation": "Tekstgeneratie",
  "settings.modelsHub.desc.image-text-to-text": "Visie",
  "settings.modelsHub.desc.text-to-image": "Beeldgeneratie",
  "settings.modelsHub.desc.image-to-image": "Beeldbewerking",
  "settings.modelsHub.desc.image-classification": "Beeldclassificatie",
  "settings.modelsHub.desc.token-classification": "Tokenclassificatie",
  "settings.modelsHub.desc.text-classification": "Tekstclassificatie",
  "settings.modelsHub.desc.question-answering": "Vragen beantwoorden",
  "settings.modelsHub.desc.summarization": "Samenvatting",
  "settings.modelsHub.desc.translation": "Vertaling",
  "settings.modelsHub.desc.fill-mask": "Fill-mask",
  "settings.modelsHub.desc.feature-extraction": "Feature-extractie",
  "settings.modelsHub.desc.automatic-speech-recognition": "Spraakherkenning",
  "settings.modelsHub.desc.text-to-speech": "Tekst naar spraak",
  "settings.modelsHub.desc.depth-estimation": "Diepteschatting",
  "settings.modelsHub.desc.image-segmentation": "Beeldsegmentatie",
  "settings.modelsHub.desc.object-detection": "Objectdetectie",
  "settings.modelsHub.desc.hint.instruct": "Instructie",
  "settings.modelsHub.desc.hint.chat": "Chat",
  "settings.modelsHub.desc.hint.vision": "Visie",
  "settings.modelsHub.desc.hint.code": "Coderen",
  "settings.modelsHub.desc.hint.reasoning": "Redeneren",
  "settings.modelsHub.desc.hint.quantized": "Gekwantiseerd",
  "onboarding.title": "Welkom bij Tiancode",
  "onboarding.step": "Stap {{current}} van {{total}}",
  "onboarding.disclaimer.p1": "Tiancode is een AI-agent die naast je werkt: hij kan opdrachten uitvoeren, bestanden bewerken en taken op je computer beheren terwijl jij de controle houdt.",
  "onboarding.disclaimer.p2": "Je prompts en bestandsinhoud kunnen naar de AI-modelproviders worden verzonden die je configureert om antwoorden te genereren.",
  "onboarding.disclaimer.p3": "Je bent verantwoordelijk voor hoe je Tiancode gebruikt. Controleer wijzigingen zorgvuldig voordat je ze accepteert en voer nooit opdrachten uit die je niet begrijpt.",
  "onboarding.accept": "Accepteren en doorgaan",
  "onboarding.preferences.title": "Maak het van jou",
  "onboarding.preferences.description": "Kies hoe Tiancode eruitziet en met je praat. Je kunt dit op elk moment wijzigen in Instellingen.",
  "onboarding.theme.title": "Weergave",
  "onboarding.theme.light": "Licht",
  "onboarding.theme.dark": "Donker",
  "onboarding.language.title": "Taal",
  "onboarding.language.english": "Engels",
  "onboarding.language.spanish": "Español",
  "onboarding.start": "Begin met Tiancode",
}
