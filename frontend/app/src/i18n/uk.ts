export const dict = {
  ...
  "desktop.menu.documentation": "Документація Tiancode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Tiancode",
  "desktop.recovery.terminated": "Роботу вікна Tiancode несподівано завершено",
  "desktop.recovery.unresponsive": "Tiancode не відповідає",
  ...
  "desktop.wsl.error.installTiancode": "Не вдалося встановити Tiancode",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.tiancodeMissing": "tiancode не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.tiancodeCannotRun": "tiancode встановлено, але його не вдалося запустити",
  "desktop.wsl.error.tiancodeNotInstalled": "Tiancode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Tiancode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.tiancode.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.tiancode.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.tiancodeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Tiancode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Tiancode.",
  ...
  "provider.connect.tiancodeZen.line1":
    "Tiancode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.tiancodeZen.visit.prefix": "Відвідайте ",
  "provider.connect.tiancodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.tiancodeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Tiancode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Tiancode.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в tiancode.json",
  ...
  "dialog.server.description": "Перемкніть сервер Tiancode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Tiancode...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Tiancode у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Tiancode...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Tiancode у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Tiancode у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Tiancode",
  "wsl.onboarding.tiancodeReadyIn": "Tiancode готовий до роботи у {{distro}}.",
  "wsl.onboarding.tiancodeReady": "Tiancode готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Tiancode у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Tiancode",
  ...
  "wsl.onboarding.distroStatus.tiancodeMissing": "Tiancode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Tiancode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Tiancode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Tiancode.",
  ...
  "help.tabs.introduction": "Tiancode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Tiancode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Tiancode",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (tiancode.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Tiancode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Tiancode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Tiancode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Tiancode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Tiancode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Tiancode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Tiancode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Tiancode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Tiancode.",
  ...
  "a11y.closeTab": "Закрити вкладку",
  "a11y.clearSearch": "Очистити пошук",
  "a11y.edit": "Змінити",
  "chat.mic.start": "Диктувати з мікрофона",
  ...
  "chat.message.speak.failed": "Не вдалося прочитати відповідь вголос",
  "preview.title": "Вбудований браузер",
  "preview.open": "Відкрити вбудований браузер",
  "preview.close": "Закрити браузер",
  "preview.back": "Назад",
  "preview.forward": "Вперед",
  "preview.reload": "Оновити",
  "preview.go": "Перейти",
  "preview.url": "Веб-адреса",
  "settings.general.row.minimizeToTray.title": "Згортати в системний трей",
  "settings.general.row.minimizeToTray.description": "Закриття вікна згортає застосунок у системний трей замість виходу",
  "settings.general.row.fileWatcher.title": "Оновлення файлів у реальному часі",
  "settings.general.row.fileWatcher.description": "Автоматично оновлює дерево файлів та зміни git.",
  "settings.general.fileWatcher.restart.confirm": "Перезапустити Tiancode, щоб застосувати зміну оновлення файлів у реальному часі?",
  "session.export.button": "Експортувати розмову в Markdown",
  "session.export.title": "Експорт розмови",
  "session.export.success": "Розмову експортовано",
  "session.export.failed": "Не вдалося експортувати розмову",
  "settings.general.section.data": "Дані",
  "settings.general.row.autoBackup.title": "Автоматичне резервне копіювання",
  "settings.general.row.autoBackup.description": "Щоденна копія сесій і конфігурації (зберігається останні 7 днів)",
  "settings.general.row.backupNow.title": "Створити резервну копію зараз",
  "settings.general.row.backupNow.description": "Створити негайну копію ваших даних",
  "settings.general.row.backupNow.button": "Створити резервну копію",
  "settings.general.row.restore.title": "Відновити",
  "settings.general.row.restore.description": "Відновити ранішу резервну копію (застосунок перезапуститься)",
  "settings.general.row.restore.button": "Відновити",
  "settings.general.backup.now.success": "Резервну копію створено",
  "settings.general.backup.now.failed": "Ще немає даних для резервного копіювання",
  "settings.general.backup.restore.confirm": "Відновити резервну копію {name}? Поточні сесії та конфігурацію буде замінено.",
  "settings.general.backup.restore.success": "Резервну копію відновлено",
  "settings.general.backup.restore.failed": "Не вдалося відновити резервну копію",
  "settings.general.row.loginItem.title": "Запускати під час входу",
  "settings.general.row.loginItem.description": "Автоматично відкривати Tiancode під час входу в Windows",
  "settings.section.extensions": "Розширення",
  "settings.tab.plugins": "Плагіни",
  "settings.tab.skills": "Навички",
  "settings.tab.subAgents": "Субагенти",
  "settings.tab.mcpServers": "MCP-сервери",
  "settings.tab.github": "Github",
  "settings.tab.voices": "Голоси",
  "settings.skills.title": "Навички",
  "settings.skills.description": "Імпортуйте навички з комп'ютера або завантажуйте опубліковані навички з інтернету.",
  "settings.skills.section.installed": "Установлені",
  "settings.skills.autoSelect.title": "Автовибір навичок",
  "settings.skills.autoSelect.description": "Автоматично підбирати навички, що відповідають вашому проєкту (фреймворк, інструменти тощо), у кожній розмові",
  "settings.skills.section.import": "Імпортувати навичку",
  "settings.skills.empty": "Навички ще не встановлено",
  "settings.skills.import.folder.title": "Імпорт із папки",
  "settings.skills.import.folder.description": "Виберіть папку навички, що містить файл SKILL.md",
  "settings.skills.import.folder.button": "Вибрати папку",
  "settings.skills.import.url.title": "Завантажити за URL",
  "settings.skills.import.url.description": "Вставте URL опублікованої навички, щоб завантажити її",
  "settings.skills.import.url.placeholder": "https://example.com/skills/my-skill",
  "settings.skills.import.url.button": "Завантажити",
  "settings.skills.search.google": "Шукати опубліковані навички в Google",
  "settings.skills.importing": "Імпорт...",
  "settings.skills.import.success": "Навичку імпортовано",
  "settings.skills.import.failed": "Не вдалося імпортувати навичку",
  "settings.subAgents.title": "Субагенти",
  "settings.subAgents.description": "Створюйте власних субагентів, яким головний агент може делегувати завдання.",
  "settings.subAgents.list.new": "Новий субагент",
  "settings.subAgents.list.search.placeholder": "Пошук субагентів",
  "settings.subAgents.list.search.clear": "Очистити пошук",
  "settings.subAgents.list.filter.all": "Усі",
  "settings.subAgents.list.filter.enabled": "Увімкнені",
  "settings.subAgents.list.filter.disabled": "Вимкнені",
  "settings.subAgents.list.group.user": "Користувацькі субагенти",
  "settings.subAgents.list.group.builtin": "Вбудовані субагенти",
  "settings.subAgents.list.builtin.hint": "тут не можна редагувати",
  "settings.subAgents.list.empty": "Субагентів не знайдено",
  "settings.subAgents.list.footer": "{{count}} субагентів · {{enabled}} увімкнено",
  "settings.subAgents.list.model.inherit": "успадкувати",
  "settings.subAgents.list.tools.all": "Усі інструменти",
  "settings.subAgents.list.tools.summary": "{{count}} інструментів",
  "settings.subAgents.list.edit": "Змінити субагента",
  "settings.subAgents.list.delete": "Видалити субагента",
  "settings.subAgents.form.new.title": "Новий субагент",
  "settings.subAgents.form.edit.title": "Змінити {{name}}",
  "settings.subAgents.form.field.name": "Ім'я",
  "settings.subAgents.form.field.name.placeholder": "code-reviewer",
  "settings.subAgents.form.field.color": "Колір",
  "settings.subAgents.form.color.yellow": "Жовтий",
  "settings.subAgents.form.color.red": "Червоний",
  "settings.subAgents.form.color.orange": "Оранжевий",
  "settings.subAgents.form.color.green": "Зелений",
  "settings.subAgents.form.color.cyan": "Блакитний",
  "settings.subAgents.form.color.blue": "Синій",
  "settings.subAgents.form.color.purple": "Фіолетовий",
  "settings.subAgents.form.color.pink": "Рожевий",
  "settings.subAgents.form.field.model": "Модель",
  "settings.subAgents.form.field.model.placeholder": "provider/model",
  "settings.subAgents.form.model.inherit": "успадкувати",
  "settings.subAgents.form.model.custom": "Власна...",
  "settings.subAgents.form.field.description": "Опис",
  "settings.subAgents.form.field.description.placeholder": "Короткий опис, який показується моделі",
  "settings.subAgents.form.field.tools": "Дозволені інструменти",
  "settings.subAgents.form.tools.all": "За замовчуванням усі дозволи",
  "settings.subAgents.form.tools.custom": "Власні дозволені інструменти",
  "settings.subAgents.form.tools.sensitive": "чутливі",
  ...
  "settings.subAgents.form.field.prompt": "Системний промпт",
  "settings.subAgents.form.field.prompt.placeholder": "Опишіть роль і правила цього субагента...",
  "settings.subAgents.form.field.injectAgentsMd": "Впровадити AGENTS.md",
  "settings.subAgents.form.field.injectAgentsMd.description": "Включити файл AGENTS.md робочої області в контекст цього субагента",
  "settings.subAgents.form.workspace.unsupported": "Створення або редагування на рівні робочої області не підтримується",
  "settings.subAgents.form.save": "Зберегти",
  "settings.subAgents.form.saving": "Збереження...",
  "settings.subAgents.form.cancel": "Скасувати",
  "settings.subAgents.form.delete": "Видалити",
  "settings.subAgents.form.delete.confirm": "Видалити субагента \"{{name}}\"?",
  "settings.subAgents.form.success": "Субагента створено",
  "settings.subAgents.form.failed": "Не вдалося створити субагента",
  "settings.subAgents.form.updated": "Субагента оновлено",
  "settings.subAgents.form.updateFailed": "Не вдалося оновити субагента",
  "settings.subAgents.form.deleted": "Субагента видалено",
  "settings.subAgents.form.deleteFailed": "Не вдалося видалити субагента",
  "settings.subAgents.native.build": "Агент за замовчуванням. Виконує інструменти на основі налаштованих дозволів.",
  "settings.subAgents.native.plan": "Режим планування. Забороняє всі інструменти редагування.",
  "settings.subAgents.native.general": "Агент загального призначення для дослідження складних питань і виконання багатокрокових завдань.",
  "settings.subAgents.native.explore": "Швидкий агент, що спеціалізується на дослідженні кодових баз і пошуку файлів.",
  "settings.subAgents.native.compaction": "Внутрішній агент для стиснення історії сесії.",
  "settings.subAgents.native.title": "Внутрішній агент для створення заголовків розмов.",
  "settings.subAgents.native.summary": "Внутрішній агент для підбиття підсумків сесій.",
  "settings.plugins.title": "Плагіни",
  "settings.plugins.description": "Розширюйте агента за допомогою npm-пакетів або локальних файлів плагінів, що підключаються до подій життєвого циклу.",
  "settings.plugins.note.title": "Що таке плагін?",
  "settings.plugins.note.description": "Плагіни працюють усередині процесу агента та реагують на події життєвого циклу, як-от бездіяльність сесії, виконання інструментів і налаштування середовища оболонки.",
  "settings.plugins.section.installed": "Установлені",
  "settings.plugins.section.add": "Додати плагін",
  "settings.plugins.empty": "Плагіни ще не встановлено",
  "settings.plugins.add.label": "Пакет або локальний файл",
  "settings.plugins.add.placeholder": "opencode-wakatime, @my-org/custom-plugin або ./plugins/my-plugin.ts",
  "settings.plugins.add.button": "Додати",
  "settings.plugins.add.success": "Плагін додано",
  "settings.plugins.add.failed": "Не вдалося додати плагін",
  "settings.plugins.remove": "Видалити",
  "settings.plugins.remove.confirm": "Видалити плагін \"{{name}}\"?",
  "settings.plugins.remove.success": "Плагін видалено",
  "settings.plugins.remove.failed": "Не вдалося видалити плагін",
  "settings.plugins.origin.npm": "npm · потрібна конвенція Tian",
  "settings.plugins.origin.local": "локальний",
  "settings.plugins.catalog.npm.title": "Популярні npm-застосунки",
  "settings.plugins.catalog.npm.description": "Перевірені пакети, що відповідають конвенції плагінів Tian.",
  "settings.plugins.catalog.npm.note": "npm-пакети мають реалізовувати конвенцію плагінів Tian",
  "settings.plugins.catalog.local.title": "Локальні плагіни",
  "settings.plugins.catalog.local.description": "Плагіни, що постачаються з цим репозиторієм у папці .tiancode/plugins.",
  "settings.plugins.catalog.add": "Додати",
  "settings.plugins.catalog.installed": "Установлено",
  "settings.plugins.catalog.npm.biome.description": "Швидкий лінтер і форматер для JavaScript і TypeScript.",
  "settings.plugins.catalog.npm.playwrightMcp.description": "Автоматизація браузера та E2E-тестування веб-застосунків.",
  "settings.plugins.catalog.npm.octokitRest.description": "Клієнт GitHub API для pull request, issues і репозиторіїв.",
  "settings.plugins.catalog.npm.slackWebApi.description": "Офіційний клієнт Slack Web API для повідомлень і розмов.",
  "settings.plugins.catalog.npm.notionClient.description": "Офіційний клієнт Notion API для сторінок, баз даних і блоків.",
  "settings.plugins.catalog.npm.sentryCli.description": "Моніторинг помилок Sentry, релізи та завантаження source map.",
  "settings.plugins.catalog.npm.agentNotify.description": "Надсилає сповіщення, коли завдання агента завершуються або завершуються з помилкою.",
  "settings.plugins.catalog.npm.chimeClaude.description": "Telegram-сповіщення про події життєвого циклу агента.",
  "settings.plugins.catalog.local.envGuard.description": "Захищає файли .env від випадкових змін.",
  "settings.plugins.catalog.local.commitHelper.description": "Допомагає складати конвенційні повідомлення коммітів.",
  "settings.plugins.catalog.local.notifyIdle.description": "Сповіщає вас, коли сесія стає бездіяльною.",
  "settings.plugins.catalog.local.shellEnv.description": "Впроваджує змінні середовища в процеси інструментів оболонки.",
  "settings.plugins.catalog.local.permissionGuard.description": "Блокує ризиковані виклики інструментів, що потребують явного схвалення.",
  "settings.plugins.template.title": "Новий плагін",
  "settings.plugins.template.description": "Створює каркас плагіна з найпоширенішими хуками життєвого циклу. Скопіюйте його у файл і додайте вище.",
  "settings.plugins.template.copy": "Копіювати",
  "settings.plugins.template.copied": "Шаблон скопійовано в буфер обміну",
  "settings.mcpServers.title": "MCP-сервери",
  "settings.mcpServers.description": "Підключіть агента до зовнішніх інструментів через сервери Model Context Protocol (MCP).",
  "settings.mcpServers.section.servers": "Сервери",
  "settings.mcpServers.section.add": "Додати сервер",
  "settings.mcpServers.edit.title": "Змінити сервер",
  "settings.mcpServers.empty": "MCP-сервери ще не налаштовано",
  "settings.mcpServers.add.button": "Додати сервер",
  "settings.mcpServers.save.button": "Зберегти",
  "settings.mcpServers.cancel.button": "Скасувати",
  "settings.mcpServers.saving": "Збереження...",
  "settings.mcpServers.field.name": "Ім'я",
  "settings.mcpServers.field.name.placeholder": "filesystem",
  "settings.mcpServers.field.type": "Тип",
  "settings.mcpServers.type.local": "Локальний (stdio)",
  "settings.mcpServers.type.remote": "Віддалений (HTTP/SSE)",
  ...
  "settings.mcpServers.field.command.hint": "Порада: npx, uvx, node або cmd /c npx у Windows",
  "settings.mcpServers.field.environment": "Середовище (KEY=VALUE у кожному рядку)",
  "settings.mcpServers.field.environment.placeholder": "API_KEY=sk-...",
  "settings.mcpServers.field.cwd": "Робочий каталог (необов'язково)",
  "settings.mcpServers.field.timeout": "Тайм-аут у секундах (необов'язково)",
  "settings.mcpServers.field.url": "URL",
  "settings.mcpServers.field.url.placeholder": "https://example.com/mcp",
  "settings.mcpServers.field.headers": "Заголовки (KEY=VALUE у кожному рядку)",
  "settings.mcpServers.field.oauth": "OAuth",
  "settings.mcpServers.presets.title": "Пресети",
  "settings.mcpServers.presets.filesystem": "Файлова система",
  "settings.mcpServers.presets.fetch": "Fetch",
  "settings.mcpServers.presets.memory": "Пам'ять",
  "settings.mcpServers.presets.sequentialThinking": "Послідовне мислення",
  "settings.mcpServers.presets.time": "Час",
  ...
  "settings.mcpServers.status.connected": "Підключено",
  "settings.mcpServers.status.disabled": "Вимкнено",
  "settings.mcpServers.status.failed": "Помилка",
  "settings.mcpServers.status.needs_auth": "Потрібен вхід",
  "settings.mcpServers.status.needs_client_registration": "Потрібна реєстрація",
  "settings.mcpServers.status.unknown": "Невідомо",
  "settings.mcpServers.action.connect": "Підключити",
  "settings.mcpServers.action.disconnect": "Відключити",
  "settings.mcpServers.action.edit": "Змінити",
  "settings.mcpServers.action.export": "Експорт",
  "settings.mcpServers.action.remove": "Видалити",
  "settings.mcpServers.remove.confirm": "Видалити сервер \"{{name}}\"?",
  "settings.mcpServers.add.success": "Сервер збережено",
  "settings.mcpServers.add.failed": "Не вдалося зберегти сервер",
  "settings.mcpServers.export.success": "Конфігурацію скопійовано в буфер обміну",
  "settings.mcpServers.export.failed": "Не вдалося скопіювати конфігурацію",
  "settings.mcpServers.search.placeholder": "Пошук серверів...",
  "settings.mcpServers.search.empty": "Жоден сервер не відповідає вашому запиту",
  "settings.mcpServers.group.connected": "Підключені",
  "settings.mcpServers.group.errors": "Помилки",
  "settings.mcpServers.group.disabled": "Вимкнені",
  "settings.mcpServers.group.unknown": "Невідомі",
  "settings.mcpServers.tools.count": "{{count}} інструментів",
  "settings.mcpServers.save.changes": "Зберегти зміни",
  "settings.mcpServers.discover.title": "Огляд",
  "settings.mcpServers.discover.description": "Популярні MCP-сервери, які можна додати одним кліком.",
  "settings.mcpServers.discover.requiresKey": "Потрібен API-ключ — змініть після додавання",
  "settings.mcpServers.discover.presets.android-emulator.name": "Android Emulator",
  "settings.mcpServers.discover.presets.android-emulator.description": "Керуйте емуляторами Android, екранами та застосунками з агента.",
  "settings.mcpServers.discover.presets.node-repl.name": "Node REPL",
  "settings.mcpServers.discover.presets.node-repl.description": "Запускайте JavaScript у сесії Node.js REPL.",
  "settings.mcpServers.discover.presets.ios-simulator.name": "iOS Simulator",
  "settings.mcpServers.discover.presets.ios-simulator.description": "Керуйте симулятором iOS та його застосунками (потрібен Xcode).",
  "settings.mcpServers.discover.presets.chrome-devtools.name": "Chrome DevTools",
  "settings.mcpServers.discover.presets.chrome-devtools.description": "Переглядайте, налагоджуйте та автоматизуйте сторінки Chrome.",
  "settings.mcpServers.discover.presets.playwright.name": "Playwright",
  "settings.mcpServers.discover.presets.playwright.description": "Автоматизація браузера та наскрізне тестування веб-застосунків.",
  "settings.mcpServers.discover.presets.context7.name": "Context7",
  "settings.mcpServers.discover.presets.context7.description": "Актуальна документація для популярних бібліотек і фреймворків.",
  "settings.mcpServers.discover.presets.agent-vision.name": "Agent Vision",
  "settings.mcpServers.discover.presets.agent-vision.description": "Дає очі моделям без зору: аналізуйте зображення, скріншоти та документи (OCR) за допомогою будь-якого сумісного з OpenAI vision API (OpenAI, Gemini, Qwen-VL). Після ввімкнення додайте VISION_API_KEY у розділ Середовище в редакторі сервера.",
  "capture.menu.title": "Зробити скріншот",
  "capture.screen": "Весь екран",
  "capture.window": "Вікно застосунку",
  "capture.area": "Вибрати область…",
  "capture.preview": "Вбудований браузер",
  "capture.area.title": "Виберіть область для захоплення (Enter — підтвердити, Esc — скасувати)",
  "capture.area.cancel": "Скасувати",
  "capture.area.confirm": "Захопити область",
  "settings.mcpServers.discover.presets.aikido.name": "Aikido",
  "settings.mcpServers.discover.presets.aikido.description": "Скануйте код і залежності на предмет проблем безпеки.",
  "settings.mcpServers.discover.presets.airwallex.name": "Airwallex",
  "settings.mcpServers.discover.presets.airwallex.description": "API платежів, казначейства та випуску карток.",
  "settings.mcpServers.discover.presets.canva.name": "Canva",
  "settings.mcpServers.discover.presets.canva.description": "Створюйте та редагуйте дизайни Canva (OAuth).",
  "settings.mcpServers.discover.presets.circle.name": "Circle",
  "settings.mcpServers.discover.presets.circle.description": "Платежі USDC і гаманці під керуванням розробника.",
  "settings.mcpServers.discover.presets.appwrite.name": "Appwrite",
  "settings.mcpServers.discover.presets.appwrite.description": "Авторизація, бази даних і сховище для ваших застосунків (OAuth).",
  "settings.mcpServers.discover.presets.apollo.name": "Apollo",
  "settings.mcpServers.discover.presets.apollo.description": "Запитуйте свій граф Apollo GraphOS (OAuth).",
  "settings.mcpServers.discover.presets.graphos-tools.name": "GraphOS Tools",
  "settings.mcpServers.discover.presets.graphos-tools.description": "Керуйте робочими областями та схемами Apollo GraphOS.",
  "settings.mcpServers.discover.presets.atlan.name": "Atlan",
  "settings.mcpServers.discover.presets.atlan.description": "Шукайте в своєму каталозі даних та активах керування (OAuth).",
  "settings.mcpServers.discover.presets.awsknowledge.name": "AWS Knowledge",
  "settings.mcpServers.discover.presets.awsknowledge.description": "Документація сервісів AWS і база знань.",
  "settings.github.title": "Github",
  "settings.github.description": "Підключіть свій обліковий запис GitHub, щоб клонувати репозиторії, створювати нові та виконувати операції git у своїх проєктах.",
  "settings.github.loading": "Завантаження...",
  "settings.github.connect.title": "Підключити GitHub",
  "settings.github.connect.description": "Вставте personal access token для автентифікації в GitHub. Токен зберігається локально та використовується для клонування й автентифікованих операцій git.",
  "settings.github.connect.token.placeholder": "github_pat_... або ghp_...",
  "settings.github.connect.hint": "Створіть токен на github.com/settings/tokens (fine-grained з доступом до repo)",
  "settings.github.connect.button": "Підключити",
  "settings.github.connecting": "Підключення...",
  "settings.github.connect.success": "Обліковий запис GitHub підключено",
  "settings.github.connect.failed": "Не вдалося підключитися до GitHub. Перевірте токен і спробуйте знову.",
  "settings.github.connected.title": "Підключено як",
  "settings.github.disconnect.button": "Відключити",
  "settings.github.disconnect.confirm": "Відключити обліковий запис GitHub? Збережений токен буде видалено.",
  "settings.github.disconnect.success": "Обліковий запис GitHub відключено",
  "settings.github.disconnect.failed": "Не вдалося відключити GitHub",
  "settings.github.refresh": "Оновити",
  "settings.github.repos.title": "Репозиторії",
  "settings.github.repos.search.placeholder": "Пошук у своїх репозиторіях...",
  "settings.github.repos.empty": "Репозиторіїв не знайдено",
  "settings.github.repo.private": "Приватний",
  "settings.github.repo.public": "Публічний",
  "settings.github.repo.clone": "Клонувати",
  "settings.github.repo.cloning": "Клонування...",
  "settings.github.repo.clone.success": "Клоновано в {{directory}}",
  "settings.github.repo.clone.failed": "Не вдалося клонувати репозиторій",
  "settings.github.create.title": "Створити репозиторій",
  "settings.github.create.name": "Назва",
  "settings.github.create.name.placeholder": "my-repository",
  "settings.github.create.private": "Приватний",
  "settings.github.create.button": "Створити",
  "settings.github.create.success": "Репозиторій створено",
  "settings.github.create.failed": "Не вдалося створити репозиторій",
  "settings.github.project.title": "Поточний проєкт",
  "settings.github.project.noRemote": "У цього проєкту ще немає git remote — створіть репозиторій на GitHub і додайте remote.",
  "settings.github.commit.placeholder": "Повідомлення комміта...",
  "settings.github.commit.button": "Commit",
  "settings.github.commit.success": "Закоммічено",
  "settings.github.commit.failed": "Не вдалося зробити комміт",
  "settings.github.push.button": "Push",
  "settings.github.push.success": "Запушено",
  "settings.github.push.failed": "Не вдалося виконати push",
  "settings.github.pull.button": "Pull",
  "settings.github.pull.success": "Виконано pull",
  "settings.github.pull.failed": "Не вдалося виконати pull",
  "settings.voices.title": "Голоси",
  "settings.voices.description": "Виберіть голос для читання відповідей асистента вголос і протестуйте безкоштовну голосову модель.",
  "settings.voices.desktopOnly": "Голоси доступні в десктопному застосунку.",
  "settings.voices.loading": "Завантаження...",
  "settings.voices.download.title": "Голосову модель не встановлено",
  "settings.voices.download.description": "Завантажте безкоштовну голосову модель kokoro (~325MB) для синтезу мовлення на вашому комп'ютері. Голоси ніколи не залишають ваш пристрій.",
  "settings.voices.download.button": "Завантажити голосову модель",
  "settings.voices.download.downloading": "Завантаження голосової моделі...",
  "settings.voices.download.progress": "Завантаження {{file}}",
  "settings.voices.download.failed": "Не вдалося завантажити голосову модель",
  "settings.voices.ready.title": "Виберіть голос",
  "settings.voices.voices.empty": "Немає доступних голосів",
  "settings.voices.voice.probe": "Тест",
  "settings.voices.voice.speaking": "Стоп",
  "settings.voices.voice.probe.failed": "Не вдалося відтворити цей голос",
  "settings.voices.voice.unsupported": "Лише англійська",
  "settings.voices.select.title": "Активний голос",
  "settings.voices.autoSpeak.title": "Читати відповіді вголос",
  "settings.voices.autoSpeak.description": "Читає відповідь моделі вголос у реальному часі під час її генерації, використовуючи вибраний голос.",
  "settings.voices.gender.female": "Жіночий",
  "settings.voices.gender.male": "Чоловічий",
  "settings.voices.filter.all": "Усі",
  "settings.voices.filter.female": "Жіночий",
  "settings.voices.filter.male": "Чоловічий",
  "settings.voices.filter.spanish": "Іспанська",
  "settings.voices.pagination.prev": "Назад",
  "settings.voices.pagination.next": "Вперед",
  "settings.voices.pagination.page": "Сторінка {{current}} з {{total}}",
  "settings.voices.voice.info": "Деталі голосу",
  "settings.voices.voice.download": "Завантажити",
  "settings.voices.voice.downloading": "Завантаження…",
  "settings.voices.voice.delete": "Видалити",
  "settings.voices.voice.delete.confirm": "Видалити завантажені файли для {{name}}?",
  "settings.voices.voice.builtin": "Вбудований",
  "settings.voices.voice.engine.kokoro": "Kokoro",
  "settings.voices.voice.engine.piper": "Piper",
  "settings.voices.voice.license": "Ліцензія",
  "settings.voices.voice.enabled": "Увімкнено",
  "settings.voices.voice.size": "{{size}} МБ",
  "settings.voices.voice.download.success": "Голос завантажено",
  "settings.voices.voice.download.failed": "Не вдалося завантажити голос",
  "settings.voices.voice.delete.success": "Голос видалено",
  "settings.voices.voice.delete.failed": "Не вдалося видалити голос",
  "settings.tab.modelsHub": "Локальні моделі",
  "settings.modelsHub.title": "Локальні моделі",
  "settings.modelsHub.description": "Шукайте та завантажуйте моделі GGUF з HuggingFace, щоб запускати ШІ локально, як LM Studio.",
  "settings.modelsHub.search.placeholder": "Пошук моделей... наприклад llama 3.2",
  "settings.modelsHub.search.button": "Знайти",
  "settings.modelsHub.empty": "Моделей не знайдено. Спробуйте інший запит.",
  "settings.modelsHub.download": "Завантажити",
  "settings.modelsHub.download.downloading": "Завантаження",
  "settings.modelsHub.download.paused": "Призупинено",
  "settings.modelsHub.download.resume": "Відновити",
  "settings.modelsHub.download.delete": "Видалити",
  "settings.modelsHub.download.completed": "Завершено",
  "settings.modelsHub.download.failed": "Помилка",
  "settings.modelsHub.downloads.title": "Завантаження",
  "settings.modelsHub.recommended": "Рекомендовані",
  "settings.modelsHub.detail.files": "Файли",
  "settings.modelsHub.runtime.title": "Runtime",
  "settings.modelsHub.runtime.description": "Локальні середовища виконання інференсу, виявлені на цьому комп'ютері.",
  "settings.modelsHub.runtime.available": "Доступно",
  "settings.modelsHub.runtime.notDetected": "Не виявлено",
  "settings.modelsHub.provider.setup": "Налаштувати як провайдера",
  "settings.modelsHub.provider.ready": "Локальний провайдер готовий (модель: {name})",
  "settings.modelsHub.provider.failed": "Не вдалося налаштувати локального провайдера",
  "settings.modelsHub.recommended.title": "Рекомендована модель для вашого GPU",
  "settings.modelsHub.recommended.forYourGpu": "на основі виявленої VRAM",
  "settings.modelsHub.recommended.download": "Завантажити",
  "settings.modelsHub.runtime.hint": "Запускайте локальні моделі через Ollama або LM Studio і додавайте їх як провайдера в розділі Провайдери.",
  "settings.modelsHub.runtime.install": "Установити",
  "settings.modelsHub.runtime.install.downloading": "Завантаження",
  "settings.modelsHub.runtime.install.installing": "Установлення…",
  "settings.modelsHub.runtime.install.success": "{{name}} установлено. Відкрийте застосунок один раз, щоб завершити налаштування.",
  "settings.modelsHub.runtime.install.failed": "Не вдалося встановити середовище виконання",
  "settings.modelsHub.system.ram": "RAM",
  "settings.modelsHub.system.vram": "Пам'ять GPU (VRAM)",
  "settings.modelsHub.system.vramFree": "вільно:",
  "settings.modelsHub.memory.title": "Режим пам'яті",
  "settings.modelsHub.memory.gpu": "Використовувати пам'ять GPU (VRAM) як основну",
  "settings.modelsHub.memory.ram": "Використовувати системну RAM як резерв",
  "settings.modelsHub.system.dir": "Папка моделей",
  "settings.modelsHub.system.disk": "Вільне місце",
  "settings.modelsHub.system.gpu": "GPU",
  "settings.modelsHub.system.cpu": "CPU",
  "settings.modelsHub.fit.fullGpu": "Можливе повне розвантаження GPU",
  "settings.modelsHub.fit.partialGpu": "Можливе часткове розвантаження GPU",
  "settings.modelsHub.fit.ramOnly": "Вміститься без GPU",
  "settings.modelsHub.fit.noFit": "Не вміститься",
  "settings.modelsHub.desc.text-generation": "Генерація тексту",
  "settings.modelsHub.desc.image-text-to-text": "Зір",
  "settings.modelsHub.desc.text-to-image": "Генерація зображень",
  "settings.modelsHub.desc.image-to-image": "Редагування зображень",
  "settings.modelsHub.desc.image-classification": "Класифікація зображень",
  "settings.modelsHub.desc.token-classification": "Класифікація токенів",
  "settings.modelsHub.desc.text-classification": "Класифікація тексту",
  "settings.modelsHub.desc.question-answering": "Відповіді на запитання",
  "settings.modelsHub.desc.summarization": "Підсумовування",
  "settings.modelsHub.desc.translation": "Переклад",
  "settings.modelsHub.desc.fill-mask": "Fill-mask",
  "settings.modelsHub.desc.feature-extraction": "Виділення ознак",
  "settings.modelsHub.desc.automatic-speech-recognition": "Розпізнавання мовлення",
  "settings.modelsHub.desc.text-to-speech": "Текст у мову",
  "settings.modelsHub.desc.depth-estimation": "Оцінка глибини",
  "settings.modelsHub.desc.image-segmentation": "Сегментація зображень",
  "settings.modelsHub.desc.object-detection": "Виявлення об'єктів",
  ...
  "onboarding.title": "Ласкаво просимо до Tiancode",
  "onboarding.step": "Крок {{current}} з {{total}}",
  "onboarding.disclaimer.p1": "Tiancode — це ШІ-агент, який працює разом із вами: він може виконувати команди, редагувати файли та керувати завданнями на вашому комп'ютері, поки ви зберігаєте контроль.",
  "onboarding.disclaimer.p2": "Ваші промпти та вміст файлів можуть надсилатися налаштованим постачальникам ШІ-моделей для генерації відповідей.",
  "onboarding.disclaimer.p3": "Ви відповідаєте за те, як використовуєте Tiancode. Уважно перевіряйте зміни перед прийняттям і ніколи не запускайте команди, які не розумієте.",
  "onboarding.accept": "Прийняти та продовжити",
  "onboarding.preferences.title": "Зробіть його своїм",
  "onboarding.preferences.description": "Виберіть, як Tiancode виглядає та як з вами говорить. Це можна змінити будь-коли в Налаштуваннях.",
  "onboarding.theme.title": "Зовнішній вигляд",
  "onboarding.theme.light": "Світла",
  "onboarding.theme.dark": "Темна",
  "onboarding.language.title": "Мова",
  "onboarding.language.english": "Англійська",
  "onboarding.language.spanish": "Español",
  "onboarding.start": "Почати використовувати Tiancode",
}
