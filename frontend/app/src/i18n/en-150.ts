...
"prompt.action.stop": "Stop",
  ...
  "settings.computerUse.autoApprove": "Allow the agent to control applications",
  "settings.computerUse.autoApprove.description": "Automatically approve computer-use actions when the model requests them",
  "settings.computerUse.autoApprove.note": "Direct control of applications depends on the model provider; Tiancode lets you automatically approve computer-use actions when the model supports them.",
  "settings.computerUse.screenshot": "Screen capture is included: you can screenshot the screen, a window or the live view and attach it to the conversation.",
...
"settings.mcpServers.group.unknown": "Unknown",
  ...
  "prompt.optimize.empty": "Please enter text first",
  "prompt.optimize.optimizing": "Optimizing input...",
  ...
  "settings.intelligence.autoSkill": "Skill auto-distillation (/learn)",
  "settings.intelligence.autoSkill.desc": "Suggests packaging successful complex workflows into reusable SKILL.md files automatically.",
  "settings.intelligence.section.codegraph": "Code Graph & AST",
  ...
  "settings.intelligence.monaco": "Monaco diff viewer",
  "settings.intelligence.monaco.desc": "Shows side-by-side visual comparisons with syntax highlighting before applying patches.",
  "settings.intelligence.section.safety": "Web & Execution Safety",
  "settings.intelligence.cleanWeb": "Clean web extraction (Firecrawl engine)",
  "settings.intelligence.cleanWeb.desc": "Strips scripts, cookies and menus to turn web pages into clean LLM-optimized Markdown.",
  "settings.intelligence.guardrails": "Guardrails & secret redaction pipeline",
  "settings.intelligence.guardrails.desc": "Masks passwords, tokens and private keys before sending requests to external providers.",
  "settings.intelligence.sandbox": "Sandboxed execution mode",
