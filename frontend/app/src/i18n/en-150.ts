...
"prompt.action.stop": "Stop",
  ...
  "settings.connections.description": "Integrate Tiancode with Telegram, WhatsApp, Discord, Slack, and Webhooks inspired by OpenClaw and Hermes Agent gateways.",
  "settings.connections.telegram.title": "Telegram Bot Gateway",
  "settings.connections.telegram.token": "Bot Token",
  "settings.connections.telegram.tokenMissing": "Enter the Telegram Bot Token",
  "settings.connections.telegram.testSuccess": "Connected to Telegram successfully!",
  "settings.connections.telegram.chatId": "Chat ID / User",
  "settings.connections.telegram.pairing": "Interactive Bi-directional Pairing",
  "settings.connections.telegram.pairingDescription": "Allows Tiancode to receive /run, /status commands and approve critical permissions directly from Telegram.",
  "settings.connections.telegram.notifyBuilds": "Build notifications",
  "settings.connections.whatsapp.title": "WhatsApp Gateway",
  "settings.connections.whatsapp.phone": "WhatsApp Phone / ID",
  "settings.connections.whatsapp.phoneMissing": "Enter your WhatsApp phone number",
  "settings.connections.whatsapp.pairedSuccess": "Pairing Code generated",
  "settings.connections.whatsapp.pairingMode": "Pairing Method",
  "settings.connections.whatsapp.notifyBuilds": "Build and test notifications",
  "settings.connections.whatsapp.notifyErrors": "Critical exception alerts",
  "settings.connections.discord.title": "Discord",
  "settings.connections.discord.authMode": "Connection Method",
  "settings.connections.discord.channel": "Alerts Channel",
  "settings.connections.discord.notifyBuilds": "Build and commit notifications",
  "settings.connections.discord.missingTarget": "Enter a Webhook URL or Discord Token",
  "settings.connections.discord.testSuccess": "Test message sent to Discord",
  "settings.connections.slack.title": "Slack",
  "settings.connections.slack.webhook": "Incoming Webhook URL",
  "settings.connections.slack.channel": "Default Channel",
  "settings.connections.slack.notifyBackground": "Background notifications",
  "settings.connections.slack.missingUrl": "Enter the Slack Incoming Webhook URL",
  "settings.connections.slack.testSuccess": "Slack Webhook verified",
  ...
  "settings.connections.webhooks.missingUrl": "Enter the Endpoint URL",
  "settings.connections.webhooks.testSuccess": "Test payload sent",
