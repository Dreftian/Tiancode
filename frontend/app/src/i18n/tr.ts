...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Tiancode yüklenemedi",
  "desktop.recovery.terminated": "Tiancode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Tiancode yanıt vermiyor",
  ...
  "desktop.wsl.error.tiancodeNotInstalled": "Tiancode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Tiancode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.tiancode.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.tiancode.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.tiancodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Tiancode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Tiancode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.tiancodeZen.line1":
    "Tiancode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.tiancodeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Tiancode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Tiancode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler tiancode.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Tiancode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Tiancode kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Tiancode kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Tiancode güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Tiancode güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Tiancode'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Tiancode'u güncelle",
  "wsl.onboarding.tiancodeReadyIn": "{{distro}} içinde Tiancode hazır.",
  "wsl.onboarding.tiancodeReady": "Tiancode hazır.",
  "wsl.onboarding.installOpencodeIn": "Tiancode'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Tiancode'u kur",
  ...
  "wsl.onboarding.distroStatus.tiancodeMissing": "Tiancode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Tiancode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Tiancode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Tiancode'u tekrar açın.",
  ...
  "help.tabs.introduction": "Tiancode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Tiancode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Tiancode ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (tiancode.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Tiancode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Tiancode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Tiancode Masaüstü",
  ...
  "settings.desktop.wsl.description": "Tiancode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Tiancode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Tiancode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Tiancode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tiancode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Tiancode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Tiancode'un en son sürümünü kullanıyorsunuz.",
  ...
  "a11y.closeTab": "Sekmeyi kapat",
  "a11y.clearSearch": "Aramayı temizle",
  "a11y.edit": "Düzenle",
  "chat.mic.start": "Mikrofonla dikte et",
  ...
  "chat.message.speak.failed": "Yanıt sesli okunamadı",
  "preview.title": "Dahili tarayıcı",
  "preview.open": "Dahili tarayıcıyı aç",
  "preview.close": "Tarayıcıyı kapat",
  "preview.back": "Geri",
  "preview.forward": "İleri",
  "preview.reload": "Yenile",
  "preview.go": "Git",
  "preview.url": "Web adresi",
  "settings.general.row.minimizeToTray.title": "Sistem tepsisine küçült",
  "settings.general.row.minimizeToTray.description": "Pencere kapatıldığında çıkış yapmak yerine sistem tepsisine küçültülür",
  "settings.general.row.fileWatcher.title": "Gerçek zamanlı dosya güncellemeleri",
  "settings.general.row.fileWatcher.description": "Dosya ağacını ve git değişikliklerini otomatik olarak yeniler.",
  "settings.general.fileWatcher.restart.confirm": "Gerçek zamanlı dosya güncellemesi değişikliğini uygulamak için Tiancode'u yeniden başlatılsın mı?",
  "session.export.button": "Sohbeti Markdown olarak dışa aktar",
  "session.export.title": "Sohbeti dışa aktar",
  "session.export.success": "Sohbet dışa aktarıldı",
  "session.export.failed": "Sohbet dışa aktarılamadı",
  "settings.general.section.data": "Veri",
  "settings.general.row.autoBackup.title": "Otomatik yedekleme",
  "settings.general.row.autoBackup.description": "Oturumların ve yapılandırmanın günlük kopyası (son 7 gün saklanır)",
  "settings.general.row.backupNow.title": "Şimdi yedekle",
  "settings.general.row.backupNow.description": "Verilerinizin anında kopyasını oluşturun",
  "settings.general.row.backupNow.button": "Yedek oluştur",
  "settings.general.row.restore.title": "Geri yükle",
  "settings.general.row.restore.description": "Önceki bir yedeği kurtarın (uygulama yeniden başlar)",
  "settings.general.row.restore.button": "Geri yükle",
  "settings.general.backup.now.success": "Yedek oluşturuldu",
  "settings.general.backup.now.failed": "Henüz yedeklenecek veri yok",
  "settings.general.backup.restore.confirm": "{name} yedeği geri yüklensin mi? Geçerli oturumlar ve yapılandırma değiştirilecek.",
  "settings.general.backup.restore.success": "Yedek geri yüklendi",
  "settings.general.backup.restore.failed": "Yedek geri yüklenemedi",
  "settings.general.row.loginItem.title": "Başlangıçta başlat",
  "settings.general.row.loginItem.description": "Windows'ta oturum açtığınızda Tiancode'u otomatik olarak açın",
  "settings.section.extensions": "Uzantılar",
  "settings.tab.plugins": "Eklentiler",
  "settings.tab.skills": "Yetenekler",
  "settings.tab.subAgents": "Alt Ajanlar",
  "settings.tab.mcpServers": "MCP Sunucuları",
  "settings.tab.github": "Github",
  "settings.tab.voices": "Sesler",
  "settings.skills.title": "Yetenekler",
  "settings.skills.description": "Bilgisayarınızdan yetenek içe aktarın veya web'de yayınlanmış yetenekleri indirin.",
  "settings.skills.section.installed": "Yüklü",
  "settings.skills.autoSelect.title": "Yetenekleri otomatik seç",
  "settings.skills.autoSelect.description": "Her sohbette projenizle eşleşen yetenekleri (çerçeve, araçlar vb.) otomatik olarak seçin",
  "settings.skills.section.import": "Yetenek içe aktar",
  "settings.skills.empty": "Henüz yetenek yüklenmemiş",
  "settings.skills.import.folder.title": "Klasörden içe aktar",
  "settings.skills.import.folder.description": "SKILL.md dosyası içeren bir yetenek klasörü seçin",
  "settings.skills.import.folder.button": "Klasör seç",
  "settings.skills.import.url.title": "URL'den indir",
  "settings.skills.import.url.description": "İndirmek için yayınlanmış bir yeteneğin URL'sini yapıştırın",
  "settings.skills.import.url.placeholder": "https://example.com/skills/my-skill",
  "settings.skills.import.url.button": "İndir",
  "settings.skills.search.google": "Google'da yayınlanmış yetenekleri ara",
  "settings.skills.importing": "İçe aktarılıyor...",
  "settings.skills.import.success": "Yetenek içe aktarıldı",
  "settings.skills.import.failed": "Yetenek içe aktarılamadı",
  "settings.subAgents.title": "Alt Ajanlar",
  "settings.subAgents.description": "Ana ajanın görevlendirebileceği kendi alt ajanlarınızı oluşturun.",
  "settings.subAgents.list.new": "Yeni alt ajan",
  "settings.subAgents.list.search.placeholder": "Alt ajanları ara",
  "settings.subAgents.list.search.clear": "Aramayı temizle",
  "settings.subAgents.list.filter.all": "Tümü",
  "settings.subAgents.list.filter.enabled": "Etkin",
  "settings.subAgents.list.filter.disabled": "Devre dışı",
  "settings.subAgents.list.group.user": "Kullanıcı alt ajanları",
  "settings.subAgents.list.group.builtin": "Yerleşik alt ajanlar",
  "settings.subAgents.list.builtin.hint": "burada düzenlenemez",
  "settings.subAgents.list.empty": "Alt ajan bulunamadı",
  "settings.subAgents.list.footer": "{{count}} alt ajan · {{enabled}} etkin",
  "settings.subAgents.list.model.inherit": "devral",
  "settings.subAgents.list.tools.all": "Tüm araçlar",
  "settings.subAgents.list.tools.summary": "{{count}} araç",
  "settings.subAgents.list.edit": "Alt ajanı düzenle",
  "settings.subAgents.list.delete": "Alt ajanı sil",
  "settings.subAgents.form.new.title": "Yeni alt ajan",
  "settings.subAgents.form.edit.title": "{{name}} düzenle",
  "settings.subAgents.form.field.name": "Ad",
  "settings.subAgents.form.field.name.placeholder": "code-reviewer",
  "settings.subAgents.form.field.color": "Renk",
  "settings.subAgents.form.color.yellow": "Sarı",
  "settings.subAgents.form.color.red": "Kırmızı",
  "settings.subAgents.form.color.orange": "Turuncu",
  "settings.subAgents.form.color.green": "Yeşil",
  "settings.subAgents.form.color.cyan": "Camgöbeği",
  "settings.subAgents.form.color.blue": "Mavi",
  "settings.subAgents.form.color.purple": "Mor",
  "settings.subAgents.form.color.pink": "Pembe",
  "settings.subAgents.form.field.model": "Model",
  "settings.subAgents.form.field.model.placeholder": "provider/model",
  "settings.subAgents.form.model.inherit": "devral",
  "settings.subAgents.form.model.custom": "Özel...",
  "settings.subAgents.form.field.description": "Açıklama",
  "settings.subAgents.form.field.description.placeholder": "Modele gösterilen kısa açıklama",
  "settings.subAgents.form.field.tools": "İzin verilen araçlar",
  "settings.subAgents.form.tools.all": "Tüm izinler varsayılan",
  "settings.subAgents.form.tools.custom": "Özel izin verilen araçlar",
  "settings.subAgents.form.tools.sensitive": "hassas",
  "settings.subAgents.form.tools.read": "Oku",
  "settings.subAgents.form.tools.grep": "Grep",
  "settings.subAgents.form.tools.glob": "Glob",
  "settings.subAgents.form.tools.bash": "Bash",
  "settings.subAgents.form.tools.edit": "Düzenle",
  ...
  "settings.subAgents.form.field.prompt": "Sistem istemi",
  "settings.subAgents.form.field.prompt.placeholder": "Bu alt ajanın rolünü ve kurallarını açıklayın...",
  "settings.subAgents.form.field.injectAgentsMd": "AGENTS.md ekle",
  "settings.subAgents.form.field.injectAgentsMd.description": "Çalışma alanındaki AGENTS.md dosyasını bu alt ajanın bağlamına dahil edin",
  "settings.subAgents.form.workspace.unsupported": "Çalışma alanı düzeyinde oluşturma veya düzenleme desteklenmiyor",
  "settings.subAgents.form.save": "Kaydet",
  "settings.subAgents.form.saving": "Kaydediliyor...",
  "settings.subAgents.form.cancel": "İptal",
  "settings.subAgents.form.delete": "Sil",
  "settings.subAgents.form.delete.confirm": "\"{{name}}\" alt ajanı silinsin mi?",
  "settings.subAgents.form.success": "Alt ajan oluşturuldu",
  "settings.subAgents.form.failed": "Alt ajan oluşturulamadı",
  "settings.subAgents.form.updated": "Alt ajan güncellendi",
  "settings.subAgents.form.updateFailed": "Alt ajan güncellenemedi",
  "settings.subAgents.form.deleted": "Alt ajan silindi",
  "settings.subAgents.form.deleteFailed": "Alt ajan silinemedi",
  "settings.subAgents.native.build": "Varsayılan ajan. Araçları yapılandırılmış izinlere göre yürütür.",
  "settings.subAgents.native.plan": "Plan modu. Tüm düzenleme araçlarını engeller.",
  "settings.subAgents.native.general": "Karmaşık soruları araştırmak ve çok adımlı görevleri yürütmek için genel amaçlı ajan.",
  "settings.subAgents.native.explore": "Kod tabanlarını keşfetme ve dosya bulma konusunda uzmanlaşmış hızlı ajan.",
  "settings.subAgents.native.compaction": "Oturum geçmişini sıkıştırmak için dahili ajan.",
  "settings.subAgents.native.title": "Sohbet başlıkları oluşturmak için dahili ajan.",
  "settings.subAgents.native.summary": "Oturumları özetlemek için dahili ajan.",
  "settings.plugins.title": "Eklentiler",
  "settings.plugins.description": "Ajanı, yaşam döngüsü olaylarına bağlanan npm paketleri veya yerel eklenti dosyalarıyla genişletin.",
  "settings.plugins.note.title": "Eklenti nedir?",
  "settings.plugins.note.description": "Eklentiler ajan sürecinin içinde çalışır ve oturum boşta kalması, araç yürütme ve kabuk ortamı kurulumu gibi yaşam döngüsü olaylarına tepki verir.",
  "settings.plugins.section.installed": "Yüklü",
  "settings.plugins.section.add": "Eklenti ekle",
  "settings.plugins.empty": "Henüz eklenti yüklenmemiş",
  "settings.plugins.add.label": "Paket veya yerel dosya",
  "settings.plugins.add.placeholder": "opencode-wakatime, @my-org/custom-plugin veya ./plugins/my-plugin.ts",
  "settings.plugins.add.button": "Ekle",
  "settings.plugins.add.success": "Eklenti eklendi",
  "settings.plugins.add.failed": "Eklenti eklenemedi",
  "settings.plugins.remove": "Kaldır",
  "settings.plugins.remove.confirm": "\"{{name}}\" eklentisi kaldırılsın mı?",
  "settings.plugins.remove.success": "Eklenti kaldırıldı",
  "settings.plugins.remove.failed": "Eklenti kaldırılamadı",
  "settings.plugins.origin.npm": "npm · Tian kuralını gerektirir",
  "settings.plugins.origin.local": "yerel",
  "settings.plugins.catalog.npm.title": "Popüler npm uygulamaları",
  "settings.plugins.catalog.npm.description": "Tian'ın eklenti kuralına uyan doğrulanmış paketler.",
  "settings.plugins.catalog.npm.note": "npm paketleri Tian'ın eklenti kuralını uygulamalıdır",
  "settings.plugins.catalog.local.title": "Yerel eklentiler",
  "settings.plugins.catalog.local.description": "Bu depoyla birlikte .tiancode/plugins altında gelen eklentiler.",
  "settings.plugins.catalog.add": "Ekle",
  "settings.plugins.catalog.installed": "Yüklü",
  "settings.plugins.catalog.npm.biome.description": "JavaScript ve TypeScript için hızlı linter ve biçimlendirici.",
  "settings.plugins.catalog.npm.playwrightMcp.description": "Web uygulamaları için tarayıcı otomasyonu ve E2E testi.",
  "settings.plugins.catalog.npm.octokitRest.description": "Pull request, sorun ve depolar için GitHub API istemcisi.",
  "settings.plugins.catalog.npm.slackWebApi.description": "Mesajlar ve sohbetler için resmi Slack Web API istemcisi.",
  "settings.plugins.catalog.npm.notionClient.description": "Sayfalar, veritabanları ve bloklar için resmi Notion API istemcisi.",
  "settings.plugins.catalog.npm.sentryCli.description": "Sentry hata izleme, sürümler ve source map yüklemeleri.",
  "settings.plugins.catalog.npm.agentNotify.description": "Ajan görevleri tamamlandığında veya başarısız olduğunda bildirim gönderir.",
  "settings.plugins.catalog.npm.chimeClaude.description": "Ajan yaşam döngüsü olayları için Telegram bildirimleri.",
  "settings.plugins.catalog.local.envGuard.description": ".env dosyalarını yanlışlıkla yapılan düzenlemelerden korur.",
  "settings.plugins.catalog.local.commitHelper.description": "Kurallı (conventional) commit mesajları yazmaya yardımcı olur.",
  "settings.plugins.catalog.local.notifyIdle.description": "Bir oturum boşta kaldığında sizi bilgilendirir.",
  "settings.plugins.catalog.local.shellEnv.description": "Kabuk aracı süreçlerine ortam değişkenleri enjekte eder.",
  "settings.plugins.catalog.local.permissionGuard.description": "Açık onay gerektiren riskli araç çağrılarını engeller.",
  "settings.plugins.template.title": "Yeni eklenti",
  "settings.plugins.template.description": "En yaygın yaşam döngüsü kancalarına sahip bir eklenti iskeleti oluşturur. Bir dosyaya kopyalayın ve yukarıya ekleyin.",
  ...
  "settings.mcpServers.description": "Ajanı Model Context Protocol (MCP) sunucuları aracılığıyla harici araçlara bağlayın.",
  "settings.mcpServers.section.servers": "Sunucular",
  "settings.mcpServers.section.add": "Sunucu ekle",
  "settings.mcpServers.edit.title": "Sunucuyu düzenle",
  "settings.mcpServers.empty": "Henüz MCP sunucusu yapılandırılmadı",
  "settings.mcpServers.add.button": "Sunucu ekle",
  "settings.mcpServers.save.button": "Kaydet",
  "settings.mcpServers.cancel.button": "İptal",
  "settings.mcpServers.saving": "Kaydediliyor...",
  "settings.mcpServers.field.name": "Ad",
  "settings.mcpServers.field.name.placeholder": "filesystem",
  "settings.mcpServers.field.type": "Tür",
  "settings.mcpServers.type.local": "Yerel (stdio)",
  "settings.mcpServers.type.remote": "Uzak (HTTP/SSE)",
  "settings.mcpServers.field.command": "Komut",
  "settings.mcpServers.field.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem /path",
  "settings.mcpServers.field.command.hint": "İpucu: Windows'ta npx, uvx, node veya cmd /c npx",
  "settings.mcpServers.field.environment": "Ortam (satır başına KEY=VALUE)",
  "settings.mcpServers.field.environment.placeholder": "API_KEY=sk-...",
  "settings.mcpServers.field.cwd": "Çalışma dizini (isteğe bağlı)",
  "settings.mcpServers.field.timeout": "Saniye cinsinden zaman aşımı (isteğe bağlı)",
  "settings.mcpServers.field.url": "URL",
  "settings.mcpServers.field.url.placeholder": "https://example.com/mcp",
  "settings.mcpServers.field.headers": "Başlıklar (satır başına KEY=VALUE)",
  "settings.mcpServers.field.oauth": "OAuth",
  "settings.mcpServers.presets.title": "Hazır ayarlar",
  ...
  "settings.mcpServers.status.connected": "Bağlı",
  "settings.mcpServers.status.disabled": "Devre dışı",
  "settings.mcpServers.status.failed": "Hata",
  "settings.mcpServers.status.needs_auth": "Kimlik doğrulama gerekli",
  "settings.mcpServers.status.needs_client_registration": "Kayıt gerekli",
  "settings.mcpServers.status.unknown": "Bilinmiyor",
  "settings.mcpServers.action.connect": "Bağlan",
  "settings.mcpServers.action.disconnect": "Bağlantıyı kes",
  "settings.mcpServers.action.edit": "Düzenle",
  "settings.mcpServers.action.export": "Dışa aktar",
  "settings.mcpServers.action.remove": "Kaldır",
  "settings.mcpServers.remove.confirm": "\"{{name}}\" sunucusu kaldırılsın mı?",
  "settings.mcpServers.add.success": "Sunucu kaydedildi",
  "settings.mcpServers.add.failed": "Sunucu kaydedilemedi",
  "settings.mcpServers.export.success": "Yapılandırma panoya kopyalandı",
  "settings.mcpServers.export.failed": "Yapılandırma kopyalanamadı",
  "settings.mcpServers.search.placeholder": "Sunucuları ara...",
  "settings.mcpServers.search.empty": "Aramanızla eşleşen sunucu yok",
  "settings.mcpServers.group.connected": "Bağlı",
  "settings.mcpServers.group.errors": "Hatalar",
  "settings.mcpServers.group.disabled": "Devre dışı",
  "settings.mcpServers.group.unknown": "Bilinmiyor",
  "settings.mcpServers.tools.count": "{{count}} araç",
  "settings.mcpServers.save.changes": "Değişiklikleri kaydet",
  "settings.mcpServers.discover.title": "Keşfet",
  "settings.mcpServers.discover.description": "Tek tıkla ekleyebileceğiniz popüler MCP sunucuları.",
  "settings.mcpServers.discover.requiresKey": "API anahtarı gerektirir — ekledikten sonra düzenleyin",
  "settings.mcpServers.discover.presets.android-emulator.name": "Android Emulator",
  "settings.mcpServers.discover.presets.android-emulator.description": "Android emülatörlerini, ekranlarını ve uygulamalarını ajandan kontrol edin.",
  "settings.mcpServers.discover.presets.node-repl.name": "Node REPL",
  "settings.mcpServers.discover.presets.node-repl.description": "JavaScript'i Node.js REPL oturumunda çalıştırın.",
  "settings.mcpServers.discover.presets.ios-simulator.name": "iOS Simulator",
  "settings.mcpServers.discover.presets.ios-simulator.description": "iOS simülatörünü ve uygulamalarını kontrol edin (Xcode gerekli).",
  "settings.mcpServers.discover.presets.chrome-devtools.name": "Chrome DevTools",
  "settings.mcpServers.discover.presets.chrome-devtools.description": "Chrome sayfalarını inceleyin, hata ayıklayın ve otomatikleştirin.",
  "settings.mcpServers.discover.presets.playwright.name": "Playwright",
  "settings.mcpServers.discover.presets.playwright.description": "Tarayıcı otomasyonu ve uçtan uca web testi.",
  "settings.mcpServers.discover.presets.context7.name": "Context7",
  "settings.mcpServers.discover.presets.context7.description": "Popüler kitaplıklar ve çerçeveler için güncel belgeler.",
  "settings.mcpServers.discover.presets.agent-vision.name": "Agent Vision",
  "settings.mcpServers.discover.presets.agent-vision.description": "Görüşü olmayan modellere göz kazandırır: OpenAI uyumlu herhangi bir vision API (OpenAI, Gemini, Qwen-VL) ile görüntüleri, ekran görüntülerini ve belgeleri (OCR) analiz edin. Etkinleştirdikten sonra sunucu düzenleyicisinde Environment altına VISION_API_KEY ekleyin.",
  "capture.menu.title": "Ekran görüntüsü al",
  "capture.screen": "Tam ekran",
  "capture.window": "Uygulama penceresi",
  "capture.area": "Alan seç…",
  "capture.preview": "Dahili tarayıcı",
  "capture.area.title": "Yakalanacak alanı seçin (onaylamak için Enter, iptal etmek için Esc)",
  "capture.area.cancel": "İptal",
  "capture.area.confirm": "Alanı yakala",
  "settings.mcpServers.discover.presets.aikido.name": "Aikido",
  "settings.mcpServers.discover.presets.aikido.description": "Güvenlik sorunları için kodu ve bağımlılıkları tarayın.",
  "settings.mcpServers.discover.presets.airwallex.name": "Airwallex",
  "settings.mcpServers.discover.presets.airwallex.description": "Ödemeler, hazine ve kart çıkarma API'leri.",
  "settings.mcpServers.discover.presets.canva.name": "Canva",
  "settings.mcpServers.discover.presets.canva.description": "Canva tasarımları oluşturun ve düzenleyin (OAuth).",
  "settings.mcpServers.discover.presets.circle.name": "Circle",
  "settings.mcpServers.discover.presets.circle.description": "USDC ödemeleri ve geliştirici kontrollü cüzdanlar.",
  "settings.mcpServers.discover.presets.appwrite.name": "Appwrite",
  "settings.mcpServers.discover.presets.appwrite.description": "Uygulamalarınız için kimlik doğrulama, veritabanları ve depolama (OAuth).",
  "settings.mcpServers.discover.presets.apollo.name": "Apollo",
  "settings.mcpServers.discover.presets.apollo.description": "Apollo GraphOS grafiğinizi sorgulayın (OAuth).",
  "settings.mcpServers.discover.presets.graphos-tools.name": "GraphOS Tools",
  "settings.mcpServers.discover.presets.graphos-tools.description": "Apollo GraphOS çalışma alanlarını ve şemalarını yönetin.",
  "settings.mcpServers.discover.presets.atlan.name": "Atlan",
  "settings.mcpServers.discover.presets.atlan.description": "Veri kataloğunuzu ve yönetişim varlıklarınızı arayın (OAuth).",
  "settings.mcpServers.discover.presets.awsknowledge.name": "AWS Knowledge",
  "settings.mcpServers.discover.presets.awsknowledge.description": "AWS hizmet belgeleri ve bilgi tabanı.",
  "settings.github.title": "Github",
  "settings.github.description": "Depoları klonlamak, yenilerini oluşturmak ve projelerinizde git işlemleri çalıştırmak için GitHub hesabınızı bağlayın.",
  "settings.github.loading": "Yükleniyor...",
  "settings.github.connect.title": "GitHub'a bağlan",
  "settings.github.connect.description": "GitHub ile kimlik doğrulamak için bir kişisel erişim belirteci yapıştırın. Belirteç yerel olarak saklanır ve klonlama ile kimliği doğrulanmış git işlemleri için kullanılır.",
  "settings.github.connect.token.placeholder": "github_pat_... or ghp_...",
  "settings.github.connect.hint": "github.com/settings/tokens adresinde bir belirteç oluşturun (repo kapsamına sahip ayrıntılı)",
  "settings.github.connect.button": "Bağlan",
  "settings.github.connecting": "Bağlanılıyor...",
  "settings.github.connect.success": "GitHub hesabı bağlandı",
  "settings.github.connect.failed": "GitHub'a bağlanılamadı. Belirtecinizi kontrol edip tekrar deneyin.",
  "settings.github.connected.title": "Bağlanan hesap",
  "settings.github.disconnect.button": "Bağlantıyı kes",
  "settings.github.disconnect.confirm": "GitHub hesabınızın bağlantısı kesilsin mi? Saklanan belirteç kaldırılacak.",
  "settings.github.disconnect.success": "GitHub hesabının bağlantısı kesildi",
  "settings.github.disconnect.failed": "GitHub bağlantısı kesilemedi",
  "settings.github.refresh": "Yenile",
  "settings.github.repos.title": "Depolar",
  "settings.github.repos.search.placeholder": "Depolarınızı arayın...",
  "settings.github.repos.empty": "Depo bulunamadı",
  "settings.github.repo.private": "Özel",
  "settings.github.repo.public": "Genel",
  "settings.github.repo.clone": "Klonla",
  "settings.github.repo.cloning": "Klonlanıyor...",
  "settings.github.repo.clone.success": "{{directory}} konumuna klonlandı",
  "settings.github.repo.clone.failed": "Depo klonlanamadı",
  "settings.github.create.title": "Depo oluştur",
  "settings.github.create.name": "Ad",
  "settings.github.create.name.placeholder": "my-repository",
  "settings.github.create.private": "Özel",
  "settings.github.create.button": "Oluştur",
  "settings.github.create.success": "Depo oluşturuldu",
  "settings.github.create.failed": "Depo oluşturulamadı",
  "settings.github.project.title": "Geçerli proje",
  "settings.github.project.noRemote": "Bu projenin henüz bir git remote'u yok — GitHub'da bir depo oluşturun ve remote'u ekleyin.",
  "settings.github.commit.placeholder": "Commit mesajı...",
  "settings.github.commit.button": "Commit",
  "settings.github.commit.success": "Commit'lendi",
  "settings.github.commit.failed": "Commit başarısız",
  "settings.github.push.button": "Push",
  "settings.github.push.success": "Push yapıldı",
  "settings.github.push.failed": "Push başarısız",
  "settings.github.pull.button": "Pull",
  "settings.github.pull.success": "Pull yapıldı",
  "settings.github.pull.failed": "Pull başarısız",
  "settings.voices.title": "Sesler",
  "settings.voices.description": "Asistan yanıtlarını sesli okumak için bir ses seçin ve ücretsiz ses modelini test edin.",
  "settings.voices.desktopOnly": "Sesler masaüstü uygulamasında kullanılabilir.",
  "settings.voices.loading": "Yükleniyor...",
  "settings.voices.download.title": "Ses modeli yüklenmemiş",
  "settings.voices.download.description": "Bilgisayarınızda konuşma sentezlemek için ücretsiz kokoro ses modelini (~325MB) indirin. Sesler cihazınızdan asla çıkmaz.",
  "settings.voices.download.button": "Ses modelini indir",
  "settings.voices.download.downloading": "Ses modeli indiriliyor...",
  "settings.voices.download.progress": "{{file}} indiriliyor",
  "settings.voices.download.failed": "Ses modeli indirilemedi",
  "settings.voices.ready.title": "Bir ses seçin",
  "settings.voices.voices.empty": "Kullanılabilir ses yok",
  "settings.voices.voice.probe": "Test et",
  "settings.voices.voice.speaking": "Durdur",
  "settings.voices.voice.probe.failed": "Bu ses çalınamadı",
  "settings.voices.voice.unsupported": "Yalnızca İngilizce",
  "settings.voices.select.title": "Etkin ses",
  "settings.voices.autoSpeak.title": "Yanıtları sesli oku",
  "settings.voices.autoSpeak.description": "Modelin yanıtını, seçilen ses kullanılarak oluşturulurken gerçek zamanlı olarak okur.",
  "settings.voices.gender.female": "Kadın",
  "settings.voices.gender.male": "Erkek",
  "settings.voices.filter.all": "Tümü",
  "settings.voices.filter.female": "Kadın",
  "settings.voices.filter.male": "Erkek",
  "settings.voices.filter.spanish": "İspanyolca",
  "settings.voices.pagination.prev": "Önceki",
  "settings.voices.pagination.next": "Sonraki",
  "settings.voices.pagination.page": "Sayfa {{current}} / {{total}}",
  "settings.voices.voice.info": "Ses ayrıntıları",
  "settings.voices.voice.download": "İndir",
  "settings.voices.voice.downloading": "İndiriliyor…",
  "settings.voices.voice.delete": "Sil",
  "settings.voices.voice.delete.confirm": "{{name}} için indirilen dosyalar silinsin mi?",
  "settings.voices.voice.builtin": "Yerleşik",
  "settings.voices.voice.engine.kokoro": "Kokoro",
  "settings.voices.voice.engine.piper": "Piper",
  "settings.voices.voice.license": "Lisans",
  "settings.voices.voice.enabled": "Etkin",
  "settings.voices.voice.size": "{{size}} MB",
  "settings.voices.voice.download.success": "Ses indirildi",
  "settings.voices.voice.download.failed": "Ses indirilemedi",
  "settings.voices.voice.delete.success": "Ses silindi",
  "settings.voices.voice.delete.failed": "Ses silinemedi",
  "settings.tab.modelsHub": "Yerel Modeller",
  "settings.modelsHub.title": "Yerel Modeller",
  "settings.modelsHub.description": "LM Studio gibi AI'yı yerel olarak çalıştırmak için HuggingFace'ten GGUF modellerini arayın ve indirin.",
  "settings.modelsHub.search.placeholder": "Modelleri ara... örn. llama 3.2",
  "settings.modelsHub.search.button": "Ara",
  "settings.modelsHub.empty": "Model bulunamadı. Başka bir arama deneyin.",
  "settings.modelsHub.download": "İndir",
  "settings.modelsHub.download.downloading": "İndiriliyor",
  "settings.modelsHub.download.paused": "Duraklatıldı",
  "settings.modelsHub.download.resume": "Sürdür",
  "settings.modelsHub.download.delete": "Sil",
  "settings.modelsHub.download.completed": "Tamamlandı",
  "settings.modelsHub.download.failed": "Başarısız",
  "settings.modelsHub.downloads.title": "İndirmeler",
  "settings.modelsHub.recommended": "Önerilen",
  "settings.modelsHub.detail.files": "Dosyalar",
  "settings.modelsHub.runtime.title": "Çalışma zamanı",
  "settings.modelsHub.runtime.description": "Bu makinede algılanan yerel çıkarım çalışma zamanları.",
  "settings.modelsHub.runtime.available": "Kullanılabilir",
  "settings.modelsHub.runtime.notDetected": "Algılanmadı",
  "settings.modelsHub.provider.setup": "Sağlayıcı olarak ayarla",
  "settings.modelsHub.provider.ready": "Yerel sağlayıcı hazır (model: {name})",
  "settings.modelsHub.provider.failed": "Yerel sağlayıcı ayarlanamadı",
  "settings.modelsHub.recommended.title": "GPU'nuz için önerilen model",
  "settings.modelsHub.recommended.forYourGpu": "algılanan VRAM'inize göre",
  "settings.modelsHub.recommended.download": "İndir",
  "settings.modelsHub.runtime.hint": "Yerel modelleri Ollama veya LM Studio üzerinden çalıştırın ve Sağlayıcılar bölümünde sağlayıcı olarak ekleyin.",
  "settings.modelsHub.runtime.install": "Yükle",
  "settings.modelsHub.runtime.install.downloading": "İndiriliyor",
  "settings.modelsHub.runtime.install.installing": "Yükleniyor…",
  "settings.modelsHub.runtime.install.success": "{{name}} yüklendi. Kurulumu bitirmek için uygulamayı bir kez açın.",
  "settings.modelsHub.runtime.install.failed": "Çalışma zamanı yüklenemedi",
  "settings.modelsHub.system.ram": "RAM",
  "settings.modelsHub.system.vram": "GPU belleği (VRAM)",
  "settings.modelsHub.system.vramFree": "boş:",
  "settings.modelsHub.memory.title": "Bellek modu",
  "settings.modelsHub.memory.gpu": "GPU belleğini (VRAM) birincil olarak kullan",
  "settings.modelsHub.memory.ram": "Sistem RAM'ini yedek olarak kullan",
  "settings.modelsHub.system.dir": "Modeller klasörü",
  "settings.modelsHub.system.disk": "Boş disk",
  "settings.modelsHub.system.gpu": "GPU",
  "settings.modelsHub.system.cpu": "CPU",
  "settings.modelsHub.fit.fullGpu": "Tam GPU Aktarımı Mümkün",
  "settings.modelsHub.fit.partialGpu": "Kısmi GPU Aktarımı Mümkün",
  "settings.modelsHub.fit.ramOnly": "GPU olmadan sığar",
  "settings.modelsHub.fit.noFit": "Sığmayacak",
  "settings.modelsHub.desc.text-generation": "Metin üretimi",
  "settings.modelsHub.desc.image-text-to-text": "Görüş",
  "settings.modelsHub.desc.text-to-image": "Görüntü üretimi",
  "settings.modelsHub.desc.image-to-image": "Görüntü düzenleme",
  "settings.modelsHub.desc.image-classification": "Görüntü sınıflandırma",
  "settings.modelsHub.desc.token-classification": "Belirteç sınıflandırma",
  "settings.modelsHub.desc.text-classification": "Metin sınıflandırma",
  "settings.modelsHub.desc.question-answering": "Soru yanıtlama",
  "settings.modelsHub.desc.summarization": "Özetleme",
  "settings.modelsHub.desc.translation": "Çeviri",
  "settings.modelsHub.desc.fill-mask": "Maskeyi doldur",
  "settings.modelsHub.desc.feature-extraction": "Özellik çıkarımı",
  "settings.modelsHub.desc.automatic-speech-recognition": "Konuşma tanıma",
  "settings.modelsHub.desc.text-to-speech": "Metinden konuşmaya",
  "settings.modelsHub.desc.depth-estimation": "Derinlik tahmini",
  "settings.modelsHub.desc.image-segmentation": "Görüntü bölütleme",
  "settings.modelsHub.desc.object-detection": "Nesne algılama",
  ...
  "settings.modelsHub.desc.hint.code": "Kodlama",
  "settings.modelsHub.desc.hint.reasoning": "Akıl yürütme",
  "settings.modelsHub.desc.hint.quantized": "Quantized",
  "onboarding.title": "Tiancode'a hoş geldiniz",
  "onboarding.step": "Adım {{current}} / {{total}}",
  "onboarding.disclaimer.p1": "Tiancode sizinle birlikte çalışan bir AI ajanıdır: kontrol sizdeyken komutları çalıştırabilir, dosyaları düzenleyebilir ve bilgisayarınızdaki görevleri yönetebilir.",
  "onboarding.disclaimer.p2": "Yanıtlar üretmek için istemleriniz ve dosya içerikleriniz, yapılandırdığınız AI model sağlayıcılarına gönderilebilir.",
  "onboarding.disclaimer.p3": "Tiancode'u nasıl kullandığınızdan siz sorumlusunuz. Değişiklikleri kabul etmeden önce dikkatlice inceleyin ve anlamadığınız komutları asla çalıştırmayın.",
  "onboarding.accept": "Kabul Et ve Devam Et",
  "onboarding.preferences.title": "Kendinize göre ayarlayın",
  "onboarding.preferences.description": "Tiancode'un nasıl görüneceğini ve sizinle nasıl konuşacağını seçin. Bunları istediğiniz zaman Ayarlar'dan değiştirebilirsiniz.",
  "onboarding.theme.title": "Görünüm",
  ...
  "onboarding.start": "Tiancode'u kullanmaya başla",
