...
"settings.mcpServers.group.unknown": "不明",
  ...
  "welcome.step1.subtitle": "言語とテーマを選択",
  "welcome.step2.subtitle": "AI プロバイダーを接続",
  "welcome.step3.subtitle": "ワークスペースを選択",
  "welcome.language.label": "表示言語を選択",
  "welcome.theme.label": "カラーモード",
  "welcome.theme.dark": "ダーク",
  "welcome.theme.light": "ライト",
  "welcome.theme.system": "システム",
  "welcome.provider.title": "AI プロバイダー",
  "welcome.provider.description": "Tiancode が応答するには、少なくとも 1 つのモデルプロバイダーが必要です。クラウドのプロバイダーを接続するか、後で「ローカルモデル」からローカルモデルを実行できます。",
  "welcome.provider.connect": "今すぐ設定する",
  "welcome.provider.connect.desc": "セットアップ完了後にプロバイダー設定を開きます",
  "welcome.provider.later": "後で設定する",
  "welcome.provider.later.desc": "そのままアプリへ。設定からいつでも接続できます",
  "welcome.workspace.title": "ワークスペース",
  "welcome.workspace.description": "Tiancode はプロジェクトフォルダー内で動作します。開始方法を選んでください。",
