export const dict = {
  ...
  "settings.connections.description": "TiancodeをTelegram、WhatsApp、Discord、Slack、Webhooksと接続し、リモート通知とモバイル操作を有効にします。",
  "settings.connections.telegram.title": "Telegram Bot ゲートウェイ",
  "settings.connections.telegram.token": "Bot Token",
  "settings.connections.telegram.tokenMissing": "Telegram Bot Tokenを入力してください",
  "settings.connections.telegram.testSuccess": "Telegramに正常に接続しました！",
  "settings.connections.telegram.chatId": "Chat ID / ユーザー",
  "settings.connections.telegram.pairing": "双方向対話ペアリング",
  "settings.connections.telegram.pairingDescription": "Telegramから直接指示を受け取り、アクションを承認できるようにします。",
  "settings.connections.telegram.notifyBuilds": "ビルド通知",
  "settings.connections.whatsapp.title": "WhatsApp ゲートウェイ",
  "settings.connections.whatsapp.phone": "WhatsApp 電話番号 / ID",
  "settings.connections.whatsapp.phoneMissing": "WhatsAppの電話番号を入力してください",
  "settings.connections.whatsapp.pairedSuccess": "ペアリングコードが生成されました",
  "settings.connections.whatsapp.pairingMode": "ペアリング方法",
  "settings.connections.whatsapp.notifyBuilds": "ビルドおよびテスト通知",
  "settings.connections.whatsapp.notifyErrors": "致命的な例外アラート",
  "settings.connections.discord.title": "Discord",
  "settings.connections.discord.authMode": "接続方法",
  "settings.connections.discord.channel": "通知チャンネル",
  "settings.connections.discord.notifyBuilds": "ビルドおよびコミット通知",
  "settings.connections.discord.missingTarget": "Webhook URLまたはDiscordトークンを入力してください",
  "settings.connections.discord.testSuccess": "Discordにテストメッセージを送信しました",
  "settings.connections.slack.title": "Slack",
  "settings.connections.slack.webhook": "Incoming Webhook URL",
  "settings.connections.slack.channel": "デフォルトチャンネル",
  "settings.connections.slack.notifyBackground": "バックグラウンドタスク通知",
  "settings.connections.slack.missingUrl": "Slack Incoming Webhook URLを入力してください",
  "settings.connections.slack.testSuccess": "Slack Webhookが確認されました",
  ...
  "settings.connections.webhooks.missingUrl": "Endpoint URLを入力してください",
  "settings.connections.webhooks.testSuccess": "テストペイロードを送信しました",
