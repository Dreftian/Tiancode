export const dict = {
  ...
  "settings.plugins.catalog.npm.biome.description": "JavaScript と TypeScript 向けの高速なリンター兼フォーマッターです。",
  "settings.plugins.catalog.npm.playwrightMcp.description": "Web アプリケーション向けのブラウザ自動化と E2E テストです。",
  "settings.plugins.catalog.npm.octokitRest.description": "プルリクエスト、Issue、リポジトリ向けの GitHub API クライアントです。",
  "settings.plugins.catalog.npm.slackWebApi.description": "メッセージと会話向けの公式 Slack Web API クライアントです。",
  "settings.plugins.catalog.npm.notionClient.description": "ページ、データベース、ブロック向けの公式 Notion API クライアントです。",
  "settings.plugins.catalog.npm.sentryCli.description": "Sentry のエラーモニタリング、リリース、ソースマップのアップロードです。",
  "settings.plugins.catalog.npm.agentNotify.description": "エージェントのタスクが完了または失敗したときに通知を送信します。",
  "settings.plugins.catalog.npm.chimeClaude.description": "エージェントのライフサイクルイベントを Telegram で通知します。",
