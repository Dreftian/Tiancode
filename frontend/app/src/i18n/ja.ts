...
"settings.mcpServers.group.unknown": "不明",
  ...
  "settings.voices.dictation.hold.title": "押している間だけ音声入力するショートカット",
  "settings.voices.dictation.hold.description": "デスクトップ上のどこでも押し続けると、カーソル位置に音声入力できます",
  "settings.voices.dictation.recordings.title": "最近の録音",
  "settings.voices.dictation.recordings.description": "直近 20 件の録音がこの端末に保存されます",
  "settings.voices.dictation.toggle.title": "音声入力のホットキーを切り替え",
  "settings.voices.dictation.toggle.description": "デスクトップ上のどこでも一度押すと音声入力を開始し、もう一度押すと停止します",
