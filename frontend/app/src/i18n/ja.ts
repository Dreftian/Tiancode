...
export const dict = {
  ...
  "settings.modelsHub.load.description": "LM Studio がモデル読み込み時に提供するのと同じ設定です。次にネイティブエンジンがモデルを起動するときに適用されます。",
  "settings.modelsHub.load.reset": "リセット",
  "settings.modelsHub.load.hint": "0 または −1 は自動を意味します。Ollama と LM Studio は独自の設定を使います。",
  "settings.modelsHub.load.choice.auto": "自動",
  "settings.modelsHub.load.choice.on": "オン",
  "settings.modelsHub.load.choice.off": "オフ",
  "settings.modelsHub.load.contextSize.title": "コンテキスト長",
  "settings.modelsHub.load.contextSize.description": "モデルがメモリに保持するトークン数。大きいほど VRAM を消費します。",
  "settings.modelsHub.load.gpuLayers.title": "GPU オフロード",
  "settings.modelsHub.load.gpuLayers.description": "GPU に送る層の数。99 で全層、0 で CPU 実行。",
  "settings.modelsHub.load.threads.title": "CPU スレッド数",
  "settings.modelsHub.load.threads.description": "CPU 処理に使うスレッド。0 で全コア −1。",
  "settings.modelsHub.load.batchSize.title": "評価バッチサイズ",
  "settings.modelsHub.load.batchSize.description": "1 バッチでまとめて処理する入力トークン数。",
  "settings.modelsHub.load.flashAttention.title": "Flash Attention",
  "settings.modelsHub.load.flashAttention.description": "最適化されたアテンション。新しい GPU で高速ですが、対応しないモデルもあります。",
  "settings.modelsHub.load.kvCacheType.title": "K/V キャッシュの量子化",
  "settings.modelsHub.load.kvCacheType.description": "キー・バリューキャッシュを量子化して、少ないメモリで長いコンテキストを扱います。",
  "settings.modelsHub.load.keepInMemory.title": "モデルをメモリに固定",
  "settings.modelsHub.load.keepInMemory.description": "モデルを RAM に固定してスワップさせません（mlock）。",
  "settings.modelsHub.load.useMmap.title": "mmap() を試す",
  "settings.modelsHub.load.useMmap.description": "モデルファイルをコピーせずマップします。読み込みが速く、メモリを共有できます。",
  "settings.modelsHub.load.kvOffload.title": "KV キャッシュを GPU メモリへ",
  "settings.modelsHub.load.kvOffload.description": "キャッシュを層と一緒に VRAM に置きます。VRAM が足りなければオフに。",
  "settings.modelsHub.load.seed.title": "シード",
  "settings.modelsHub.load.seed.description": "再現可能な出力のための固定シード。−1 でランダム。",
  "settings.modelsHub.load.ropeFrequencyBase.title": "RoPE 周波数ベース",
  "settings.modelsHub.load.ropeFrequencyBase.description": "回転位置埋め込みのベース。0 でモデルの値を維持。",
  "settings.modelsHub.load.ropeFrequencyScale.title": "RoPE 周波数スケール",
  "settings.modelsHub.load.ropeFrequencyScale.description": "コンテキストを伸ばすときの回転埋め込みのスケール。0 でモデルの値を維持。",
  "settings.modelsHub.load.parallel.title": "並列リクエスト",
  "settings.modelsHub.load.parallel.description": "同時リクエストのスロット数。スロットごとにコンテキストを分割します。",
  ...
  "settings.modelsHub.dir.restart": "新しいダウンロードとエンジンはすぐにこのフォルダーを使い、「ディスク上」に既存のモデルが表示されます。次回起動時も記憶されます。",
  ...
  "chat.mic.listening": "聞き取り中… 終了するにはマイクをクリック",
  "prompt.folder.title": "会話にフォルダーを追加",
  "settings.pets.kind.otter": "カワウソ",
  "settings.pets.kind.otter.species": "遊び好きなカワウソ",
  "settings.pets.kind.otter.description": "好奇心旺盛で遊び好き。長いリファクタリングでも筋道を見失いません。",
  "settings.pets.kind.otter.trait": "多くのファイルにまたがる文脈を保つ",
  "settings.pets.kind.owl": "フクロウ",
  "settings.pets.kind.owl.species": "賢いフクロウ",
  "settings.pets.kind.owl.description": "暗闇でも見える。ログとスタックトレースを辛抱強く確認します。",
  "settings.pets.kind.owl.trait": "デバッグとコードレビューが得意",
  "settings.pets.kind.dino": "ディノ",
  "settings.pets.kind.dino.species": "やさしい恐竜",
  "settings.pets.kind.dino.description": "昔ながらで頑丈。レガシーコードと大きな移行が大好きです。",
  "settings.pets.kind.dino.trait": "レガシーシステムと移行を担当",
  "settings.pets.kind.penguin": "ペンギン",
  "settings.pets.kind.penguin.species": "冷静なペンギン",
  "settings.pets.kind.penguin.description": "プレッシャーに強く、デプロイと CI パイプラインを整えます。",
  "settings.pets.kind.penguin.trait": "DevOps とリリースの規律",
  "settings.pets.kind.redpanda": "レッサーパンダ",
  "settings.pets.kind.redpanda.species": "やさしいレッサーパンダ",
  "settings.pets.kind.redpanda.description": "温かく丁寧。インターフェースと文言をしっくりくるまで磨きます。",
  "settings.pets.kind.redpanda.trait": "UI の仕上げとデザインの細部",
  "settings.pets.kind.robot": "ロボット",
  "settings.pets.kind.robot.species": "正確なロボット",
  "settings.pets.kind.robot.description": "疲れ知らずで正確。テストと自動化を黙々とこなします。",
  "settings.pets.kind.robot.trait": "テストと自動化",
  "settings.pets.kind.koala": "コアラ",
  "settings.pets.kind.koala.species": "のんびりコアラ",
  "settings.pets.kind.koala.description": "急がず徹底的に。何かに触れる前にドキュメントを読みます。",
  "settings.pets.kind.koala.trait": "ドキュメントと慎重な計画",
  "settings.pets.kind.hamster": "ハムスター",
  "settings.pets.kind.hamster.species": "せっせと働くハムスター",
  "settings.pets.kind.hamster.description": "素早く元気。小さなタスクや修正をあっという間に片づけます。",
  "settings.pets.kind.hamster.trait": "素早い修正と小さなタスク",
  "settings.sections.label": "設定セクション",
  "titlebar.debugTools": "デバッグツールを切り替え",
  "chat.mic.transcribing": "文字起こし中…",
  "settings.general.row.showVoice.title": "タイトルバーの音声コントロール",
  ...
  "splash.subtitle": "ローカルでプライベートに動くコーディングエージェント",
  "splash.progress": "環境を起動中",
  "splash.step.server": "ローカルサーバーに接続中",
  "splash.step.config": "設定と認証情報を読み込み中",
  "splash.step.models": "モデルとプロバイダーを同期中",
  "splash.step.tools": "MCP サーバーとツールを確認中",
  "splash.step.ready": "コードを書く準備完了",
  "agent.webapp.label": "Web とアプリ",
  "webapp.modeBadge": "Full JSX · ライブプレビュー",
  ...
  "home.webapp.title": "Web＆アプリ開発",
  "home.webapp.description": "full JSX でアプリやウェブサイトをリアルタイムプレビュー付きで作成します。",
  ...
  "home.chat.heading": "今日はどのようなお手伝いをしましょうか？",
  "home.chat.subtitle": "質問や会話、コード作成を自由に始めましょう。",
  "home.chat.placeholder": "メッセージを入力するか、質問してください...",
  "home.chat.send": "送信",
  "home.chat.suggestion.webapp": "⚡ Web アプリを作成",
  "home.chat.suggestion.explain": "💡 コードやアーキテクチャの解説",
  "home.chat.suggestion.refactor": "🛠️ 関数のリファクタリングと最適化",
  "home.chat.suggestion.tests": "🧪 単体テストを作成",
  ...
  "liveView.appEmpty": "エージェントが開発サーバーを起動すると、ここにページが表示されます。",
  "liveView.code.empty": "エージェントが編集中のファイルがここに表示されます。",
  "liveView.code.unavailable": "コードパネルを利用できません",
  "liveView.code.filter.all": "すべて",
  "liveView.code.filter.frontend": "フロントエンド",
  ...
  "livePreview.device.laptop": "ノートパソコン",
  "livePreview.device.tablet": "タブレット",
  "livePreview.device.mobile": "モバイル",
  "livePreview.device.android": "Android スマホ",
  "livePreview.device.androidTablet": "Android タブレット",
  "livePreview.device.tv": "スマートテレビ",
  "livePreview.device.custom": "カスタム",
  "livePreview.rotate": "デバイスを回転",
  "livePreview.custom.width": "幅",
  "livePreview.custom.height": "高さ",
  ...
  "livePreview.stop": "開発サーバーを停止",
  "livePreview.restart": "開発サーバーを再起動",
  "livePreview.starting": "起動中…",
  "livePreview.ready": "準備完了",
  "livePreview.stopped": "停止中",
  "livePreview.idle": "待機中",
  "livePreview.serverError": "開発サーバーエラー",
  "livePreview.console": "コンソール",
  "livePreview.diagnostics": "診断",
  "livePreview.console.empty": "コンソールメッセージはありません",
  "livePreview.console.clear": "コンソールをクリア",
  "livePreview.loadFailed": "{{url}} を読み込めませんでした — 開発サーバーは起動していますか？（{{description}}）",
  "livePreview.selection.title": "選択した要素",
  "livePreview.selection.selector": "セレクター",
  "livePreview.selection.size": "サイズ",
  "livePreview.selection.route": "ルート",
  "livePreview.selection.copySelector": "セレクターをコピー",
  ...
  "livePreview.change.noPixelDiff": "これは確認済みの読み込みシグナルであり、ピクセル比較ではありません。",
  ...
  "settings.mcpServers.health.connected": "{{count}} 件接続済み",
  "settings.mcpServers.health.failed": "{{count}} 件失敗",
  "settings.mcpServers.health.needsAuth": "{{count}} 件で認証が必要",
  "settings.mcpServers.health.local": "{{count}} 件のローカル実行中",
  "settings.mcpServers.health.recover": "失敗を回復",
  ...
  "settings.connections.discord.authMode": "接続方法",
  "settings.connections.slack.title": "Slack",
  "settings.connections.slack.webhook": "Incoming Webhook URL",
  "settings.connections.webhooks.title": "WebhookとAPIゲートウェイ",
  "settings.connections.webhooks.url": "Endpoint URL",
  "settings.connections.webhooks.secret": "HMACシークレットキー",
  "settings.connections.filter.all": "すべて",
  "settings.connections.state.active": "有効",
  "settings.connections.state.error": "エラー",
  "settings.connections.state.missing": "認証情報がありません",
  "settings.connections.state.paused": "一時停止",
  "settings.connections.state.off": "未設定",
  "settings.connections.lastDelivery": "最終送信 {{when}}",
  "settings.connections.time.justNow": "たった今",
  "settings.connections.time.minutes": "{{n}} 分前",
  "settings.connections.time.hours": "{{n}} 時間前",
  "settings.connections.time.days": "{{n}} 日前",
  "settings.connections.loadFailed": "サーバーからゲートウェイを読み込めませんでした。",
  "settings.connections.retry": "再試行",
  "settings.connections.enable": "有効化",
  "settings.connections.enable.desc": "このゲートウェイでセッションの結果を送信します。",
  "settings.connections.notifyIdle": "セッション終了時に通知",
  "settings.connections.notifyIdle.desc": "アシスタントの最終回答を送信します。",
  "settings.connections.notifyError": "エラー時に通知",
  "settings.connections.notifyError.desc": "セッションが停止した原因のエラーを送信します。",
  "settings.connections.secret.saved": "保存済み",
  "settings.connections.secret.save": "保存",
  "settings.connections.secret.replace": "置き換え",
  "settings.connections.secret.clear": "削除",
  "settings.connections.secret.show": "表示",
  "settings.connections.secret.hide": "非表示",
  "settings.connections.secret.savedToast": "認証情報を保存しました",
  "settings.connections.secret.clearedToast": "認証情報を削除しました",
  "settings.connections.test": "テスト送信",
  "settings.connections.testing": "送信中…",
  "settings.connections.test.ok": "{{provider}} の応答: {{message}}（{{ms}} ms）",
  "settings.connections.test.failed": "{{provider}} のテストに失敗: {{message}}",
  "settings.connections.disconnect": "切断",
  ...
  "settings.connections.telegram.directory.desc": "プロンプトを実行するプロジェクトの絶対パス。",
  "settings.connections.discord.desc": "Incoming Webhook またはボットトークンでチャンネルに投稿します。",
  "settings.connections.discord.mode.webhook": "Webhook",
  "settings.connections.discord.mode.bot": "ボット",
  ...
  "settings.skills.github.success.many": "{{count}}個のスキルをGitHubからクローンしました",
  "settings.skills.github.failed": "GitHubからスキルをクローンできませんでした",
  "settings.skills.github.none": "そのURLにSKILL.mdが見つかりません",
  "settings.skills.import.success": "スキルをインポートしました",
  "settings.skills.import.failed": "スキルのインポートに失敗しました",
  "settings.skills.actions.enableAll": "すべて有効化",
  "settings.skills.actions.safeOnly": "安全なもののみ",
  "settings.skills.actions.specialized.enable": "専門スキルを有効化",
  "settings.skills.actions.specialized.disable": "専門スキルを無効化",
  "settings.skills.actions.disableAll": "すべて無効化",
  "settings.skills.stats.active": "{{enabled}}/{{total}} 有効",
  "settings.skills.filter.all": "すべて",
  "settings.skills.filter.safe": "安全",
  "settings.skills.filter.specialized": "専門",
  "settings.skills.filter.frontend": "フロントエンド",
  "settings.skills.filter.backend": "バックエンド",
  "settings.skills.filter.testing": "テスト",
  ...
  "settings.mcpPlugins.description": "外部 MCP ツールとライフサイクルプラグインでエージェントを拡張します。",
  "settings.mcpPlugins.add.plugin": "プラグインを追加",
  "settings.mcpPlugins.add.server": "MCP サーバーを追加",
  "settings.mcpPlugins.tab.plugins": "プラグイン",
  "settings.mcpPlugins.tab.servers": "MCP サーバー",
  ...
  "settings.mcpPlugins.column.type": "種類",
  "settings.mcpPlugins.column.command": "コマンド / エンドポイント",
  "settings.mcpPlugins.column.status": "状態",
  "settings.mcpPlugins.column.action": "操作",
  "settings.mcpPlugins.column.plugin": "プラグイン",
  "settings.mcpPlugins.column.category": "カテゴリ",
  "settings.mcpPlugins.column.description": "説明",
  "settings.mcpPlugins.column.extension": "拡張機能",
  "settings.mcpPlugins.column.spec": "コマンド / 説明",
  "settings.mcpPlugins.status.active": "有効",
  "settings.mcpPlugins.status.inactive": "無効",
  ...
  "settings.mcpPlugins.discover.title": "拡張機能カタログ",
  "settings.mcpPlugins.discover.description": "ワンクリックで接続できる公式 MCP サーバーとプラグイン。",
  "settings.mcpPlugins.discover.available": "{{count}} 件利用可能",
  "settings.mcpPlugins.discover.installed": "{{count}} 件インストール済み",
  "settings.mcpPlugins.discover.popular": "人気",
  "settings.mcpPlugins.discover.get": "入手",
  "settings.mcpPlugins.discover.installedBadge": "インストール済み",
  "settings.mcpPlugins.discover.category.all": "すべて",
  "settings.mcpPlugins.discover.category.desarrollo": "開発",
  "settings.mcpPlugins.discover.category.ia": "AI とエージェント",
  "settings.mcpPlugins.discover.category.seguridad": "セキュリティ",
  "settings.mcpPlugins.discover.category.web": "Web とブラウザ",
  "settings.mcpPlugins.discover.category.database": "データベース",
  "settings.mcpPlugins.discover.category.cloud": "クラウドと DevOps",
  "settings.mcpPlugins.discover.category.finanzas": "金融",
  "settings.mcpPlugins.discover.category.diseno": "デザイン",
  "settings.mcpPlugins.discover.category.ventas": "営業",
  "settings.mcpPlugins.discover.category.datos": "データ",
  "settings.mcpPlugins.form.name": "識別子",
  ...
  "settings.mcpPlugins.toast.serverDisabled": "サーバー「{{name}}」を無効にしました",
  "settings.mcpPlugins.toast.serverUpdateFailed": "MCP サーバーを更新できませんでした",
  "settings.mcpPlugins.toast.serverRemoved": "サーバー「{{name}}」を削除しました",
  "settings.mcpPlugins.toast.serverRemoveFailed": "MCP サーバーを削除できませんでした",
  "settings.mcpPlugins.toast.pluginEnabled": "プラグインを有効にしました",
  "settings.mcpPlugins.toast.pluginDisabled": "プラグインを無効にしました",
  "settings.mcpPlugins.toast.pluginUpdateFailed": "プラグインを更新できませんでした",
  "settings.mcpPlugins.toast.serverConnected": "MCP サーバー「{{name}}」に接続しました",
  "settings.mcpPlugins.toast.pluginInstalled": "プラグイン「{{name}}」をインストールしました",
  "settings.mcpPlugins.toast.installFailed": "{{name}} をインストールできませんでした",
  "settings.mcpPlugins.toast.formIncomplete": "名前とコマンド / URL を入力してください",
  "settings.mcpPlugins.toast.added": "追加しました",
  "settings.mcpPlugins.toast.saveFailed": "設定を保存できませんでした",
  ...
  "settings.pets.kind.panda": "パンダ",
  "settings.pets.kind.fox": "キツネ",
  "settings.pets.kind.dewey.description": "集中作業のための穏やかな相棒。",
  "settings.pets.kind.fireball.description": "高速な反復とデバッグのための情熱的なエネルギー。",
  "settings.pets.kind.hoots.description": "一瞬で洗練されたコードに仕上げる鋭いフクロウ。",
  "settings.pets.kind.rocky.description": "差分が大きくなっても安定した岩のような存在。",
  "settings.pets.kind.seedy.description": "新しいアイデアと成長のための小さな緑の芽。",
  "settings.pets.kind.stacky.description": "深いシステム作業のためのバランスの取れたスタック。",
  "settings.pets.kind.bsod.description": "システムの耐久性をテストする小さな青画面のグレムリン。",
  "settings.pets.kind.nullsignal.description": "夜のハッキングのための虚空からの静かな信号。",
  ...
  "settings.pets.kind.panda.description": "穏やかで几帳面、長時間のコーディングに最適です。",
  "settings.pets.kind.fox.description": "賢く機敏、複雑なリファクタリングに優雅な解決策を見出します。",
  "settings.pets.desktop.float.title": "デスクトップ フローティング コンパニオン",
  "settings.pets.desktop.float.desc": "Windowsデスクトップ上にフローティングするコンパニオンを表示します。",
  ...
  "settings.mcpServers.presets.braveSearch": "Brave検索",
  ...
  "settings.voices.speakReasoning.description": "AI が実行する前に、その推論と計画中の手順を読み上げます。",
  "livePreview.startServer": "プレビューを開始",
  "chat.mic.defaultDevice": "システムの既定",
  "chat.mic.devices": "PC のマイク",
  "chat.mic.noDevices": "この PC でマイクが検出されませんでした",
  "chat.mic.selectDevice": "PC のマイクを選択",
  "command.prompt.speed.toggle": "⚡ 2x スピードモードを切り替え (超高速)",
  "livePreview.fixWithAi": "AI で修正",
  "settings.voices.mic.title": "マイク",
  "settings.voices.mic.description": "音声チャットと音声入力に使用します",
  "settings.voices.section.dictation": "音声入力",
  "settings.voices.section.general": "一般",
  "settings.voices.section.speech": "音声合成と再生",
  ...
  "welcome.theme.dark": "ダーク",
  "welcome.theme.light": "ライト",
  "welcome.theme.system": "システム",
  "welcome.workspace.title": "ワークスペース",
  "welcome.workspace.createDefault": "スターターフォルダーを作成",
  "welcome.workspace.createDefault.desc": "ドキュメント内に Tiancode フォルダーを作成し、すぐに使えます",
  "welcome.workspace.chooseLater": "自分のフォルダーを開く",
  "welcome.workspace.chooseLater.desc": "何も作成しません。ホーム画面からプロジェクトを選びます",
  "welcome.back": "戻る",
  "welcome.next": "次へ",
  "welcome.finish": "完了",
  ...
  "settings.subAgents.list.column.agent": "サブエージェント",
  "settings.subAgents.list.column.role": "役割と専門分野",
  ...
  "settings.subAgents.native.count": "内蔵サブエージェント {{count}} 件",
  "settings.subAgents.scope.label": "適用範囲",
  "settings.subAgents.scope.project": "このプロジェクト",
  "settings.subAgents.scope.global": "グローバル",
  "settings.subAgents.scope.project.hint": "このリポジトリにのみ適用されます。",
  "settings.subAgents.scope.global.hint": "すべてのリポジトリの既定値です。",
  "settings.subAgents.status.active": "有効",
  "settings.subAgents.status.inactive": "無効",
  "settings.subAgents.toggle.enabled": "@{{name}} を有効にしました",
  "settings.subAgents.toggle.disabled": "@{{name}} を無効にしました",
  "settings.subAgents.toggle.failed": "サブエージェントを更新できませんでした",
  ...
  "settings.pets.total": "{{count}} 体のインタラクティブなコンパニオン",
  "settings.pets.desktop.unavailable": "デスクトップアプリでのみ利用できます。",
  "settings.pets.pet.title": "リアクションを試す",
  "settings.pets.pet.description": "アクティブなマスコットに愛情のパルスを送り、リアルタイムで反応を確かめます。",
  "settings.pets.pet.action": "なでる",
  "settings.pets.pet.greeting": "こんにちは！コーディングのお手伝いをする準備はできています。",
  "settings.pets.state.ready": "待機中",
  "settings.pets.state.running": "実行中",
  "settings.pets.state.needsInput": "入力待ち",
  "settings.pets.state.blocked": "停止中",
  "settings.pets.state.visible": "画面に表示中",
  "settings.pets.state.hidden": "非表示",
  "settings.pets.kind.dewey.species": "しずくの精",
  "settings.pets.kind.dewey.trait": "コードの流れを瑞々しく、詰まりなく保つ",
  "settings.pets.kind.fireball.species": "躍動する炎",
  "settings.pets.kind.fireball.trait": "ビルドや高負荷タスクを加速させる",
  "settings.pets.kind.hoots.species": "夜のフクロウ",
  "settings.pets.kind.hoots.trait": "アーキテクチャとリファクタリングを見抜く分析眼",
  "settings.pets.kind.rocky.species": "不動の岩",
  "settings.pets.kind.rocky.trait": "エラーやクラッシュにも揺るがない安定感",
  "settings.pets.kind.seedy.species": "芽吹く種",
  "settings.pets.kind.seedy.trait": "新しいプロジェクトやプロトタイプを育て続ける",
  "settings.pets.kind.stacky.species": "再帰スタック",
  "settings.pets.kind.stacky.trait": "コール追跡とスタックオーバーフローの専門家",
  "settings.pets.kind.bsod.species": "レトロなブルースクリーン",
  "settings.pets.kind.bsod.trait": "重大な例外と低レベルデバッグの守護者",
  "settings.pets.kind.nullsignal.species": "量子の幻影",
  "settings.pets.kind.nullsignal.trait": "ヌルポインタと競合状態をいち早く検知",
  "settings.pets.kind.cat.species": "好奇心旺盛な猫",
  "settings.pets.kind.cat.trait": "ビルド成功で喉を鳴らし、静かに寄り添う",
  "settings.pets.kind.dog.species": "忠実な犬",
  "settings.pets.kind.dog.trait": "コミットを喜び、長いセッションでも励ましてくれる",
  "settings.pets.kind.rabbit.species": "俊敏なウサギ",
  "settings.pets.kind.rabbit.trait": "アジャイルなスプリントで最高の機動力",
  "settings.pets.kind.panda.species": "禅のパンダ",
  "settings.pets.kind.panda.trait": "複雑なリファクタリングでも揺るがない落ち着き",
  "settings.pets.kind.fox.species": "ずる賢いキツネ",
  "settings.pets.kind.fox.trait": "デバッグと構文エラーの発見に鋭い",
  "prompt.optimize.done": "プロンプトを最適化しました",
  "prompt.optimize.undo": "最適化を元に戻す",
  "prompt.optimize.reverted": "元のプロンプトに戻しました",
  "prompt.optimize.streaming": "プロンプトを書き換えています...",
  "prompt.optimize.stop": "最適化を停止",
  "prompt.optimize.needsText": "最適化するテキストを入力してください",
  "prompt.optimize.failed": "プロンプトを最適化できませんでした",
  "prompt.optimize.noModel": "プロンプト最適化用のモデルが設定されていません。",
  "prompt.optimize.noOutput": "モデルから応答がありませんでした。",
  "prompt.optimize.style.standard": "標準",
  "prompt.optimize.style.rigorous": "厳密 (TDD)",
  "prompt.optimize.style.minimal": "最小限",
  "prompt.optimize.style.hint": "右クリックでスタイルを切り替え",
  "error.client.transport": "サーバーに接続できませんでした",
  "error.client.badResponse": "サーバーから予期しない応答が返されました",
  "error.client.unexpectedStatus": "サーバーから予期しない応答が返されました（{{status}}）",
  "settings.mcpPlugins.form.oauth": "OAuth サインインが必要",
  ...
  "settings.github.stats.capped": "読み込んだのは最初の {{count}} 件のリポジトリだけなので、これらの数値は最小値です。",
  "settings.github.repos.filter.all": "すべて",
  "settings.github.repos.range": "{{total}} 件中 {{from}}–{{to}} 件を表示",
  "settings.github.repo.description.empty": "説明はありません。",
  "settings.github.repo.fork": "フォーク",
  "settings.github.repo.stars.title": "スター: {{count}}",
  "settings.github.repo.forks.title": "フォーク: {{count}}",
  "settings.github.repo.copy": "リポジトリの URL をコピー",
  "settings.github.repo.copied": "リポジトリの URL をコピーしました",
  "settings.github.repo.view": "表示",
  "settings.github.repo.view.title": "GitHub.com で開く",
  "settings.github.repo.open": "プロジェクトを開く",
  "settings.github.repo.open.title": "すでにローカルにクローン済みです。再クローンせずに開きます。",
  ...
  "settings.github.pushing": "プッシュしています...",
  "settings.github.pulling": "プルしています...",
  "settings.github.sort.label": "並べ替え",
  "settings.github.sort.updated": "最近更新した順",
  "settings.github.sort.stars": "スターが多い順",
  ...
  "chat.mic.error.engine": "音声認識エンジンでエラーが発生しました。もう一度お試しください。",
  "chat.mic.error.unavailable": "音声サービスを利用できないか、オフラインです。",
  "chat.mic.hint.rightClick": "（右クリック：PC のマイクを選択）",
  "chat.mic.device.fallback": "マイク {{index}}",
  "chat.mic.limitReached": "{{seconds}} 秒の上限に達したためディクテーションを停止しました。",
  "command.voice.dictation": "音声ディクテーションの切り替え",
  "command.category.voice": "音声",
  "settings.voices.dictation.dictionary.add": "項目を追加",
  "settings.voices.dictation.dictionary.placeholder": "単語またはフレーズ（例：TypeScript）…",
  "settings.voices.dictation.dictionary.save": "保存",
  "settings.voices.dictation.dictionary.cancel": "キャンセル",
  "settings.voices.dictation.dictionary.remove": "項目を削除",
  "settings.voices.dictation.dictionary.added.title": "項目を追加しました",
  "settings.voices.dictation.dictionary.added.description": "ディクテーションで「{{word}}」が優先されます。",
  "settings.voices.dictation.recordings.count.one": "{{count}} 件保存済み",
  "settings.voices.dictation.recordings.count.other": "{{count}} 件保存済み",
  "settings.voices.dictation.recordings.show": "文字起こしを表示",
  "settings.voices.dictation.recordings.hide": "隠す",
  ...
  "prompt.optimize.failed.unknown": "モデルが完了前に停止しました。変更は行われていません。",
  "liveView.project.active": "現在のフォルダー: {{dir}}",
  "liveView.project.changeHint": "クリックしてプロジェクトを切り替えます",
  "liveView.project.change": "プロジェクト {{name}}、クリックして切り替え",
  "liveView.project.default": "既定",
  "liveView.project.fallbackName": "プロジェクト",
  "liveView.project.title": "Sandbox のフォルダー",
  "liveView.project.detected": "検出されたプロジェクト:",
  "liveView.project.activeBadge": "使用中",
  "liveView.project.pathLabel": "パスを直接入力:",
  "liveView.project.pathPlaceholder": "C:/path/to/my-project",
  "liveView.project.auto": "自動検出",
  "liveView.project.reset": "リセット",
  "liveView.project.apply": "変更",
  "liveView.device.label": "ビューポートのサイズ",
  ...
  "desktop.computerUse.indicator.app": "{{app}} を操作中",
  ...
  "settings.general.row.transcriptWidth.title": "トランスクリプトの幅",
  "settings.general.row.transcriptWidth.description": "会話とメッセージ入力欄の最大幅（幅768px以上のウィンドウのみ）",
  "settings.general.row.transcriptWidth.option.narrow": "狭い",
  "settings.general.row.transcriptWidth.option.medium": "標準",
  "settings.general.row.transcriptWidth.option.wide": "広い",
  "liveView.code.filter.label": "ファイルを絞り込む",
  "liveView.code.resizeSidebar": "ドラッグしてファイル一覧の幅を変更",
  "liveView.code.unsaved": "未保存の変更",
  "liveView.code.saveFailed": "このファイルを保存できませんでした",
  "liveView.code.editStart": "このファイルを編集",
  "liveView.code.saveAs": "別のパスに保存",
  "liveView.code.editStop": "編集を終了",
  "livePreview.status.failed": "読み込みに失敗",
  "livePreview.buildFailed": "ビルドに失敗しました",
  "livePreview.inspector.active": "インスペクター ON",
  "livePreview.issue.whiteScreen": "空白画面を検出しました（4 秒経っても何も描画されていません）",
  "livePreview.issue.runtime": "プレビューのエラー: {{message}}",
  "livePreview.issue.runtimeDefault": "プレビューの実行時エラー",
  "livePreview.issue.unhandledRejection": "未処理の Promise 拒否",
  "livePreview.issue.whiteScreen.noBody": "空白画面: ドキュメントに <body> が描画されていません。",
  "livePreview.issue.whiteScreen.empty": "空白画面: 読み込みから 4 秒後もプレビューに描画された要素が 0 個です。",
  "livePreview.console.refresh": "出力を更新",
  ...
  "livePreview.desktop.run": "アプリを実行",
  "livePreview.desktop.stopApp": "アプリを停止",
  "livePreview.desktop.restart": "アプリを再起動",
  "livePreview.mirror.window": "アプリケーションのウィンドウ",
  ...
  "livePreview.mirror.pickTitle": "アプリケーションのウィンドウを選んでください",
  "livePreview.mirror.empty": "表示できるウィンドウがありません。",
  ...
  "session.transcriptView.menu": "トランスクリプトの表示",
  "welcome.step.preferences": "言語と使い心地",
  "welcome.pet.label": "デスクトップペット",
  "welcome.pet.desc": "エージェントの動きを伝える小さな相棒です。ダウンロードはありません。",
  "welcome.speak.label": "返答を読み上げる",
  "welcome.speak.desc": "パソコンに入っている音声を使います。ダウンロードはありません。",
  "welcome.confirm.title": "設定の確認",
  ...
  "settings.subAgents.hierarchy.delegates": "{{count}} 件に委譲",
  "settings.subAgents.hierarchy.noDelegation": "委譲できません",
  "settings.subAgents.list.tools.summary.one": "{{count}} 個のツール",
  "settings.subAgents.list.tools.summary.other": "{{count}} 個のツール",
  "settings.subAgents.hierarchy.noDelegates": "委譲できる有効なサブエージェントがありません",
  "settings.subAgents.hierarchy.rootDisabled": "無効化中: 非アクティブの間は委譲しません",
  "settings.subAgents.hierarchy.showAll": "さらに {{count}} 件を表示",
  "settings.subAgents.hierarchy.showLess": "表示を減らす",
  "dialog.model.manageProvider": "プロバイダーを管理",
  ...
  "settings.modelsHub.auto.title": "自動設定",
  "settings.modelsHub.auto.description": "各モデルの GGUF ヘッダー（学習コンテキスト、層、ヘッド）と VRAM/RAM を読み取り、読み込み時にコンテキスト、GPU 層、スレッド、バッチ、KV キャッシュを決めます。オフにすると下の手動値を使います。",
  "settings.modelsHub.auto.applied": "読み込み済みモデルに適用",
  "settings.modelsHub.auto.idle": "各モデルの読み込み時に計算されます。「ディスク上」で各ファイルの提案を確認できます。",
  "settings.modelsHub.auto.manualDisabled": "自動設定が有効な間、手動値は無視されます。",
  "settings.modelsHub.disk.title": "ディスク上のモデル",
  "settings.modelsHub.disk.description": "モデルフォルダー（と以前の Tiancode フォルダー）内のすべての GGUF ファイル。ヘッダーの内容とこのマシン向けの読み込み設定案を表示します。",
  "settings.modelsHub.disk.empty": "モデルフォルダーに GGUF ファイルがありません。",
  "settings.modelsHub.disk.activate": "有効化して使う",
  "settings.modelsHub.disk.active": "読み込み済み",
  "settings.modelsHub.disk.rescan": "再スキャン",
  "settings.modelsHub.disk.folder": "フォルダー",
  "settings.modelsHub.disk.trainContext": "学習コンテキスト",
  "settings.modelsHub.disk.layers": "層",
  "settings.modelsHub.disk.recommended": "提案する読み込み設定",
  "settings.modelsHub.disk.delete": "ディスクから削除",
  "settings.modelsHub.disk.smallModelNote": "7B 未満のモデルはツールや長いプロンプトで応答が弱くなりがちです。コーディングには 7B 以上を試してください。",
  "settings.modelsHub.placement.gpu": "すべて GPU",
  "settings.modelsHub.placement.hybrid": "GPU + RAM",
  "settings.modelsHub.placement.cpu": "CPU のみ",
  "settings.modelsHub.reason.fits_gpu": "モデルとキャッシュが VRAM に収まります。",
  "settings.modelsHub.reason.hybrid": "VRAM に収まりきらないため、一部の層を RAM に置きます。",
  "settings.modelsHub.reason.cpu_only": "使用できる GPU がないため CPU で実行します。",
  "settings.modelsHub.reason.kv_q8_for_context": "コンテキストを増やすため KV キャッシュを q8_0 に。",
  "settings.modelsHub.reason.kv_q8_for_memory": "メモリ節約のため KV キャッシュを q8_0 に。",
  "settings.modelsHub.reason.ctx_train_limit": "コンテキストはモデルの学習上限まで。",
  "settings.modelsHub.reason.ctx_vram_limit": "コンテキストは空き VRAM で制限されます。",
  ...
  "settings.modelsHub.auto.vram.title": "VRAM の最大使用率",
  "settings.modelsHub.auto.vram.description": "モデルとキャッシュが占有できる GPU メモリの割合。",
  "settings.modelsHub.auto.ram.title": "RAM の最大使用率",
  "settings.modelsHub.auto.ram.description": "GPU に載らない層のためのシステムメモリの割合。",
  "settings.modelsHub.auto.cpu.title": "CPU 使用率",
  "settings.modelsHub.auto.cpu.description": "モデルに割り当てるコアの割合。",
  "settings.modelsHub.auto.placement.title": "GPU / RAM の配置",
  "settings.modelsHub.auto.placement.description": "自動はモデルサイズで判断、GPU + RAM は常に分割、CPU のみはグラフィックカードを使いません。",
  "settings.modelsHub.placement.auto": "自動",
  "settings.modelsHub.auto.idle.title": "アイドル時にアンロード",
  "settings.modelsHub.auto.idle.description": "この時間チャットがモデルを使わないと VRAM を解放し、次のリクエストで自動再読み込みします（LM Studio の JIT や Ollama の keep_alive と同様）。",
  "settings.modelsHub.auto.idle.never": "しない（常に読み込み）",
  "settings.modelsHub.auto.idle.minutes": "{{n}} 分",
  "settings.modelsHub.auto.lightweight": "ローカルモデルではチャットが軽量モードになります。コンパクトなプロンプトと基本ツールだけで、コンテキストに収まり実際に応答します。",
}
