...
"settings.mcpServers.group.unknown": "不明",
  ...
  "prompt.optimize.empty": "最初にテキストを入力してください",
  "prompt.optimize.optimizing": "入力を最適化中...",
  ...
  "settings.intelligence.autoSkill": "スキル自動抽出 (/learn)",
  "settings.intelligence.autoSkill.desc": "成功した複雑なワークフローを再利用可能な SKILL.md へ自動的にまとめることを提案します。",
  "settings.intelligence.section.codegraph": "コードグラフと AST",
  ...
  "settings.intelligence.monaco": "Monaco 差分ビューア",
  "settings.intelligence.monaco.desc": "パッチ適用前に、構文ハイライト付きの並列比較を表示します。",
  "settings.intelligence.section.safety": "Web と実行の安全性",
  "settings.intelligence.cleanWeb": "クリーンな Web 抽出 (Firecrawl エンジン)",
  "settings.intelligence.cleanWeb.desc": "スクリプト・Cookie・メニューを取り除き、LLM 向けに最適化された純粋な Markdown に変換します。",
  "settings.intelligence.guardrails": "ガードレールと機密情報のマスキング",
  "settings.intelligence.guardrails.desc": "外部プロバイダーへ送信する前に、パスワード・トークン・秘密鍵をマスクします。",
  "settings.intelligence.sandbox": "サンドボックス実行モード",
