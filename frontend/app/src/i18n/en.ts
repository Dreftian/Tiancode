...
"settings.mcpServers.group.unknown": "Unknown",
  ...
  "welcome.step1.subtitle": "Choose language & theme",
  "welcome.step2.subtitle": "Connect an AI provider",
  "welcome.step3.subtitle": "Choose your workspace",
  "welcome.language.label": "Choose display language",
  "welcome.theme.label": "Color mode",
  "welcome.theme.dark": "Dark",
  "welcome.theme.light": "Light",
  "welcome.theme.system": "System",
  "welcome.provider.title": "AI provider",
  "welcome.provider.description": "Tiancode needs at least one model provider to answer you. You can connect a cloud provider, or run a local model later from the Local Models tab.",
  "welcome.provider.connect": "Set one up now",
  "welcome.provider.connect.desc": "Opens provider settings as soon as setup finishes",
  "welcome.provider.later": "I'll do it later",
  "welcome.provider.later.desc": "Go straight to the app; you can connect one any time from Settings",
  "welcome.workspace.title": "Workspace",
  "welcome.workspace.description": "Tiancode works inside a project folder. Pick how you want to start.",
