...
"settings.mcpServers.group.unknown": "Unknown",
  ...
  "settings.mcpServers.discover.presets.unreal.description": "Controls an Unreal Engine project (Web Remote Control): open the editor, run Python and console commands, read logs and level actors. Requires the unreal-opencode-mcp folder installed.",
