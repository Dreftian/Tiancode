...
export const dict = {
  ...
  "settings.subAgents.section.agents": "Agents",
  "settings.subAgents.section.create": "Create agent",
  "settings.subAgents.empty": "No sub-agents created yet",
  "settings.subAgents.create.name": "Name",
  "settings.subAgents.create.name.placeholder": "my-subagent",
  "settings.subAgents.create.description": "Description",
  "settings.subAgents.create.description.placeholder": "What this agent is good at",
  "settings.subAgents.create.mode": "Mode",
  "settings.subAgents.create.mode.subagent": "Sub-agent",
  "settings.subAgents.create.mode.primary": "Primary",
  "settings.subAgents.create.model": "Model",
  "settings.subAgents.create.model.placeholder": "provider/model (optional)",
  "settings.subAgents.create.color": "Color",
  "settings.subAgents.create.color.placeholder": "#RRGGBB (optional)",
  "settings.subAgents.create.button": "Create agent",
