...
"prompt.action.stop": "Stop",
  ...
  "settings.browser.allowControl": "Allow Tiancode to control the built-in browser",
  "settings.browser.allowControl.description": "Show the built-in browser in the app to view apps and sites in real time",
...
"settings.mcpServers.group.unknown": "Unknown",
  ...
  "settings.computerUse.tools.description": "Tiancode cannot move the mouse or press keys. It can take a screenshot and read or write the clipboard, and only from the desktop app.",
