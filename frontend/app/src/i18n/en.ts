...
export const dict = {
  ...
  "settings.modelsHub.load.description": "The same knobs LM Studio offers when a model loads. They apply the next time the native engine starts a model.",
  "settings.modelsHub.load.reset": "Reset",
  "settings.modelsHub.load.hint": "0 or −1 means automatic. Ollama and LM Studio keep their own settings.",
  "settings.modelsHub.load.choice.auto": "Automatic",
  "settings.modelsHub.load.choice.on": "On",
  "settings.modelsHub.load.choice.off": "Off",
  "settings.modelsHub.load.contextSize.title": "Context length",
  "settings.modelsHub.load.contextSize.description": "Tokens the model keeps in memory. Higher values use more VRAM.",
  "settings.modelsHub.load.gpuLayers.title": "GPU offload",
  "settings.modelsHub.load.gpuLayers.description": "Layers offloaded to the GPU. 99 offloads everything, 0 runs on CPU.",
  "settings.modelsHub.load.threads.title": "CPU thread pool size",
  "settings.modelsHub.load.threads.description": "Threads used for CPU work. 0 picks all cores minus one.",
  "settings.modelsHub.load.batchSize.title": "Evaluation batch size",
  "settings.modelsHub.load.batchSize.description": "Input tokens processed together in a single batch.",
  "settings.modelsHub.load.flashAttention.title": "Flash Attention",
  "settings.modelsHub.load.flashAttention.description": "Optimised attention kernel. Faster on modern GPUs, may not work on every model.",
  "settings.modelsHub.load.kvCacheType.title": "K/V cache quantization",
  "settings.modelsHub.load.kvCacheType.description": "Quantizes the key-value cache to fit longer contexts in less memory.",
  "settings.modelsHub.load.keepInMemory.title": "Keep model in memory",
  "settings.modelsHub.load.keepInMemory.description": "Locks the model in RAM so it is never swapped out (mlock).",
  "settings.modelsHub.load.useMmap.title": "Try mmap()",
  "settings.modelsHub.load.useMmap.description": "Maps the model file instead of copying it. Faster loads, shared memory.",
  "settings.modelsHub.load.kvOffload.title": "Offload KV cache to GPU memory",
  "settings.modelsHub.load.kvOffload.description": "Keeps the cache in VRAM with the layers. Turn off if VRAM is tight.",
  "settings.modelsHub.load.seed.title": "Seed",
  "settings.modelsHub.load.seed.description": "Fixed seed for reproducible outputs. −1 uses a random one.",
  "settings.modelsHub.load.ropeFrequencyBase.title": "RoPE frequency base",
  "settings.modelsHub.load.ropeFrequencyBase.description": "Custom rotary embedding base. 0 keeps the model's value.",
  "settings.modelsHub.load.ropeFrequencyScale.title": "RoPE frequency scale",
  "settings.modelsHub.load.ropeFrequencyScale.description": "Scaling for rotary embeddings when stretching context. 0 keeps the model's value.",
  "settings.modelsHub.load.parallel.title": "Parallel requests",
  "settings.modelsHub.load.parallel.description": "Simultaneous request slots. Each slot splits the context.",
  ...
  "settings.modelsHub.dir.restart": "New downloads and the engine use this folder right away, and “On disk” lists the models it already holds. The app remembers it on the next start.",
  ...
  "chat.mic.listening": "Listening… click the microphone to finish",
  "prompt.folder.title": "Add folders to the conversation",
  "settings.pets.kind.otter": "Otter",
  "settings.pets.kind.otter.species": "Playful Otter",
  "settings.pets.kind.otter.description": "Curious and playful, floats through long refactors without losing the thread.",
  "settings.pets.kind.otter.trait": "Keeps context across many files",
  "settings.pets.kind.owl": "Owl",
  "settings.pets.kind.owl.species": "Wise Owl",
  "settings.pets.kind.owl.description": "Sees in the dark: reviews logs and stack traces with patience.",
  "settings.pets.kind.owl.trait": "Best at debugging and code review",
  "settings.pets.kind.dino": "Dino",
  "settings.pets.kind.dino.species": "Friendly Dino",
  "settings.pets.kind.dino.description": "Old-school and sturdy, loves legacy code and big migrations.",
  "settings.pets.kind.dino.trait": "Handles legacy systems and migrations",
  "settings.pets.kind.penguin": "Penguin",
  "settings.pets.kind.penguin.species": "Cool Penguin",
  "settings.pets.kind.penguin.description": "Calm under pressure, keeps deployments and CI pipelines tidy.",
  "settings.pets.kind.penguin.trait": "DevOps and release discipline",
  "settings.pets.kind.redpanda": "Red panda",
  "settings.pets.kind.redpanda.species": "Gentle Red Panda",
  "settings.pets.kind.redpanda.description": "Warm and careful, polishes interfaces and copy until they feel right.",
  "settings.pets.kind.redpanda.trait": "UI polish and design details",
  "settings.pets.kind.robot": "Robot",
  "settings.pets.kind.robot.species": "Precise Robot",
  "settings.pets.kind.robot.description": "Tireless and exact, runs tests and automations without complaint.",
  "settings.pets.kind.robot.trait": "Testing and automation",
  "settings.pets.kind.koala": "Koala",
  "settings.pets.kind.koala.species": "Relaxed Koala",
  "settings.pets.kind.koala.description": "Unhurried and thorough, reads documentation before touching anything.",
  "settings.pets.kind.koala.trait": "Documentation and careful planning",
  "settings.pets.kind.hamster": "Hamster",
  "settings.pets.kind.hamster.species": "Busy Hamster",
  "settings.pets.kind.hamster.description": "Quick and energetic, spins through small tasks and fixes in no time.",
  "settings.pets.kind.hamster.trait": "Fast fixes and small tasks",
  "settings.sections.label": "Settings sections",
  "titlebar.debugTools": "Toggle debug tools",
  "chat.mic.transcribing": "Transcribing…",
  "settings.general.row.showVoice.title": "Voice controls in the title bar",
  ...
  "settings.pets.total": "{{count}} interactive companions",
  ...
  "dialog.model.manageProvider": "Manage provider",
  ...
  "settings.modelsHub.auto.title": "Automatic configuration",
  "settings.modelsHub.auto.description": "Reads each model's GGUF header (training context, layers, heads) plus your VRAM and RAM to set context, GPU layers, threads, batch and KV cache at load time. Turn it off to use the manual values below.",
  "settings.modelsHub.auto.applied": "Applied to the loaded model",
  "settings.modelsHub.auto.idle": "Computed when each model loads. “On disk” shows the proposal for every file.",
  "settings.modelsHub.auto.manualDisabled": "Manual values are ignored while automatic configuration is on.",
  "settings.modelsHub.disk.title": "Models on disk",
  "settings.modelsHub.disk.description": "Every GGUF file in the models folder (and Tiancode's earlier folders), with what its header says and the load configuration proposed for this machine.",
  "settings.modelsHub.disk.empty": "There are no GGUF files in the models folder.",
  "settings.modelsHub.disk.activate": "Activate and use",
  "settings.modelsHub.disk.active": "Loaded",
  "settings.modelsHub.disk.rescan": "Rescan",
  "settings.modelsHub.disk.folder": "Folder",
  "settings.modelsHub.disk.trainContext": "Training context",
  "settings.modelsHub.disk.layers": "Layers",
  "settings.modelsHub.disk.recommended": "Proposed load",
  "settings.modelsHub.disk.delete": "Delete from disk",
  "settings.modelsHub.disk.smallModelNote": "Models under 7B usually respond worse with tools and long prompts; for coding, try 7B or larger.",
  "settings.modelsHub.placement.gpu": "All on GPU",
  "settings.modelsHub.placement.hybrid": "GPU + RAM",
  "settings.modelsHub.placement.cpu": "CPU only",
  "settings.modelsHub.reason.fits_gpu": "The model and its cache fit in VRAM.",
  "settings.modelsHub.reason.hybrid": "It does not fit entirely in VRAM: some layers go to RAM.",
  "settings.modelsHub.reason.cpu_only": "No usable GPU: runs on the CPU.",
  "settings.modelsHub.reason.kv_q8_for_context": "KV cache in q8_0 to gain context.",
  "settings.modelsHub.reason.kv_q8_for_memory": "KV cache in q8_0 to save memory.",
  "settings.modelsHub.reason.ctx_train_limit": "Context limited by the model's training.",
  "settings.modelsHub.reason.ctx_vram_limit": "Context limited by the available VRAM.",
  ...
  "settings.modelsHub.auto.vram.title": "Maximum VRAM use",
  "settings.modelsHub.auto.vram.description": "Share of the GPU memory the model and its cache may occupy.",
  "settings.modelsHub.auto.ram.title": "Maximum RAM use",
  "settings.modelsHub.auto.ram.description": "Share of system memory for the layers that do not fit on the GPU.",
  "settings.modelsHub.auto.cpu.title": "CPU use",
  "settings.modelsHub.auto.cpu.description": "Share of the cores dedicated to the model.",
  "settings.modelsHub.auto.placement.title": "GPU / RAM split",
  "settings.modelsHub.auto.placement.description": "Automatic decides by model size; GPU + RAM always splits; CPU only never touches the graphics card.",
  "settings.modelsHub.placement.auto": "Automatic",
  "settings.modelsHub.auto.idle.title": "Unload when idle",
  "settings.modelsHub.auto.idle.description": "Frees the VRAM when the chat has not used the model for this long; it reloads by itself on the next request (like LM Studio's JIT or Ollama's keep_alive).",
  "settings.modelsHub.auto.idle.never": "Never (always loaded)",
  "settings.modelsHub.auto.idle.minutes": "{{n}} min",
  "settings.modelsHub.auto.lightweight": "With local models the chat uses a lightweight mode: a compact prompt and only the core tools, so it fits the context and actually answers.",
}
