...
export const dict = {
  ...
  "settings.general.row.previewAutoOpen.description": "当 AI 在本会话中启动 Web 应用时自动打开实时预览。关闭后只能手动打开。",
  "settings.general.row.restore.delete": "删除",
  "settings.general.backup.delete.confirm": "要彻底删除 {{name}} 的备份吗？此操作无法撤销。",
  "settings.general.backup.delete.success": "备份已删除",
  "settings.general.backup.delete.failed": "无法删除备份",
  "settings.modelsHub.load.title": "加载参数",
  "settings.modelsHub.load.description": "与 LM Studio 加载模型时提供的设置相同。下次原生引擎启动模型时生效。",
  "settings.modelsHub.load.reset": "重置",
  "settings.modelsHub.load.hint": "0 或 −1 表示自动。Ollama 与 LM Studio 使用各自的设置。",
  "settings.modelsHub.load.choice.auto": "自动",
  "settings.modelsHub.load.choice.on": "开启",
  "settings.modelsHub.load.choice.off": "关闭",
  "settings.modelsHub.load.contextSize.title": "上下文长度",
  "settings.modelsHub.load.contextSize.description": "模型在内存中保留的 token 数。越大占用的显存越多。",
  "settings.modelsHub.load.gpuLayers.title": "GPU 卸载",
  "settings.modelsHub.load.gpuLayers.description": "发送到 GPU 的层数。99 为全部，0 为仅用 CPU。",
  "settings.modelsHub.load.threads.title": "CPU 线程数",
  "settings.modelsHub.load.threads.description": "用于 CPU 计算的线程。0 表示全部核心减一。",
  "settings.modelsHub.load.batchSize.title": "评估批大小",
  "settings.modelsHub.load.batchSize.description": "单个批次中一起处理的输入 token 数。",
  "settings.modelsHub.load.flashAttention.title": "Flash Attention",
  "settings.modelsHub.load.flashAttention.description": "优化的注意力内核。在新 GPU 上更快，但并非所有模型都支持。",
  "settings.modelsHub.load.kvCacheType.title": "K/V 缓存量化",
  "settings.modelsHub.load.kvCacheType.description": "量化键值缓存，用更少内存容纳更长上下文。",
  "settings.modelsHub.load.keepInMemory.title": "将模型保留在内存中",
  "settings.modelsHub.load.keepInMemory.description": "把模型锁定在 RAM 中，避免被换出（mlock）。",
  "settings.modelsHub.load.useMmap.title": "尝试 mmap()",
  "settings.modelsHub.load.useMmap.description": "映射模型文件而不是复制。加载更快，内存共享。",
  "settings.modelsHub.load.kvOffload.title": "KV 缓存放入 GPU 显存",
  "settings.modelsHub.load.kvOffload.description": "缓存与层一起保存在显存中。显存紧张时可关闭。",
  "settings.modelsHub.load.seed.title": "随机种子",
  "settings.modelsHub.load.seed.description": "固定种子以获得可复现的输出。−1 为随机。",
  "settings.modelsHub.load.ropeFrequencyBase.title": "RoPE 频率基数",
  "settings.modelsHub.load.ropeFrequencyBase.description": "自定义旋转位置编码基数。0 保持模型默认值。",
  "settings.modelsHub.load.ropeFrequencyScale.title": "RoPE 频率缩放",
  "settings.modelsHub.load.ropeFrequencyScale.description": "拉伸上下文时的旋转编码缩放。0 保持模型默认值。",
  "settings.modelsHub.load.parallel.title": "并行请求",
  "settings.modelsHub.load.parallel.description": "同时请求的槽位数。每个槽位会分摊上下文。",
  ...
  "settings.modelsHub.dir.restart": "新下载和引擎会立即使用此文件夹，“磁盘上”会列出其中已有的模型。应用在下次启动时会记住它。",
  ...
  "chat.mic.listening": "正在聆听… 点击麦克风结束",
  "prompt.folder.title": "将文件夹添加到对话",
  "settings.pets.kind.otter": "水獭",
  "settings.pets.kind.otter.species": "爱玩的水獭",
  "settings.pets.kind.otter.description": "好奇又爱玩，在漫长的重构中也不会迷失方向。",
  "settings.pets.kind.otter.trait": "跨多个文件保持上下文",
  "settings.pets.kind.owl": "猫头鹰",
  "settings.pets.kind.owl.species": "智慧猫头鹰",
  "settings.pets.kind.owl.description": "夜视能力强，耐心审阅日志和堆栈跟踪。",
  "settings.pets.kind.owl.trait": "擅长调试与代码审查",
  "settings.pets.kind.dino": "小恐龙",
  "settings.pets.kind.dino.species": "友好的恐龙",
  "settings.pets.kind.dino.description": "老派而稳健，喜欢遗留代码和大型迁移。",
  "settings.pets.kind.dino.trait": "处理遗留系统与迁移",
  "settings.pets.kind.penguin": "企鹅",
  "settings.pets.kind.penguin.species": "沉着的企鹅",
  "settings.pets.kind.penguin.description": "临危不乱，让部署和 CI 流水线井井有条。",
  "settings.pets.kind.penguin.trait": "DevOps 与发布纪律",
  "settings.pets.kind.redpanda": "小熊猫",
  "settings.pets.kind.redpanda.species": "温柔的小熊猫",
  "settings.pets.kind.redpanda.description": "温暖细致，把界面和文案打磨到恰到好处。",
  "settings.pets.kind.redpanda.trait": "UI 打磨与设计细节",
  "settings.pets.kind.robot": "机器人",
  "settings.pets.kind.robot.species": "精准的机器人",
  "settings.pets.kind.robot.description": "不知疲倦且精确，默默运行测试与自动化。",
  "settings.pets.kind.robot.trait": "测试与自动化",
  "settings.pets.kind.koala": "考拉",
  "settings.pets.kind.koala.species": "悠闲的考拉",
  "settings.pets.kind.koala.description": "不急不躁、细致周到，动手前先读文档。",
  "settings.pets.kind.koala.trait": "文档与谨慎规划",
  "settings.pets.kind.hamster": "仓鼠",
  "settings.pets.kind.hamster.species": "勤快的仓鼠",
  "settings.pets.kind.hamster.description": "敏捷有活力，小任务和修复转眼就完成。",
  "settings.pets.kind.hamster.trait": "快速修复与小任务",
  "settings.sections.label": "设置分区",
  "titlebar.debugTools": "切换调试工具",
  "chat.mic.transcribing": "正在转写…",
  "settings.general.row.showVoice.title": "标题栏的语音控件",
  "settings.general.row.showVoice.description": "在聊天标题栏显示语音播放控件。",
  ...
  "settings.pets.total": "{{count}} 个互动伙伴",
  ...
  "dialog.model.manageProvider": "管理提供商",
  ...
  "settings.modelsHub.auto.title": "自动配置",
  "settings.modelsHub.auto.description": "读取每个模型的 GGUF 头（训练上下文、层数、头数）以及你的显存和内存，在加载时设置上下文、GPU 层数、线程、批大小和 KV 缓存。关闭后使用下方手动值。",
  "settings.modelsHub.auto.applied": "已应用于已加载模型",
  "settings.modelsHub.auto.idle": "在加载每个模型时计算。“磁盘上”会显示每个文件的建议。",
  "settings.modelsHub.auto.manualDisabled": "自动配置开启时将忽略手动值。",
  "settings.modelsHub.disk.title": "磁盘上的模型",
  "settings.modelsHub.disk.description": "模型文件夹（以及 Tiancode 之前的文件夹）中的所有 GGUF 文件，包含头信息和为本机建议的加载配置。",
  "settings.modelsHub.disk.empty": "模型文件夹中没有 GGUF 文件。",
  "settings.modelsHub.disk.activate": "启用并使用",
  "settings.modelsHub.disk.active": "已加载",
  "settings.modelsHub.disk.rescan": "重新扫描",
  "settings.modelsHub.disk.folder": "文件夹",
  "settings.modelsHub.disk.trainContext": "训练上下文",
  "settings.modelsHub.disk.layers": "层数",
  "settings.modelsHub.disk.recommended": "建议的加载配置",
  "settings.modelsHub.disk.delete": "从磁盘删除",
  "settings.modelsHub.disk.smallModelNote": "小于 7B 的模型在工具调用和长提示下通常表现较差；编程建议使用 7B 或更大的模型。",
  "settings.modelsHub.placement.gpu": "全部在 GPU",
  "settings.modelsHub.placement.hybrid": "GPU + 内存",
  "settings.modelsHub.placement.cpu": "仅 CPU",
  "settings.modelsHub.reason.fits_gpu": "模型及其缓存可放入显存。",
  "settings.modelsHub.reason.hybrid": "无法完全放入显存：部分层放到内存。",
  "settings.modelsHub.reason.cpu_only": "没有可用 GPU：在 CPU 上运行。",
  "settings.modelsHub.reason.kv_q8_for_context": "KV 缓存使用 q8_0 以获得更多上下文。",
  "settings.modelsHub.reason.kv_q8_for_memory": "KV 缓存使用 q8_0 以节省内存。",
  "settings.modelsHub.reason.ctx_train_limit": "上下文受模型训练上限限制。",
  "settings.modelsHub.reason.ctx_vram_limit": "上下文受可用显存限制。",
  ...
  "settings.modelsHub.auto.vram.title": "显存最大占用",
  "settings.modelsHub.auto.vram.description": "模型及其缓存可占用的 GPU 内存比例。",
  "settings.modelsHub.auto.ram.title": "内存最大占用",
  "settings.modelsHub.auto.ram.description": "用于放不进 GPU 的层的系统内存比例。",
  "settings.modelsHub.auto.cpu.title": "CPU 占用",
  "settings.modelsHub.auto.cpu.description": "分配给模型的核心比例。",
  "settings.modelsHub.auto.placement.title": "GPU / 内存分配",
  "settings.modelsHub.auto.placement.description": "自动根据模型大小决定；GPU + 内存始终分配；仅 CPU 不使用显卡。",
  "settings.modelsHub.placement.auto": "自动",
  "settings.modelsHub.auto.idle.title": "空闲时卸载",
  "settings.modelsHub.auto.idle.description": "当聊天在此时间内未使用模型时释放显存；下次请求时自动重新加载（类似 LM Studio 的 JIT 或 Ollama 的 keep_alive）。",
  "settings.modelsHub.auto.idle.never": "从不（始终加载）",
  "settings.modelsHub.auto.idle.minutes": "{{n}} 分钟",
  "settings.modelsHub.auto.lightweight": "使用本地模型时，聊天采用轻量模式：紧凑提示词和核心工具，以适应上下文并真正作答。",
