...
"settings.mcpServers.group.unknown": "未知",
  ...
  "welcome.step1.subtitle": "选择语言与主题",
  "welcome.step2.subtitle": "连接 AI 服务商",
  "welcome.step3.subtitle": "选择你的工作区",
  "welcome.language.label": "选择界面语言",
  "welcome.theme.label": "配色模式",
  "welcome.theme.dark": "深色",
  "welcome.theme.light": "浅色",
  "welcome.theme.system": "跟随系统",
  "welcome.provider.title": "AI 服务商",
  "welcome.provider.description": "Tiancode 至少需要一个模型服务商才能回应你。你可以连接云端服务商，也可以稍后在「本地模型」中运行本地模型。",
  "welcome.provider.connect": "现在就设置",
  "welcome.provider.connect.desc": "设置完成后立即打开服务商设置",
  "welcome.provider.later": "稍后再说",
  "welcome.provider.later.desc": "直接进入应用；随时可在「设置」中连接",
  "welcome.workspace.title": "工作区",
  "welcome.workspace.description": "Tiancode 在项目文件夹中工作。请选择你的起步方式。",
