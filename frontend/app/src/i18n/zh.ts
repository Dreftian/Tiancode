...
export const dict = {
  ...
  "settings.connections.description": "将 Tiancode 与 Telegram、WhatsApp、Discord、Slack 和 Webhook 连接，以实现远程通知和移动端代理交互。",
  "settings.connections.telegram.title": "Telegram Bot 网关",
  "settings.connections.telegram.token": "Bot Token",
  "settings.connections.telegram.tokenMissing": "请输入 Telegram Bot Token",
  "settings.connections.telegram.testSuccess": "已成功连接至 Telegram！",
  "settings.connections.telegram.chatId": "Chat ID / 用户",
  "settings.connections.telegram.pairing": "双向交互配对",
  "settings.connections.telegram.pairingDescription": "允许直接从 Telegram 向 Tiancode 发送指令并批准操作。",
  "settings.connections.telegram.notifyBuilds": "构建通知",
  "settings.connections.whatsapp.title": "WhatsApp 网关",
  "settings.connections.whatsapp.phone": "WhatsApp 手机号 / ID",
  "settings.connections.whatsapp.phoneMissing": "请输入您的 WhatsApp 手机号",
  "settings.connections.whatsapp.pairedSuccess": "配对码已生成",
  "settings.connections.whatsapp.pairingMode": "配对方式",
  "settings.connections.whatsapp.notifyBuilds": "构建和测试通知",
  "settings.connections.whatsapp.notifyErrors": "严重异常警报",
  "settings.connections.discord.title": "Discord",
  "settings.connections.discord.authMode": "连接方式",
  "settings.connections.discord.channel": "通知频道",
  "settings.connections.discord.notifyBuilds": "构建与提交通知",
  "settings.connections.discord.missingTarget": "请输入 Webhook URL 或 Discord Token",
  "settings.connections.discord.testSuccess": "测试消息已发送到 Discord",
  "settings.connections.slack.title": "Slack",
  "settings.connections.slack.webhook": "Incoming Webhook URL",
  "settings.connections.slack.channel": "默认频道",
  "settings.connections.slack.notifyBackground": "后台任务通知",
  "settings.connections.slack.missingUrl": "请输入 Slack Incoming Webhook URL",
  "settings.connections.slack.testSuccess": "Slack Webhook 已验证",
  ...
  "settings.connections.webhooks.missingUrl": "请输入 Endpoint URL",
  "settings.connections.webhooks.testSuccess": "测试负载已发送",
