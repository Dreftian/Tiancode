...
export const dict = {
  ...
  "settings.plugins.catalog.npm.biome.description": "用于 JavaScript 和 TypeScript 的快速 linter 和格式化工具。",
  "settings.plugins.catalog.npm.playwrightMcp.description": "用于 Web 应用的浏览器自动化和 E2E 测试。",
  "settings.plugins.catalog.npm.octokitRest.description": "用于拉取请求、问题和仓库的 GitHub API 客户端。",
  "settings.plugins.catalog.npm.slackWebApi.description": "用于消息和对话的官方 Slack Web API 客户端。",
  "settings.plugins.catalog.npm.notionClient.description": "用于页面、数据库和块的官方 Notion API 客户端。",
  "settings.plugins.catalog.npm.sentryCli.description": "Sentry 错误监控、发布和 source map 上传。",
  "settings.plugins.catalog.npm.agentNotify.description": "在代理任务完成或失败时发送通知。",
  "settings.plugins.catalog.npm.chimeClaude.description": "代理生命周期事件的 Telegram 通知。",
