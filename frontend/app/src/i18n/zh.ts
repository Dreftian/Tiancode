...
"settings.mcpServers.group.unknown": "未知",
  ...
  "prompt.optimize.empty": "请先输入文本",
  "prompt.optimize.optimizing": "正在优化输入...",
  ...
  "settings.intelligence.autoSkill": "技能自动提炼 (/learn)",
  "settings.intelligence.autoSkill.desc": "自动建议将成功的复杂工作流打包为可复用的 SKILL.md 文件。",
  "settings.intelligence.section.codegraph": "代码图谱与 AST",
  "settings.intelligence.codeGraph": "代码图谱分析 (CodeGraph)",
  "settings.intelligence.codeGraph.desc": "索引函数、类和依赖关系，在编辑前推理架构影响。",
  "settings.intelligence.monaco": "Monaco 差异查看器",
  "settings.intelligence.monaco.desc": "在应用补丁前以并排视图和语法高亮展示差异对比。",
  "settings.intelligence.section.safety": "网页与执行安全",
  "settings.intelligence.cleanWeb": "干净网页提取 (Firecrawl 引擎)",
  "settings.intelligence.cleanWeb.desc": "剔除脚本、Cookie 和菜单，将网页转换为面向 LLM 优化的纯 Markdown。",
  "settings.intelligence.guardrails": "护栏与密钥脱敏流水线",
  "settings.intelligence.guardrails.desc": "在向外部服务商发送请求前，屏蔽密码、令牌和私钥。",
  "settings.intelligence.sandbox": "沙箱执行模式",
