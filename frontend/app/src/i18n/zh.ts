...
"settings.mcpServers.group.unknown": "未知",
  ...
  "settings.voices.dictation.hold.title": "按住说话的听写快捷键",
  "settings.voices.dictation.hold.description": "在桌面任意位置按住即可在光标处听写",
  "settings.voices.dictation.recordings.title": "最近的录音",
  "settings.voices.dictation.recordings.description": "最近 20 条录音保存在此设备上",
  "settings.voices.dictation.toggle.title": "切换听写热键",
  "settings.voices.dictation.toggle.description": "在桌面任意位置按一次开始听写，再按一次停止",
