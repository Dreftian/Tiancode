export const dict = {
  ...
  "settings.connections.description": "Tiancode를 Telegram, WhatsApp, Discord, Slack 및 Webhook과 연결하여 원격 알림과 모바일 상호작용을 활성화합니다.",
  "settings.connections.telegram.title": "Telegram Bot 게이트웨이",
  "settings.connections.telegram.token": "Bot Token",
  "settings.connections.telegram.tokenMissing": "Telegram Bot Token을 입력하세요",
  "settings.connections.telegram.testSuccess": "Telegram 연결 성공!",
  "settings.connections.telegram.chatId": "Chat ID / 사용자",
  "settings.connections.telegram.pairing": "양방향 대화형 페어링",
  "settings.connections.telegram.pairingDescription": "Telegram에서 직접 명령을 수신하고 작업을 승인할 수 있습니다.",
  "settings.connections.telegram.notifyBuilds": "빌드 알림",
  "settings.connections.whatsapp.title": "WhatsApp 게이트웨이",
  "settings.connections.whatsapp.phone": "WhatsApp 전화번호 / ID",
  "settings.connections.whatsapp.phoneMissing": "WhatsApp 전화번호를 입력하세요",
  "settings.connections.whatsapp.pairedSuccess": "페어링 코드가 생성되었습니다",
  "settings.connections.whatsapp.pairingMode": "페어링 방식",
  "settings.connections.whatsapp.notifyBuilds": "빌드 및 테스트 알림",
  "settings.connections.whatsapp.notifyErrors": "치명적 예외 경고",
  "settings.connections.discord.title": "Discord",
  "settings.connections.discord.authMode": "연결 방식",
  "settings.connections.discord.channel": "알림 채널",
  "settings.connections.discord.notifyBuilds": "빌드 및 커밋 알림",
  "settings.connections.discord.missingTarget": "Webhook URL 또는 Discord 토큰을 입력하세요",
  "settings.connections.discord.testSuccess": "Discord로 테스트 메시지가 전송되었습니다",
  "settings.connections.slack.title": "Slack",
  "settings.connections.slack.webhook": "Incoming Webhook URL",
  "settings.connections.slack.channel": "기본 채널",
  "settings.connections.slack.notifyBackground": "백그라운드 작업 알림",
  "settings.connections.slack.missingUrl": "Slack Incoming Webhook URL을 입력하세요",
  "settings.connections.slack.testSuccess": "Slack Webhook이 확인되었습니다",
  ...
  "settings.connections.webhooks.missingUrl": "Endpoint URL을 입력하세요",
  "settings.connections.webhooks.testSuccess": "테스트 페이로드가 전송되었습니다",
