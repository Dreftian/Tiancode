...
"settings.mcpServers.group.unknown": "알 수 없음",
  ...
  "welcome.step1.subtitle": "언어와 테마 선택",
  "welcome.step2.subtitle": "AI 제공자 연결",
  "welcome.step3.subtitle": "작업 공간 선택",
  "welcome.language.label": "표시 언어 선택",
  "welcome.theme.label": "색상 모드",
  "welcome.theme.dark": "다크",
  "welcome.theme.light": "라이트",
  "welcome.theme.system": "시스템",
  "welcome.provider.title": "AI 제공자",
  "welcome.provider.description": "Tiancode가 응답하려면 최소 한 개의 모델 제공자가 필요합니다. 클라우드 제공자를 연결하거나, 나중에 로컬 모델 탭에서 로컬 모델을 실행할 수 있습니다.",
  "welcome.provider.connect": "지금 설정하기",
  "welcome.provider.connect.desc": "설정을 마치면 제공자 설정을 엽니다",
  "welcome.provider.later": "나중에 하기",
  "welcome.provider.later.desc": "앱으로 바로 이동합니다. 설정에서 언제든 연결할 수 있습니다",
  "welcome.workspace.title": "작업 공간",
  "welcome.workspace.description": "Tiancode는 프로젝트 폴더 안에서 동작합니다. 시작 방식을 선택하세요.",
