...
"settings.mcpServers.group.unknown": "알 수 없음",
  ...
  "settings.voices.dictation.hold.title": "누르고 있는 동안 받아쓰기 단축키",
  "settings.voices.dictation.hold.description": "바탕 화면 어디서나 누르고 있으면 커서 위치에 받아쓰기됩니다",
  "settings.voices.dictation.recordings.title": "최근 녹음",
  "settings.voices.dictation.recordings.description": "최근 20개의 녹음이 이 기기에 저장됩니다",
  "settings.voices.dictation.toggle.title": "받아쓰기 단축키 전환",
  "settings.voices.dictation.toggle.description": "바탕 화면 어디서나 한 번 누르면 받아쓰기를 시작하고 다시 누르면 멈춥니다",
