...
"settings.mcpServers.group.unknown": "알 수 없음",
  ...
  "settings.mcpServers.discover.presets.unreal.description": "Unreal Engine 프로젝트 제어(Web Remote Control): 편집기를 열고 Python 및 콘솔 명령 실행, 로그 및 레벨 액터 읽기. unreal-opencode-mcp 폴더 설치 필요.",
