...
export const dict = {
  ...
  "settings.modelsHub.load.description": "LM Studio가 모델을 로드할 때 제공하는 것과 같은 설정입니다. 네이티브 엔진이 다음에 모델을 시작할 때 적용됩니다.",
  "settings.modelsHub.load.reset": "재설정",
  "settings.modelsHub.load.hint": "0 또는 −1은 자동을 뜻합니다. Ollama와 LM Studio는 자체 설정을 유지합니다.",
  "settings.modelsHub.load.choice.auto": "자동",
  "settings.modelsHub.load.choice.on": "켜기",
  "settings.modelsHub.load.choice.off": "끄기",
  "settings.modelsHub.load.contextSize.title": "컨텍스트 길이",
  "settings.modelsHub.load.contextSize.description": "모델이 메모리에 유지하는 토큰 수. 클수록 VRAM을 더 씁니다.",
  "settings.modelsHub.load.gpuLayers.title": "GPU 오프로드",
  "settings.modelsHub.load.gpuLayers.description": "GPU로 보내는 레이어 수. 99는 전부, 0은 CPU 실행.",
  "settings.modelsHub.load.threads.title": "CPU 스레드 수",
  "settings.modelsHub.load.threads.description": "CPU 작업에 쓰는 스레드. 0이면 코어 수 −1.",
  "settings.modelsHub.load.batchSize.title": "평가 배치 크기",
  "settings.modelsHub.load.batchSize.description": "한 배치에서 함께 처리하는 입력 토큰 수.",
  "settings.modelsHub.load.flashAttention.title": "Flash Attention",
  "settings.modelsHub.load.flashAttention.description": "최적화된 어텐션 커널. 최신 GPU에서 빠르지만 일부 모델은 지원하지 않습니다.",
  "settings.modelsHub.load.kvCacheType.title": "K/V 캐시 양자화",
  "settings.modelsHub.load.kvCacheType.description": "키-값 캐시를 양자화해 적은 메모리로 긴 컨텍스트를 처리합니다.",
  "settings.modelsHub.load.keepInMemory.title": "모델을 메모리에 유지",
  "settings.modelsHub.load.keepInMemory.description": "모델을 RAM에 고정해 스왑되지 않게 합니다(mlock).",
  "settings.modelsHub.load.useMmap.title": "mmap() 시도",
  "settings.modelsHub.load.useMmap.description": "모델 파일을 복사하지 않고 매핑합니다. 더 빠른 로드, 공유 메모리.",
  "settings.modelsHub.load.kvOffload.title": "KV 캐시를 GPU 메모리로",
  "settings.modelsHub.load.kvOffload.description": "캐시를 레이어와 함께 VRAM에 둡니다. VRAM이 부족하면 끄세요.",
  "settings.modelsHub.load.seed.title": "시드",
  "settings.modelsHub.load.seed.description": "재현 가능한 출력을 위한 고정 시드. −1은 무작위.",
  "settings.modelsHub.load.ropeFrequencyBase.title": "RoPE 주파수 베이스",
  "settings.modelsHub.load.ropeFrequencyBase.description": "회전 위치 임베딩 베이스. 0이면 모델 값 유지.",
  "settings.modelsHub.load.ropeFrequencyScale.title": "RoPE 주파수 스케일",
  "settings.modelsHub.load.ropeFrequencyScale.description": "컨텍스트를 늘릴 때의 회전 임베딩 스케일. 0이면 모델 값 유지.",
  "settings.modelsHub.load.parallel.title": "병렬 요청",
  "settings.modelsHub.load.parallel.description": "동시 요청 슬롯 수. 슬롯마다 컨텍스트를 나눕니다.",
  ...
  "settings.modelsHub.dir.restart": "새 다운로드와 엔진이 즉시 이 폴더를 사용하고, ‘디스크’에 이미 있는 모델이 표시됩니다. 다음 시작 때도 기억합니다.",
  ...
  "chat.mic.listening": "듣는 중… 마이크를 클릭하면 종료됩니다",
  "prompt.folder.title": "대화에 폴더 추가",
  "settings.pets.kind.otter": "수달",
  "settings.pets.kind.otter.species": "장난꾸러기 수달",
  "settings.pets.kind.otter.description": "호기심 많고 장난스러워 긴 리팩터링에서도 흐름을 잃지 않습니다.",
  "settings.pets.kind.otter.trait": "여러 파일에 걸친 맥락 유지",
  "settings.pets.kind.owl": "올빼미",
  "settings.pets.kind.owl.species": "지혜로운 올빼미",
  "settings.pets.kind.owl.description": "어둠 속에서도 봅니다. 로그와 스택 추적을 차분히 검토합니다.",
  "settings.pets.kind.owl.trait": "디버깅과 코드 리뷰에 최적",
  "settings.pets.kind.dino": "디노",
  "settings.pets.kind.dino.species": "친근한 공룡",
  "settings.pets.kind.dino.description": "고전적이고 튼튼해서 레거시 코드와 대규모 마이그레이션을 좋아합니다.",
  "settings.pets.kind.dino.trait": "레거시 시스템과 마이그레이션 담당",
  "settings.pets.kind.penguin": "펭귄",
  "settings.pets.kind.penguin.species": "차분한 펭귄",
  "settings.pets.kind.penguin.description": "압박 속에서도 침착하게 배포와 CI 파이프라인을 정돈합니다.",
  "settings.pets.kind.penguin.trait": "DevOps와 릴리스 규율",
  "settings.pets.kind.redpanda": "레서판다",
  "settings.pets.kind.redpanda.species": "온화한 레서판다",
  "settings.pets.kind.redpanda.description": "따뜻하고 세심하게 인터페이스와 문구를 다듬습니다.",
  "settings.pets.kind.redpanda.trait": "UI 다듬기와 디자인 디테일",
  "settings.pets.kind.robot": "로봇",
  "settings.pets.kind.robot.species": "정밀한 로봇",
  "settings.pets.kind.robot.description": "지치지 않고 정확하게 테스트와 자동화를 수행합니다.",
  "settings.pets.kind.robot.trait": "테스트와 자동화",
  "settings.pets.kind.koala": "코알라",
  "settings.pets.kind.koala.species": "느긋한 코알라",
  "settings.pets.kind.koala.description": "서두르지 않고 꼼꼼하게, 손대기 전에 문서부터 읽습니다.",
  "settings.pets.kind.koala.trait": "문서화와 신중한 계획",
  "settings.pets.kind.hamster": "햄스터",
  "settings.pets.kind.hamster.species": "부지런한 햄스터",
  "settings.pets.kind.hamster.description": "빠르고 활기차게 작은 작업과 수정을 금세 처리합니다.",
  "settings.pets.kind.hamster.trait": "빠른 수정과 작은 작업",
  "settings.sections.label": "설정 섹션",
  "titlebar.debugTools": "디버그 도구 전환",
  "chat.mic.transcribing": "받아쓰는 중…",
  "settings.general.row.showVoice.title": "제목 표시줄의 음성 컨트롤",
  ...
  "settings.pets.total": "인터랙티브 컴패니언 {{count}}종",
  ...
  "settings.subAgents.list.user.hint": "agent/*.md 파일에서",
  "settings.subAgents.create.manual": "직접 만들기",
  "settings.subAgents.create.ai": "AI로 생성",
  ...
  "settings.subAgents.generate.running": "생성 중...",
  "settings.subAgents.generate.needsDescription": "먼저 서브에이전트가 할 일을 설명하세요",
  "settings.subAgents.generate.failed": "서브에이전트를 생성하지 못했습니다",
  "settings.subAgents.generate.failed.noModel": "사용할 수 있는 모델이 없습니다. 먼저 모델을 선택하세요.",
  "settings.subAgents.generate.failed.model": "모델 호출에 실패했습니다. 다시 시도하거나 다른 모델을 선택하세요.",
  "settings.subAgents.generate.failed.network": "서버에 연결할 수 없습니다.",
  "settings.subAgents.generate.ready": "초안이 준비되었습니다. 저장 전에 확인하고 수정하세요.",
  "settings.subAgents.form.field.mode": "모드",
  "settings.subAgents.form.mode.subagent": "서브에이전트",
  "settings.subAgents.form.mode.primary": "기본",
  ...
  "settings.subAgents.hierarchy.delegates": "{{count}}개에 위임",
  "settings.subAgents.hierarchy.noDelegation": "위임할 수 없음",
  "settings.subAgents.list.tools.summary.one": "도구 {{count}}개",
  "settings.subAgents.list.tools.summary.other": "도구 {{count}}개",
  "settings.subAgents.hierarchy.noDelegates": "위임할 활성 서브에이전트가 없음",
  "settings.subAgents.hierarchy.rootDisabled": "비활성화됨: 비활성 상태에서는 아무것도 위임하지 않음",
  "settings.subAgents.hierarchy.showAll": "{{count}}개 더 보기",
  "settings.subAgents.hierarchy.showLess": "적게 보기",
  "dialog.model.manageProvider": "제공자 관리",
  ...
  "settings.modelsHub.auto.title": "자동 구성",
  "settings.modelsHub.auto.description": "각 모델의 GGUF 헤더(학습 컨텍스트, 레이어, 헤드)와 VRAM/RAM을 읽어 로드 시 컨텍스트, GPU 레이어, 스레드, 배치, KV 캐시를 정합니다. 끄면 아래 수동 값을 사용합니다.",
  "settings.modelsHub.auto.applied": "로드된 모델에 적용됨",
  "settings.modelsHub.auto.idle": "각 모델을 로드할 때 계산됩니다. ‘디스크’에서 파일별 제안을 볼 수 있습니다.",
  "settings.modelsHub.auto.manualDisabled": "자동 구성이 켜져 있는 동안 수동 값은 무시됩니다.",
  "settings.modelsHub.disk.title": "디스크의 모델",
  "settings.modelsHub.disk.description": "모델 폴더(및 이전 Tiancode 폴더)의 모든 GGUF 파일과 헤더 정보, 이 PC에 맞춘 로드 구성 제안입니다.",
  "settings.modelsHub.disk.empty": "모델 폴더에 GGUF 파일이 없습니다.",
  "settings.modelsHub.disk.activate": "활성화하고 사용",
  "settings.modelsHub.disk.active": "로드됨",
  "settings.modelsHub.disk.rescan": "다시 검색",
  "settings.modelsHub.disk.folder": "폴더",
  "settings.modelsHub.disk.trainContext": "학습 컨텍스트",
  "settings.modelsHub.disk.layers": "레이어",
  "settings.modelsHub.disk.recommended": "제안된 로드",
  "settings.modelsHub.disk.delete": "디스크에서 삭제",
  "settings.modelsHub.disk.smallModelNote": "7B 미만 모델은 도구와 긴 프롬프트에서 응답이 약한 편입니다. 코딩에는 7B 이상을 써 보세요.",
  "settings.modelsHub.placement.gpu": "모두 GPU",
  "settings.modelsHub.placement.hybrid": "GPU + RAM",
  "settings.modelsHub.placement.cpu": "CPU만",
  "settings.modelsHub.reason.fits_gpu": "모델과 캐시가 VRAM에 들어갑니다.",
  "settings.modelsHub.reason.hybrid": "VRAM에 다 들어가지 않아 일부 레이어를 RAM에 둡니다.",
  "settings.modelsHub.reason.cpu_only": "사용 가능한 GPU가 없어 CPU에서 실행합니다.",
  "settings.modelsHub.reason.kv_q8_for_context": "컨텍스트를 늘리기 위해 KV 캐시를 q8_0으로.",
  "settings.modelsHub.reason.kv_q8_for_memory": "메모리 절약을 위해 KV 캐시를 q8_0으로.",
  "settings.modelsHub.reason.ctx_train_limit": "컨텍스트는 모델 학습 한도로 제한됩니다.",
  "settings.modelsHub.reason.ctx_vram_limit": "컨텍스트는 사용 가능한 VRAM으로 제한됩니다.",
  ...
  "settings.modelsHub.auto.vram.title": "최대 VRAM 사용량",
  "settings.modelsHub.auto.vram.description": "모델과 캐시가 차지할 수 있는 GPU 메모리 비율.",
  "settings.modelsHub.auto.ram.title": "최대 RAM 사용량",
  "settings.modelsHub.auto.ram.description": "GPU에 들어가지 않는 레이어를 위한 시스템 메모리 비율.",
  "settings.modelsHub.auto.cpu.title": "CPU 사용량",
  "settings.modelsHub.auto.cpu.description": "모델에 할당하는 코어 비율.",
  "settings.modelsHub.auto.placement.title": "GPU / RAM 배치",
  "settings.modelsHub.auto.placement.description": "자동은 모델 크기로 결정하고, GPU + RAM은 항상 분할하며, CPU만은 그래픽카드를 쓰지 않습니다.",
  "settings.modelsHub.placement.auto": "자동",
  "settings.modelsHub.auto.idle.title": "유휴 시 언로드",
  "settings.modelsHub.auto.idle.description": "이 시간 동안 채팅이 모델을 쓰지 않으면 VRAM을 비우고 다음 요청 때 자동으로 다시 로드합니다(LM Studio의 JIT, Ollama의 keep_alive처럼).",
  "settings.modelsHub.auto.idle.never": "안 함(항상 로드)",
  "settings.modelsHub.auto.idle.minutes": "{{n}}분",
  "settings.modelsHub.auto.lightweight": "로컬 모델에서는 채팅이 경량 모드를 사용합니다. 간결한 프롬프트와 핵심 도구만 써서 컨텍스트에 맞고 실제로 답합니다.",
}
