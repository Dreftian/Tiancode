export const dict = {
  ...
  "settings.browser.allowControl": "Tiancode가 내장 브라우저를 제어하도록 허용",
  "settings.browser.allowControl.description": "앱과 사이트를 실시간으로 볼 수 있는 내장 브라우저를 앱에 표시합니다",
...
"settings.mcpServers.group.unknown": "알 수 없음",
  ...
  "settings.computerUse.tools.description": "Tiancode는 마우스를 움직이거나 키를 누를 수 없습니다. 스크린샷을 찍고 클립보드를 읽거나 쓸 수는 있으며, 데스크톱 앱에서만 가능합니다.",
