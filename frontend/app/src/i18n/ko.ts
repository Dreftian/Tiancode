export const dict = {
  ...
  "settings.computerUse.autoApprove": "에이전트가 앱을 제어하도록 허용",
  "settings.computerUse.autoApprove.description": "모델이 요청할 때 computer use 작업을 자동 승인합니다",
  "settings.computerUse.autoApprove.note": "앱 직접 제어는 모델 제공업체에 따라 달라집니다. Tiancode는 모델이 지원할 때 computer use 작업을 자동 승인할 수 있습니다.",
  "settings.computerUse.screenshot": "화면 캡처 포함: 화면, 창 또는 라이브 뷰를 캡처하여 대화에 첨부할 수 있습니다.",
...
"settings.mcpServers.group.unknown": "알 수 없음",
  ...
  "prompt.optimize.empty": "먼저 텍스트를 입력해 주세요",
  "prompt.optimize.optimizing": "입력 최적화 중...",
  ...
  "settings.intelligence.autoSkill": "스킬 자동 추출 (/learn)",
  "settings.intelligence.autoSkill.desc": "성공한 복잡한 워크플로를 재사용 가능한 SKILL.md 파일로 묶도록 자동 제안합니다.",
  "settings.intelligence.section.codegraph": "코드 그래프 및 AST",
  ...
  "settings.intelligence.monaco": "Monaco 차이 보기",
  "settings.intelligence.monaco.desc": "패치를 적용하기 전에 구문 강조가 적용된 나란한 비교를 보여줍니다.",
  "settings.intelligence.section.safety": "웹 및 실행 보안",
  "settings.intelligence.cleanWeb": "클린 웹 추출 (Firecrawl 엔진)",
  "settings.intelligence.cleanWeb.desc": "스크립트, 쿠키, 메뉴를 제거해 LLM에 최적화된 순수 Markdown으로 변환합니다.",
  "settings.intelligence.guardrails": "가드레일 및 비밀 정보 마스킹 파이프라인",
  "settings.intelligence.guardrails.desc": "외부 제공자에게 요청을 보내기 전에 비밀번호, 토큰, 개인 키를 마스킹합니다.",
  "settings.intelligence.sandbox": "샌드박스 실행 모드",
