...
export const dict = {
  ...
  "dialog.provider.tiancode.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.tiancode.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.tiancodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Tiancode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Tiancode zu nutzen.",
  ...
  "provider.connect.tiancodeZen.line1":
    "Tiancode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.tiancodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.tiancodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.tiancodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Tiancode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Tiancode zu nutzen.",
  ...
  "dialog.plugins.empty": "In tiancode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Tiancode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Tiancode wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Tiancode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Tiancode wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Tiancode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Tiancode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Tiancode aktualisieren",
  "wsl.onboarding.tiancodeReadyIn": "Tiancode ist in {{distro}} bereit.",
  "wsl.onboarding.tiancodeReady": "Tiancode ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Tiancode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Tiancode installieren",
  ...
  "wsl.onboarding.distroStatus.tiancodeMissing": "Tiancode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Tiancode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Tiancode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Tiancode erneut.",
  ...
  "toast.update.description": "Eine neue Version von Tiancode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Tiancode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (tiancode.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Tiancode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Tiancode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Tiancode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Tiancode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Tiancode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Tiancode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Tiancode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Tiancode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Tiancode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Tiancode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Tiancode wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "Tiancode-Menü",
  ...
  "desktop.recovery.loadFailed": "Tiancode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Tiancode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Tiancode reagiert nicht",
  ...
  "desktop.wsl.error.installTiancode": "Tiancode-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.tiancodeMissing": "tiancode ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.tiancodeCannotRun": "tiancode ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.tiancodeNotInstalled": "Tiancode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Tiancode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Tiancode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
  ...
  "a11y.closeTab": "Tab schließen",
  "a11y.clearSearch": "Suche löschen",
  "a11y.edit": "Bearbeiten",
  "chat.mic.start": "Mit Mikrofon diktieren",
  ...
  "chat.message.speak.failed": "Antwort konnte nicht vorgelesen werden",
  "preview.title": "Interner Browser",
  "preview.open": "Internen Browser öffnen",
  "preview.close": "Browser schließen",
  "preview.back": "Zurück",
  "preview.forward": "Vor",
  "preview.reload": "Neu laden",
  "preview.go": "Los",
  "preview.url": "Webadresse",
  "settings.general.row.minimizeToTray.title": "In Taskleiste minimieren",
  "settings.general.row.minimizeToTray.description": "Beim Schließen des Fensters wird die App in die Taskleiste minimiert, statt zu beenden",
  "settings.general.row.fileWatcher.title": "Echtzeit-Dateiaktualisierungen",
  "settings.general.row.fileWatcher.description": "Aktualisiert Dateibaum und Git-Änderungen automatisch.",
  "settings.general.fileWatcher.restart.confirm": "Tiancode neu starten, um die Änderung an den Echtzeit-Dateiaktualisierungen anzuwenden?",
  "session.export.button": "Konversation als Markdown exportieren",
  "session.export.title": "Konversation exportieren",
  "session.export.success": "Konversation exportiert",
  "session.export.failed": "Konversation konnte nicht exportiert werden",
  "settings.general.section.data": "Daten",
  "settings.general.row.autoBackup.title": "Automatische Sicherung",
  "settings.general.row.autoBackup.description": "Tägliche Kopie von Sitzungen und Konfiguration (behält die letzten 7 Tage)",
  "settings.general.row.backupNow.title": "Jetzt sichern",
  "settings.general.row.backupNow.description": "Erstellt eine sofortige Kopie Ihrer Daten",
  "settings.general.row.backupNow.button": "Sicherung erstellen",
  "settings.general.row.restore.title": "Wiederherstellen",
  "settings.general.row.restore.description": "Eine frühere Sicherung wiederherstellen (die App wird neu gestartet)",
  "settings.general.row.restore.button": "Wiederherstellen",
  "settings.general.backup.now.success": "Sicherung erstellt",
  "settings.general.backup.now.failed": "Noch keine Daten zum Sichern vorhanden",
  "settings.general.backup.restore.confirm": "Sicherung {name} wiederherstellen? Aktuelle Sitzungen und Konfiguration werden ersetzt.",
  "settings.general.backup.restore.success": "Sicherung wiederhergestellt",
  "settings.general.backup.restore.failed": "Sicherung konnte nicht wiederhergestellt werden",
  "settings.general.row.loginItem.title": "Beim Start ausführen",
  "settings.general.row.loginItem.description": "Tiancode automatisch öffnen, wenn Sie sich bei Windows anmelden",
  "settings.section.extensions": "Erweiterungen",
  "settings.tab.plugins": "Plugins",
  "settings.tab.skills": "Skills",
  "settings.tab.subAgents": "Sub-Agents",
  "settings.tab.mcpServers": "MCP-Server",
  "settings.tab.github": "GitHub",
  "settings.tab.voices": "Stimmen",
  "settings.skills.title": "Skills",
  "settings.skills.description": "Importieren Sie Skills von Ihrem Computer oder laden Sie veröffentlichte Skills aus dem Web herunter.",
  "settings.skills.section.installed": "Installiert",
  "settings.skills.autoSelect.title": "Skills automatisch auswählen",
  "settings.skills.autoSelect.description": "In jeder Konversation automatisch die Skills auswählen, die zu Ihrem Projekt passen (Framework, Werkzeuge usw.)",
  "settings.skills.section.import": "Skill importieren",
  "settings.skills.empty": "Noch keine Skills installiert",
  "settings.skills.import.folder.title": "Aus Ordner importieren",
  "settings.skills.import.folder.description": "Wählen Sie einen Skill-Ordner mit einer SKILL.md-Datei aus",
  "settings.skills.import.folder.button": "Ordner auswählen",
  "settings.skills.import.url.title": "Von URL herunterladen",
  "settings.skills.import.url.description": "Fügen Sie die URL eines veröffentlichten Skills ein, um ihn herunterzuladen",
  "settings.skills.import.url.placeholder": "https://example.com/skills/my-skill",
  "settings.skills.import.url.button": "Herunterladen",
  "settings.skills.search.google": "Veröffentlichte Skills bei Google suchen",
  "settings.skills.importing": "Wird importiert…",
  "settings.skills.import.success": "Skill importiert",
  "settings.skills.import.failed": "Skill konnte nicht importiert werden",
  "settings.subAgents.title": "Sub-Agents",
  "settings.subAgents.description": "Erstellen Sie eigene Sub-Agents, an die der Hauptagent Aufgaben delegieren kann.",
  "settings.subAgents.list.new": "Neuer Subagent",
  "settings.subAgents.list.search.placeholder": "Subagents suchen",
  "settings.subAgents.list.search.clear": "Suche löschen",
  "settings.subAgents.list.filter.all": "Alle",
  "settings.subAgents.list.filter.enabled": "Aktiviert",
  "settings.subAgents.list.filter.disabled": "Deaktiviert",
  "settings.subAgents.list.group.user": "Benutzer-Subagents",
  "settings.subAgents.list.group.builtin": "Integrierte Subagents",
  "settings.subAgents.list.builtin.hint": "hier nicht bearbeitbar",
  "settings.subAgents.list.empty": "Keine Subagents gefunden",
  "settings.subAgents.list.footer": "{{count}} Subagents · {{enabled}} aktiviert",
  "settings.subAgents.list.model.inherit": "erben",
  "settings.subAgents.list.tools.all": "Alle Werkzeuge",
  "settings.subAgents.list.tools.summary": "{{count}} Werkzeuge",
  "settings.subAgents.list.edit": "Subagent bearbeiten",
  "settings.subAgents.list.delete": "Subagent löschen",
  "settings.subAgents.form.new.title": "Neuer Subagent",
  "settings.subAgents.form.edit.title": "{{name}} bearbeiten",
  "settings.subAgents.form.field.name": "Name",
  "settings.subAgents.form.field.name.placeholder": "code-reviewer",
  "settings.subAgents.form.field.color": "Farbe",
  "settings.subAgents.form.color.yellow": "Gelb",
  "settings.subAgents.form.color.red": "Rot",
  "settings.subAgents.form.color.orange": "Orange",
  "settings.subAgents.form.color.green": "Grün",
  "settings.subAgents.form.color.cyan": "Cyan",
  "settings.subAgents.form.color.blue": "Blau",
  ...
  "settings.subAgents.form.model.inherit": "erben",
  "settings.subAgents.form.model.custom": "Benutzerdefiniert…",
  "settings.subAgents.form.field.description": "Beschreibung",
  "settings.subAgents.form.field.description.placeholder": "Kurze Beschreibung, die dem Modell angezeigt wird",
  "settings.subAgents.form.field.tools": "Zulässige Werkzeuge",
  "settings.subAgents.form.tools.all": "Standardmäßig alle Berechtigungen",
  "settings.subAgents.form.tools.custom": "Benutzerdefinierte zulässige Werkzeuge",
  "settings.subAgents.form.tools.sensitive": "sensibel",
  "settings.subAgents.form.tools.read": "Lesen",
  "settings.subAgents.form.tools.grep": "Grep",
  "settings.subAgents.form.tools.glob": "Glob",
  "settings.subAgents.form.tools.bash": "Bash",
  "settings.subAgents.form.tools.edit": "Bearbeiten",
  "settings.subAgents.form.tools.write": "Schreiben",
  ...
  "settings.subAgents.form.field.prompt.placeholder": "Beschreiben Sie die Rolle und die Regeln dieses Subagents…",
  "settings.subAgents.form.field.injectAgentsMd": "AGENTS.md einfügen",
  "settings.subAgents.form.field.injectAgentsMd.description": "Die AGENTS.md-Datei des Arbeitsbereichs in den Kontext dieses Subagents aufnehmen",
  "settings.subAgents.form.workspace.unsupported": "Erstellung oder Bearbeitung auf Arbeitsbereichsebene wird nicht unterstützt",
  "settings.subAgents.form.save": "Speichern",
  "settings.subAgents.form.saving": "Wird gespeichert…",
  "settings.subAgents.form.cancel": "Abbrechen",
  "settings.subAgents.form.delete": "Löschen",
  "settings.subAgents.form.delete.confirm": "Subagent \"{{name}}\" löschen?",
  "settings.subAgents.form.success": "Subagent erstellt",
  "settings.subAgents.form.failed": "Subagent konnte nicht erstellt werden",
  "settings.subAgents.form.updated": "Subagent aktualisiert",
  "settings.subAgents.form.updateFailed": "Subagent konnte nicht aktualisiert werden",
  "settings.subAgents.form.deleted": "Subagent gelöscht",
  "settings.subAgents.form.deleteFailed": "Subagent konnte nicht gelöscht werden",
  "settings.subAgents.native.build": "Der Standardagent. Führt Werkzeuge basierend auf den konfigurierten Berechtigungen aus.",
  "settings.subAgents.native.plan": "Planmodus. Verhindert alle Bearbeitungswerkzeuge.",
  "settings.subAgents.native.general": "Allzweck-Agent zum Recherchieren komplexer Fragen und Ausführen mehrstufiger Aufgaben.",
  "settings.subAgents.native.explore": "Schneller Agent, spezialisiert auf das Durchsuchen von Codebasen und das Auffinden von Dateien.",
  "settings.subAgents.native.compaction": "Interner Agent zum Komprimieren des Sitzungsverlaufs.",
  "settings.subAgents.native.title": "Interner Agent zum Generieren von Konversationstiteln.",
  "settings.subAgents.native.summary": "Interner Agent zum Zusammenfassen von Sitzungen.",
  "settings.plugins.title": "Plugins",
  "settings.plugins.description": "Erweitern Sie den Agenten mit npm-Paketen oder lokalen Plugin-Dateien, die in Lebenszyklus-Ereignisse eingreifen.",
  "settings.plugins.note.title": "Was ist ein Plugin?",
  "settings.plugins.note.description": "Plugins laufen im Agentenprozess und reagieren auf Lebenszyklus-Ereignisse wie Sitzungs-Leerlauf, Werkzeugausführung und Einrichtung der Shell-Umgebung.",
  "settings.plugins.section.installed": "Installiert",
  "settings.plugins.section.add": "Plugin hinzufügen",
  "settings.plugins.empty": "Noch keine Plugins installiert",
  "settings.plugins.add.label": "Paket oder lokale Datei",
  "settings.plugins.add.placeholder": "opencode-wakatime, @my-org/custom-plugin oder ./plugins/my-plugin.ts",
  "settings.plugins.add.button": "Hinzufügen",
  "settings.plugins.add.success": "Plugin hinzugefügt",
  "settings.plugins.add.failed": "Plugin konnte nicht hinzugefügt werden",
  "settings.plugins.remove": "Entfernen",
  "settings.plugins.remove.confirm": "Plugin \"{{name}}\" entfernen?",
  "settings.plugins.remove.success": "Plugin entfernt",
  "settings.plugins.remove.failed": "Plugin konnte nicht entfernt werden",
  "settings.plugins.origin.npm": "npm · erfordert Tian-Konvention",
  "settings.plugins.origin.local": "lokal",
  "settings.plugins.catalog.npm.title": "Beliebte npm-Apps",
  "settings.plugins.catalog.npm.description": "Verifizierte Pakete, die Tians Plugin-Konvention folgen.",
  "settings.plugins.catalog.npm.note": "npm-Pakete müssen Tians Plugin-Konvention implementieren",
  "settings.plugins.catalog.local.title": "Lokale Plugins",
  "settings.plugins.catalog.local.description": "Plugins, die mit diesem Repository unter .tiancode/plugins ausgeliefert werden.",
  "settings.plugins.catalog.add": "Hinzufügen",
  "settings.plugins.catalog.installed": "Installiert",
  "settings.plugins.catalog.npm.biome.description": "Schneller Linter und Formatierer für JavaScript und TypeScript.",
  "settings.plugins.catalog.npm.playwrightMcp.description": "Browserautomatisierung und E2E-Tests für Webanwendungen.",
  "settings.plugins.catalog.npm.octokitRest.description": "GitHub-API-Client für Pull Requests, Issues und Repositorys.",
  "settings.plugins.catalog.npm.slackWebApi.description": "Offizieller Slack-Web-API-Client für Nachrichten und Konversationen.",
  "settings.plugins.catalog.npm.notionClient.description": "Offizieller Notion-API-Client für Seiten, Datenbanken und Blöcke.",
  "settings.plugins.catalog.npm.sentryCli.description": "Sentry-Fehlerüberwachung, Releases und Source-Map-Uploads.",
  "settings.plugins.catalog.npm.agentNotify.description": "Sendet Benachrichtigungen, wenn Agentenaufgaben abgeschlossen werden oder fehlschlagen.",
  "settings.plugins.catalog.npm.chimeClaude.description": "Telegram-Benachrichtigungen für Ereignisse im Agenten-Lebenszyklus.",
  "settings.plugins.catalog.local.envGuard.description": "Schützt .env-Dateien vor versehentlichen Änderungen.",
  "settings.plugins.catalog.local.commitHelper.description": "Hilft beim Erstellen konventioneller Commit-Nachrichten.",
  "settings.plugins.catalog.local.notifyIdle.description": "Benachrichtigt Sie, wenn eine Sitzung in den Leerlauf übergeht.",
  "settings.plugins.catalog.local.shellEnv.description": "Fügt Umgebungsvariablen in Shell-Werkzeugprozesse ein.",
  "settings.plugins.catalog.local.permissionGuard.description": "Blockiert riskante Werkzeugaufrufe, die eine ausdrückliche Genehmigung erfordern.",
  "settings.plugins.template.title": "Neues Plugin",
  "settings.plugins.template.description": "Generiert ein Plugin-Gerüst mit den häufigsten Lebenszyklus-Hooks. Kopieren Sie es in eine Datei und fügen Sie es oben hinzu.",
  "settings.plugins.template.copy": "Kopieren",
  "settings.plugins.template.copied": "Vorlage in die Zwischenablage kopiert",
  "settings.mcpServers.title": "MCP-Server",
  "settings.mcpServers.description": "Verbinden Sie den Agenten über Model Context Protocol (MCP)-Server mit externen Werkzeugen.",
  "settings.mcpServers.section.servers": "Server",
  "settings.mcpServers.section.add": "Server hinzufügen",
  "settings.mcpServers.edit.title": "Server bearbeiten",
  "settings.mcpServers.empty": "Noch keine MCP-Server konfiguriert",
  "settings.mcpServers.add.button": "Server hinzufügen",
  "settings.mcpServers.save.button": "Speichern",
  "settings.mcpServers.cancel.button": "Abbrechen",
  "settings.mcpServers.saving": "Wird gespeichert…",
  ...
  "settings.mcpServers.field.command": "Befehl",
  "settings.mcpServers.field.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem /path",
  "settings.mcpServers.field.command.hint": "Tipp: npx, uvx, node oder unter Windows cmd /c npx",
  "settings.mcpServers.field.environment": "Umgebung (KEY=VALUE pro Zeile)",
  "settings.mcpServers.field.environment.placeholder": "API_KEY=sk-...",
  "settings.mcpServers.field.cwd": "Arbeitsverzeichnis (optional)",
  "settings.mcpServers.field.timeout": "Zeitüberschreitung in Sekunden (optional)",
  "settings.mcpServers.field.url": "URL",
  "settings.mcpServers.field.url.placeholder": "https://example.com/mcp",
  "settings.mcpServers.field.headers": "Header (KEY=VALUE pro Zeile)",
  "settings.mcpServers.field.oauth": "OAuth",
  "settings.mcpServers.presets.title": "Voreinstellungen",
  "settings.mcpServers.presets.filesystem": "Dateisystem",
  "settings.mcpServers.presets.fetch": "Fetch",
  "settings.mcpServers.presets.memory": "Speicher",
  "settings.mcpServers.presets.sequentialThinking": "Sequential Thinking",
  "settings.mcpServers.presets.time": "Zeit",
  ...
  "settings.mcpServers.status.connected": "Verbunden",
  "settings.mcpServers.status.disabled": "Deaktiviert",
  "settings.mcpServers.status.failed": "Fehler",
  "settings.mcpServers.status.needs_auth": "Authentifizierung erforderlich",
  "settings.mcpServers.status.needs_client_registration": "Registrierung erforderlich",
  "settings.mcpServers.status.unknown": "Unbekannt",
  "settings.mcpServers.action.connect": "Verbinden",
  "settings.mcpServers.action.disconnect": "Trennen",
  "settings.mcpServers.action.edit": "Bearbeiten",
  "settings.mcpServers.action.export": "Exportieren",
  "settings.mcpServers.action.remove": "Entfernen",
  "settings.mcpServers.remove.confirm": "Server \"{{name}}\" entfernen?",
  "settings.mcpServers.add.success": "Server gespeichert",
  "settings.mcpServers.add.failed": "Server konnte nicht gespeichert werden",
  "settings.mcpServers.export.success": "Konfiguration in die Zwischenablage kopiert",
  "settings.mcpServers.export.failed": "Konfiguration konnte nicht kopiert werden",
  "settings.mcpServers.search.placeholder": "Server suchen…",
  "settings.mcpServers.search.empty": "Keine Server entsprechen Ihrer Suche",
  "settings.mcpServers.group.connected": "Verbunden",
  "settings.mcpServers.group.errors": "Fehler",
  "settings.mcpServers.group.disabled": "Deaktiviert",
  "settings.mcpServers.group.unknown": "Unbekannt",
  "settings.mcpServers.tools.count": "{{count}} Werkzeuge",
  "settings.mcpServers.save.changes": "Änderungen speichern",
  "settings.mcpServers.discover.title": "Entdecken",
  "settings.mcpServers.discover.description": "Beliebte MCP-Server, die Sie mit einem Klick hinzufügen können.",
  "settings.mcpServers.discover.requiresKey": "Erfordert API-Schlüssel – nach dem Hinzufügen bearbeiten",
  "settings.mcpServers.discover.presets.android-emulator.name": "Android Emulator",
  "settings.mcpServers.discover.presets.android-emulator.description": "Steuern Sie Android-Emulatoren, -Bildschirme und -Apps vom Agenten aus.",
  "settings.mcpServers.discover.presets.node-repl.name": "Node REPL",
  "settings.mcpServers.discover.presets.node-repl.description": "Führen Sie JavaScript in einer Node.js-REPL-Sitzung aus.",
  "settings.mcpServers.discover.presets.ios-simulator.name": "iOS Simulator",
  "settings.mcpServers.discover.presets.ios-simulator.description": "Steuern Sie den iOS-Simulator und seine Apps (Xcode erforderlich).",
  "settings.mcpServers.discover.presets.chrome-devtools.name": "Chrome DevTools",
  "settings.mcpServers.discover.presets.chrome-devtools.description": "Chrome-Seiten untersuchen, debuggen und automatisieren.",
  "settings.mcpServers.discover.presets.playwright.name": "Playwright",
  "settings.mcpServers.discover.presets.playwright.description": "Browserautomatisierung und End-to-End-Webtests.",
  "settings.mcpServers.discover.presets.context7.name": "Context7",
  "settings.mcpServers.discover.presets.context7.description": "Aktuelle Dokumentation für beliebte Bibliotheken und Frameworks.",
  "settings.mcpServers.discover.presets.agent-vision.name": "Agent Vision",
  "settings.mcpServers.discover.presets.agent-vision.description": "Gibt Modellen ohne Bildverständnis Augen: Analysiert Bilder, Screenshots und Dokumente (OCR) mit jeder OpenAI-kompatiblen Vision-API (OpenAI, Gemini, Qwen-VL). Nach dem Aktivieren fügen Sie VISION_API_KEY unter Umgebung im Server-Editor hinzu.",
  "capture.menu.title": "Screenshot aufnehmen",
  "capture.screen": "Vollbild",
  "capture.window": "App-Fenster",
  "capture.area": "Bereich auswählen…",
  "capture.preview": "Interner Browser",
  "capture.area.title": "Wählen Sie den aufzunehmenden Bereich aus (Enter zum Bestätigen, Esc zum Abbrechen)",
  "capture.area.cancel": "Abbrechen",
  "capture.area.confirm": "Bereich aufnehmen",
  "settings.mcpServers.discover.presets.aikido.name": "Aikido",
  "settings.mcpServers.discover.presets.aikido.description": "Code und Abhängigkeiten auf Sicherheitsprobleme scannen.",
  "settings.mcpServers.discover.presets.airwallex.name": "Airwallex",
  "settings.mcpServers.discover.presets.airwallex.description": "APIs für Zahlungen, Treasury und Kartenservices.",
  "settings.mcpServers.discover.presets.canva.name": "Canva",
  "settings.mcpServers.discover.presets.canva.description": "Canva-Designs erstellen und bearbeiten (OAuth).",
  "settings.mcpServers.discover.presets.circle.name": "Circle",
  "settings.mcpServers.discover.presets.circle.description": "USDC-Zahlungen und entwicklerverwaltete Wallets.",
  "settings.mcpServers.discover.presets.appwrite.name": "Appwrite",
  "settings.mcpServers.discover.presets.appwrite.description": "Authentifizierung, Datenbanken und Speicher für Ihre Apps (OAuth).",
  "settings.mcpServers.discover.presets.apollo.name": "Apollo",
  "settings.mcpServers.discover.presets.apollo.description": "Fragen Sie Ihren Apollo-GraphOS-Graph ab (OAuth).",
  "settings.mcpServers.discover.presets.graphos-tools.name": "GraphOS Tools",
  "settings.mcpServers.discover.presets.graphos-tools.description": "Apollo-GraphOS-Arbeitsbereiche und -Schemata verwalten.",
  "settings.mcpServers.discover.presets.atlan.name": "Atlan",
  "settings.mcpServers.discover.presets.atlan.description": "Durchsuchen Sie Ihren Datenkatalog und Governance-Assets (OAuth).",
  "settings.mcpServers.discover.presets.awsknowledge.name": "AWS Knowledge",
  "settings.mcpServers.discover.presets.awsknowledge.description": "AWS-Servicedokumentation und Wissensdatenbank.",
  "settings.github.title": "GitHub",
  "settings.github.description": "Verbinden Sie Ihr GitHub-Konto, um Repositorys zu klonen, neue zu erstellen und Git-Operationen in Ihren Projekten auszuführen.",
  "settings.github.loading": "Wird geladen…",
  "settings.github.connect.title": "GitHub verbinden",
  "settings.github.connect.description": "Fügen Sie ein persönliches Zugriffstoken ein, um sich bei GitHub zu authentifizieren. Das Token wird lokal gespeichert und zum Klonen und für authentifizierte Git-Operationen verwendet.",
  "settings.github.connect.token.placeholder": "github_pat_... oder ghp_...",
  "settings.github.connect.hint": "Erstellen Sie ein Token unter github.com/settings/tokens (fein abgestuft mit Repository-Bereich)",
  "settings.github.connect.button": "Verbinden",
  "settings.github.connecting": "Wird verbunden…",
  "settings.github.connect.success": "GitHub-Konto verbunden",
  "settings.github.connect.failed": "GitHub konnte nicht verbunden werden. Überprüfen Sie Ihr Token und versuchen Sie es erneut.",
  "settings.github.connected.title": "Verbunden als",
  "settings.github.disconnect.button": "Trennen",
  "settings.github.disconnect.confirm": "GitHub-Konto trennen? Das gespeicherte Token wird entfernt.",
  "settings.github.disconnect.success": "GitHub-Konto getrennt",
  "settings.github.disconnect.failed": "GitHub konnte nicht getrennt werden",
  "settings.github.refresh": "Aktualisieren",
  "settings.github.repos.title": "Repositorys",
  "settings.github.repos.search.placeholder": "Ihre Repositorys durchsuchen…",
  "settings.github.repos.empty": "Keine Repositorys gefunden",
  "settings.github.repo.private": "Privat",
  "settings.github.repo.public": "Öffentlich",
  "settings.github.repo.clone": "Klonen",
  "settings.github.repo.cloning": "Wird geklont…",
  "settings.github.repo.clone.success": "Nach {{directory}} geklont",
  "settings.github.repo.clone.failed": "Repository konnte nicht geklont werden",
  "settings.github.create.title": "Repository erstellen",
  ...
  "settings.github.create.button": "Erstellen",
  "settings.github.create.success": "Repository erstellt",
  "settings.github.create.failed": "Repository konnte nicht erstellt werden",
  "settings.github.project.title": "Aktuelles Projekt",
  "settings.github.project.noRemote": "Dieses Projekt hat noch kein Git-Remote – erstellen Sie ein Repository auf GitHub und fügen Sie das Remote hinzu.",
  "settings.github.commit.placeholder": "Commit-Nachricht…",
  "settings.github.commit.button": "Committen",
  "settings.github.commit.success": "Commit erstellt",
  "settings.github.commit.failed": "Commit fehlgeschlagen",
  "settings.github.push.button": "Pushen",
  "settings.github.push.success": "Gepusht",
  "settings.github.push.failed": "Push fehlgeschlagen",
  "settings.github.pull.button": "Pullen",
  "settings.github.pull.success": "Gepullt",
  "settings.github.pull.failed": "Pull fehlgeschlagen",
  "settings.voices.title": "Stimmen",
  "settings.voices.description": "Wählen Sie eine Stimme zum Vorlesen der Antworten des Assistenten und testen Sie das kostenlose Sprachmodell.",
  "settings.voices.desktopOnly": "Stimmen sind in der Desktop-App verfügbar.",
  "settings.voices.loading": "Wird geladen…",
  "settings.voices.download.title": "Sprachmodell nicht installiert",
  "settings.voices.download.description": "Laden Sie das kostenlose Kokoro-Sprachmodell (~325 MB) herunter, um Sprache auf Ihrem Computer zu synthetisieren. Stimmen verlassen niemals Ihr Gerät.",
  "settings.voices.download.button": "Sprachmodell herunterladen",
  "settings.voices.download.downloading": "Sprachmodell wird heruntergeladen…",
  "settings.voices.download.progress": "{{file}} wird heruntergeladen",
  "settings.voices.download.failed": "Sprachmodell konnte nicht heruntergeladen werden",
  "settings.voices.ready.title": "Stimme auswählen",
  "settings.voices.voices.empty": "Keine Stimmen verfügbar",
  "settings.voices.voice.probe": "Testen",
  "settings.voices.voice.speaking": "Stoppen",
  "settings.voices.voice.probe.failed": "Diese Stimme konnte nicht abgespielt werden",
  "settings.voices.voice.unsupported": "Nur Englisch",
  "settings.voices.select.title": "Aktive Stimme",
  "settings.voices.autoSpeak.title": "Antworten vorlesen",
  "settings.voices.autoSpeak.description": "Liest die Antwort des Modells in Echtzeit vor, während sie generiert wird, mit der ausgewählten Stimme.",
  "settings.voices.gender.female": "Weiblich",
  "settings.voices.gender.male": "Männlich",
  "settings.voices.filter.all": "Alle",
  "settings.voices.filter.female": "Weiblich",
  "settings.voices.filter.male": "Männlich",
  "settings.voices.filter.spanish": "Spanisch",
  "settings.voices.pagination.prev": "Zurück",
  "settings.voices.pagination.next": "Weiter",
  "settings.voices.pagination.page": "Seite {{current}} von {{total}}",
  "settings.voices.voice.info": "Stimmdetails",
  "settings.voices.voice.download": "Herunterladen",
  "settings.voices.voice.downloading": "Wird heruntergeladen…",
  "settings.voices.voice.delete": "Löschen",
  "settings.voices.voice.delete.confirm": "Die heruntergeladenen Dateien für {{name}} löschen?",
  "settings.voices.voice.builtin": "Integriert",
  "settings.voices.voice.engine.kokoro": "Kokoro",
  "settings.voices.voice.engine.piper": "Piper",
  "settings.voices.voice.license": "Lizenz",
  "settings.voices.voice.enabled": "Aktiviert",
  "settings.voices.voice.size": "{{size}} MB",
  "settings.voices.voice.download.success": "Stimme heruntergeladen",
  "settings.voices.voice.download.failed": "Stimme konnte nicht heruntergeladen werden",
  "settings.voices.voice.delete.success": "Stimme gelöscht",
  "settings.voices.voice.delete.failed": "Stimme konnte nicht gelöscht werden",
  "settings.tab.modelsHub": "Lokale Modelle",
  "settings.modelsHub.title": "Lokale Modelle",
  "settings.modelsHub.description": "Suchen und laden Sie GGUF-Modelle von HuggingFace herunter, um KI lokal auszuführen, wie LM Studio.",
  "settings.modelsHub.search.placeholder": "Modelle suchen… z. B. llama 3.2",
  "settings.modelsHub.search.button": "Suchen",
  "settings.modelsHub.empty": "Keine Modelle gefunden. Versuchen Sie eine andere Suche.",
  "settings.modelsHub.download": "Herunterladen",
  "settings.modelsHub.download.downloading": "Wird heruntergeladen",
  "settings.modelsHub.download.paused": "Pausiert",
  "settings.modelsHub.download.resume": "Fortsetzen",
  "settings.modelsHub.download.delete": "Löschen",
  "settings.modelsHub.download.completed": "Abgeschlossen",
  "settings.modelsHub.download.failed": "Fehlgeschlagen",
  "settings.modelsHub.downloads.title": "Downloads",
  "settings.modelsHub.recommended": "Empfohlen",
  "settings.modelsHub.detail.files": "Dateien",
  "settings.modelsHub.runtime.title": "Laufzeit",
  "settings.modelsHub.runtime.description": "Lokale Inferenzlaufzeiten, die auf diesem Rechner erkannt wurden.",
  "settings.modelsHub.runtime.available": "Verfügbar",
  "settings.modelsHub.runtime.notDetected": "Nicht erkannt",
  "settings.modelsHub.provider.setup": "Als Anbieter einrichten",
  "settings.modelsHub.provider.ready": "Lokaler Anbieter bereit (Modell: {name})",
  "settings.modelsHub.provider.failed": "Lokaler Anbieter konnte nicht eingerichtet werden",
  "settings.modelsHub.recommended.title": "Empfohlenes Modell für Ihre GPU",
  "settings.modelsHub.recommended.forYourGpu": "basierend auf Ihrem erkannten VRAM",
  "settings.modelsHub.recommended.download": "Herunterladen",
  "settings.modelsHub.runtime.hint": "Führen Sie lokale Modelle über Ollama oder LM Studio aus und fügen Sie sie in den Einstellungen als Anbieter hinzu.",
  "settings.modelsHub.runtime.install": "Installieren",
  "settings.modelsHub.runtime.install.downloading": "Wird heruntergeladen",
  "settings.modelsHub.runtime.install.installing": "Wird installiert…",
  "settings.modelsHub.runtime.install.success": "{{name}} installiert. Öffnen Sie die App einmal, um die Einrichtung abzuschließen.",
  "settings.modelsHub.runtime.install.failed": "Laufzeit konnte nicht installiert werden",
  "settings.modelsHub.system.ram": "RAM",
  "settings.modelsHub.system.vram": "GPU-Speicher (VRAM)",
  "settings.modelsHub.system.vramFree": "frei:",
  "settings.modelsHub.memory.title": "Speichermodus",
  "settings.modelsHub.memory.gpu": "GPU-Speicher (VRAM) primär verwenden",
  "settings.modelsHub.memory.ram": "System-RAM als Fallback verwenden",
  "settings.modelsHub.system.dir": "Modellordner",
  "settings.modelsHub.system.disk": "Freier Speicherplatz",
  "settings.modelsHub.system.gpu": "GPU",
  "settings.modelsHub.system.cpu": "CPU",
  "settings.modelsHub.fit.fullGpu": "Voller GPU-Offload möglich",
  "settings.modelsHub.fit.partialGpu": "Teilweiser GPU-Offload möglich",
  "settings.modelsHub.fit.ramOnly": "Passt ohne GPU",
  "settings.modelsHub.fit.noFit": "Passt nicht",
  "settings.modelsHub.desc.text-generation": "Textgenerierung",
  "settings.modelsHub.desc.image-text-to-text": "Bildverständnis",
  "settings.modelsHub.desc.text-to-image": "Bildgenerierung",
  "settings.modelsHub.desc.image-to-image": "Bildbearbeitung",
  "settings.modelsHub.desc.image-classification": "Bildklassifizierung",
  "settings.modelsHub.desc.token-classification": "Token-Klassifizierung",
  "settings.modelsHub.desc.text-classification": "Textklassifizierung",
  "settings.modelsHub.desc.question-answering": "Fragebeantwortung",
  "settings.modelsHub.desc.summarization": "Zusammenfassung",
  "settings.modelsHub.desc.translation": "Übersetzung",
  "settings.modelsHub.desc.fill-mask": "Fill-Mask",
  "settings.modelsHub.desc.feature-extraction": "Merkmalsextraktion",
  "settings.modelsHub.desc.automatic-speech-recognition": "Spracherkennung",
  "settings.modelsHub.desc.text-to-speech": "Text zu Sprache",
  "settings.modelsHub.desc.depth-estimation": "Tiefenschätzung",
  "settings.modelsHub.desc.image-segmentation": "Bildsegmentierung",
  "settings.modelsHub.desc.object-detection": "Objekterkennung",
  ...
  "settings.modelsHub.desc.hint.code": "Programmieren",
  "settings.modelsHub.desc.hint.reasoning": "Reasoning",
  "settings.modelsHub.desc.hint.quantized": "Quantisiert",
  "onboarding.title": "Willkommen bei Tiancode",
  "onboarding.step": "Schritt {{current}} von {{total}}",
  "onboarding.disclaimer.p1": "Tiancode ist ein KI-Agent, der an Ihrer Seite arbeitet: Er kann Befehle ausführen, Dateien bearbeiten und Aufgaben auf Ihrem Computer verwalten, während Sie die Kontrolle behalten.",
  "onboarding.disclaimer.p2": "Ihre Eingaben und Dateiinhalte können an die von Ihnen konfigurierten KI-Modellanbieter gesendet werden, um Antworten zu generieren.",
  "onboarding.disclaimer.p3": "Sie sind für Ihre Nutzung von Tiancode verantwortlich. Prüfen Sie Änderungen sorgfältig, bevor Sie sie übernehmen, und führen Sie niemals Befehle aus, die Sie nicht verstehen.",
  "onboarding.accept": "Akzeptieren & Fortfahren",
  "onboarding.preferences.title": "Machen Sie es sich zu eigen",
  "onboarding.preferences.description": "Wählen Sie, wie Tiancode aussieht und mit Ihnen spricht. Sie können dies jederzeit in den Einstellungen ändern.",
  "onboarding.theme.title": "Darstellung",
  "onboarding.theme.light": "Hell",
  "onboarding.theme.dark": "Dunkel",
  "onboarding.language.title": "Sprache",
  "onboarding.language.english": "Englisch",
  "onboarding.language.spanish": "Español",
  "onboarding.start": "Tiancode verwenden",
