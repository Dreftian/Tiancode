export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Tiancode",
  ...
  "desktop.recovery.loadFailed": "Tiancode gagal dimuat",
  "desktop.recovery.terminated": "Jendela Tiancode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Tiancode tidak merespons",
  ...
  "desktop.wsl.error.installTiancode": "Instalasi Tiancode gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.tiancodeMissing": "tiancode belum terinstal di distro ini",
  "desktop.wsl.error.tiancodeCannotRun": "tiancode telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.tiancodeNotInstalled": "Tiancode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Tiancode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.tiancode.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.tiancode.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.tiancodeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Tiancode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Tiancode.",
  ...
  "provider.connect.tiancodeZen.line1":
    "Tiancode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.tiancodeZen.visit.prefix": "Kunjungi ",
  "provider.connect.tiancodeZen.visit.link": "opencode.ai/zen",
  "provider.connect.tiancodeZen.visit.suffix": " untuk mendapatkan kunci API Anda.",
  "provider.connect.oauth.code.visit.prefix": "Kunjungi ",
  "provider.connect.oauth.code.visit.link": "tautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Tiancode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Tiancode.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di tiancode.json",
  ...
  "dialog.server.description": "Ganti server Tiancode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Tiancode...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Tiancode di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Tiancode...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Tiancode di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Tiancode di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Tiancode",
  "wsl.onboarding.tiancodeReadyIn": "Tiancode siap di {{distro}}.",
  "wsl.onboarding.tiancodeReady": "Tiancode siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Tiancode di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Tiancode",
  ...
  "wsl.onboarding.distroStatus.tiancodeMissing": "Tiancode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Tiancode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Tiancode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Tiancode.",
  ...
  "help.tabs.introduction": "Tiancode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Tiancode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Tiancode",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (tiancode.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Tiancode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Tiancode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Tiancode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Tiancode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Tiancode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Tiancode mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Tiancode.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Tiancode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Tiancode.",
  ...
  "a11y.closeTab": "Tutup tab",
  "a11y.clearSearch": "Bersihkan pencarian",
  "a11y.edit": "Sunting",
  "chat.mic.start": "Dikte dengan mikrofon",
  ...
  "chat.message.speak.failed": "Gagal membacakan respons dengan lantang",
  "preview.title": "Peramban internal",
  "preview.open": "Buka peramban internal",
  "preview.close": "Tutup peramban",
  "preview.back": "Kembali",
  "preview.forward": "Maju",
  "preview.reload": "Muat ulang",
  "preview.go": "Buka",
  "preview.url": "Alamat web",
  "settings.general.row.minimizeToTray.title": "Minimalkan ke baki sistem",
  "settings.general.row.minimizeToTray.description": "Menutup jendela akan meminimalkan ke baki sistem, bukan keluar",
  "settings.general.row.fileWatcher.title": "Pembaruan file real-time",
  "settings.general.row.fileWatcher.description": "Menyegarkan pohon file dan perubahan git secara otomatis.",
  "settings.general.fileWatcher.restart.confirm": "Mulai ulang Tiancode untuk menerapkan perubahan pembaruan file real-time?",
  "session.export.button": "Ekspor percakapan ke Markdown",
  "session.export.title": "Ekspor percakapan",
  "session.export.success": "Percakapan diekspor",
  "session.export.failed": "Tidak dapat mengekspor percakapan",
  "settings.general.section.data": "Data",
  "settings.general.row.autoBackup.title": "Cadangan otomatis",
  "settings.general.row.autoBackup.description": "Salinan harian sesi dan konfigurasi (menyimpan 7 hari terakhir)",
  "settings.general.row.backupNow.title": "Cadangkan sekarang",
  "settings.general.row.backupNow.description": "Buat salinan langsung data Anda",
  "settings.general.row.backupNow.button": "Buat cadangan",
  "settings.general.row.restore.title": "Pulihkan",
  "settings.general.row.restore.description": "Pulihkan cadangan sebelumnya (aplikasi dimulai ulang)",
  "settings.general.row.restore.button": "Pulihkan",
  "settings.general.backup.now.success": "Cadangan dibuat",
  "settings.general.backup.now.failed": "Belum ada data untuk dicadangkan",
  "settings.general.backup.restore.confirm": "Pulihkan cadangan {name}? Sesi dan konfigurasi saat ini akan diganti.",
  "settings.general.backup.restore.success": "Cadangan dipulihkan",
  "settings.general.backup.restore.failed": "Tidak dapat memulihkan cadangan",
  "settings.general.row.loginItem.title": "Luncurkan saat startup",
  "settings.general.row.loginItem.description": "Buka Tiancode secara otomatis saat Anda masuk ke Windows",
  "settings.section.extensions": "Ekstensi",
  "settings.tab.plugins": "Plugin",
  "settings.tab.skills": "Keahlian",
  "settings.tab.subAgents": "Sub-Agen",
  "settings.tab.mcpServers": "Server MCP",
  "settings.tab.github": "Github",
  "settings.tab.voices": "Suara",
  "settings.skills.title": "Keahlian",
  "settings.skills.description": "Impor keahlian dari komputer Anda atau unduh keahlian yang dipublikasikan dari web.",
  "settings.skills.section.installed": "Terpasang",
  "settings.skills.autoSelect.title": "Pilih keahlian otomatis",
  "settings.skills.autoSelect.description": "Pilih keahlian yang cocok dengan proyek Anda (kerangka kerja, perangkat, dll.) di setiap percakapan secara otomatis",
  "settings.skills.section.import": "Impor keahlian",
  "settings.skills.empty": "Belum ada keahlian terpasang",
  "settings.skills.import.folder.title": "Impor dari folder",
  "settings.skills.import.folder.description": "Pilih folder keahlian yang berisi file SKILL.md",
  "settings.skills.import.folder.button": "Pilih folder",
  "settings.skills.import.url.title": "Unduh dari URL",
  "settings.skills.import.url.description": "Tempel URL keahlian yang dipublikasikan untuk mengunduhnya",
  "settings.skills.import.url.placeholder": "https://example.com/skills/my-skill",
  "settings.skills.import.url.button": "Unduh",
  "settings.skills.search.google": "Cari keahlian yang dipublikasikan di Google",
  "settings.skills.importing": "Mengimpor...",
  "settings.skills.import.success": "Keahlian diimpor",
  "settings.skills.import.failed": "Gagal mengimpor keahlian",
  "settings.subAgents.title": "Sub-Agen",
  "settings.subAgents.description": "Buat sub-agen Anda sendiri yang dapat didelegasikan oleh agen utama.",
  "settings.subAgents.list.new": "Sub-agen baru",
  "settings.subAgents.list.search.placeholder": "Cari sub-agen",
  "settings.subAgents.list.search.clear": "Bersihkan pencarian",
  "settings.subAgents.list.filter.all": "Semua",
  "settings.subAgents.list.filter.enabled": "Aktif",
  "settings.subAgents.list.filter.disabled": "Nonaktif",
  "settings.subAgents.list.group.user": "Sub-agen pengguna",
  "settings.subAgents.list.group.builtin": "Sub-agen bawaan",
  "settings.subAgents.list.builtin.hint": "tidak dapat disunting di sini",
  "settings.subAgents.list.empty": "Tidak ada sub-agen ditemukan",
  "settings.subAgents.list.footer": "{{count}} sub-agen · {{enabled}} aktif",
  "settings.subAgents.list.model.inherit": "warisi",
  "settings.subAgents.list.tools.all": "Semua alat",
  "settings.subAgents.list.tools.summary": "{{count}} alat",
  "settings.subAgents.list.edit": "Sunting sub-agen",
  "settings.subAgents.list.delete": "Hapus sub-agen",
  "settings.subAgents.form.new.title": "Sub-agen baru",
  "settings.subAgents.form.edit.title": "Sunting {{name}}",
  "settings.subAgents.form.field.name": "Nama",
  "settings.subAgents.form.field.name.placeholder": "code-reviewer",
  "settings.subAgents.form.field.color": "Warna",
  "settings.subAgents.form.color.yellow": "Kuning",
  "settings.subAgents.form.color.red": "Merah",
  "settings.subAgents.form.color.orange": "Oranye",
  "settings.subAgents.form.color.green": "Hijau",
  "settings.subAgents.form.color.cyan": "Cyan",
  "settings.subAgents.form.color.blue": "Biru",
  "settings.subAgents.form.color.purple": "Ungu",
  "settings.subAgents.form.color.pink": "Merah muda",
  "settings.subAgents.form.field.model": "Model",
  "settings.subAgents.form.field.model.placeholder": "provider/model",
  "settings.subAgents.form.model.inherit": "warisi",
  "settings.subAgents.form.model.custom": "Kustom...",
  "settings.subAgents.form.field.description": "Deskripsi",
  "settings.subAgents.form.field.description.placeholder": "Deskripsi singkat yang ditampilkan ke model",
  "settings.subAgents.form.field.tools": "Alat yang diizinkan",
  "settings.subAgents.form.tools.all": "Semua izin default",
  "settings.subAgents.form.tools.custom": "Alat yang diizinkan kustom",
  "settings.subAgents.form.tools.sensitive": "sensitif",
  "settings.subAgents.form.tools.read": "Baca",
  "settings.subAgents.form.tools.grep": "Grep",
  "settings.subAgents.form.tools.glob": "Glob",
  "settings.subAgents.form.tools.bash": "Bash",
  "settings.subAgents.form.tools.edit": "Sunting",
  "settings.subAgents.form.tools.write": "Tulis",
  ...
  "settings.subAgents.form.field.prompt": "Prompt sistem",
  "settings.subAgents.form.field.prompt.placeholder": "Jelaskan peran dan aturan sub-agen ini...",
  "settings.subAgents.form.field.injectAgentsMd": "Suntikkan AGENTS.md",
  "settings.subAgents.form.field.injectAgentsMd.description": "Sertakan file AGENTS.md workspace dalam konteks sub-agen ini",
  "settings.subAgents.form.workspace.unsupported": "Pembuatan atau penyuntingan tingkat workspace tidak didukung",
  "settings.subAgents.form.save": "Simpan",
  "settings.subAgents.form.saving": "Menyimpan...",
  "settings.subAgents.form.cancel": "Batal",
  "settings.subAgents.form.delete": "Hapus",
  "settings.subAgents.form.delete.confirm": "Hapus sub-agen \"{{name}}\"?",
  "settings.subAgents.form.success": "Sub-agen dibuat",
  "settings.subAgents.form.failed": "Gagal membuat sub-agen",
  "settings.subAgents.form.updated": "Sub-agen diperbarui",
  "settings.subAgents.form.updateFailed": "Gagal memperbarui sub-agen",
  "settings.subAgents.form.deleted": "Sub-agen dihapus",
  "settings.subAgents.form.deleteFailed": "Gagal menghapus sub-agen",
  "settings.subAgents.native.build": "Agen default. Menjalankan alat berdasarkan izin yang dikonfigurasi.",
  "settings.subAgents.native.plan": "Mode rencana. Menonaktifkan semua alat sunting.",
  "settings.subAgents.native.general": "Agen serba guna untuk meneliti pertanyaan kompleks dan menjalankan tugas bertingkat.",
  "settings.subAgents.native.explore": "Agen cepat yang khusus untuk menjelajahi codebase dan menemukan file.",
  "settings.subAgents.native.compaction": "Agen internal untuk memadatkan riwayat sesi.",
  "settings.subAgents.native.title": "Agen internal untuk membuat judul percakapan.",
  "settings.subAgents.native.summary": "Agen internal untuk merangkum sesi.",
  "settings.plugins.title": "Plugin",
  "settings.plugins.description": "Perluas agen dengan paket npm atau file plugin lokal yang terhubung ke peristiwa siklus hidup.",
  "settings.plugins.note.title": "Apa itu plugin?",
  "settings.plugins.note.description": "Plugin berjalan di dalam proses agen dan bereaksi terhadap peristiwa siklus hidup seperti sesi idle, eksekusi alat, dan penyiapan lingkungan shell.",
  "settings.plugins.section.installed": "Terpasang",
  "settings.plugins.section.add": "Tambah plugin",
  "settings.plugins.empty": "Belum ada plugin terpasang",
  "settings.plugins.add.label": "Paket atau file lokal",
  "settings.plugins.add.placeholder": "opencode-wakatime, @my-org/custom-plugin atau ./plugins/my-plugin.ts",
  "settings.plugins.add.button": "Tambah",
  "settings.plugins.add.success": "Plugin ditambahkan",
  "settings.plugins.add.failed": "Gagal menambahkan plugin",
  "settings.plugins.remove": "Hapus",
  "settings.plugins.remove.confirm": "Hapus plugin \"{{name}}\"?",
  "settings.plugins.remove.success": "Plugin dihapus",
  "settings.plugins.remove.failed": "Gagal menghapus plugin",
  "settings.plugins.origin.npm": "npm · memerlukan konvensi Tian",
  "settings.plugins.origin.local": "lokal",
  "settings.plugins.catalog.npm.title": "Aplikasi npm populer",
  "settings.plugins.catalog.npm.description": "Paket terverifikasi yang mengikuti konvensi plugin Tian.",
  "settings.plugins.catalog.npm.note": "Paket npm harus menerapkan konvensi plugin Tian",
  "settings.plugins.catalog.local.title": "Plugin lokal",
  "settings.plugins.catalog.local.description": "Plugin yang disertakan dengan repositori ini di bawah .tiancode/plugins.",
  "settings.plugins.catalog.add": "Tambah",
  "settings.plugins.catalog.installed": "Terpasang",
  "settings.plugins.catalog.npm.biome.description": "Linter dan formatter cepat untuk JavaScript dan TypeScript.",
  "settings.plugins.catalog.npm.playwrightMcp.description": "Otomatisasi peramban dan pengujian E2E untuk aplikasi web.",
  "settings.plugins.catalog.npm.octokitRest.description": "Klien GitHub API untuk pull request, isu, dan repositori.",
  "settings.plugins.catalog.npm.slackWebApi.description": "Klien Slack Web API resmi untuk pesan dan percakapan.",
  "settings.plugins.catalog.npm.notionClient.description": "Klien Notion API resmi untuk halaman, database, dan blok.",
  "settings.plugins.catalog.npm.sentryCli.description": "Pemantauan error Sentry, rilis, dan unggahan source map.",
  "settings.plugins.catalog.npm.agentNotify.description": "Mengirim notifikasi saat tugas agen selesai atau gagal.",
  "settings.plugins.catalog.npm.chimeClaude.description": "Notifikasi Telegram untuk peristiwa siklus hidup agen.",
  "settings.plugins.catalog.local.envGuard.description": "Melindungi file .env dari suntingan yang tidak disengaja.",
  "settings.plugins.catalog.local.commitHelper.description": "Membantu menyusun pesan commit konvensional.",
  "settings.plugins.catalog.local.notifyIdle.description": "Memberi tahu Anda saat sesi menjadi idle.",
  "settings.plugins.catalog.local.shellEnv.description": "Menyuntikkan variabel lingkungan ke proses alat shell.",
  "settings.plugins.catalog.local.permissionGuard.description": "Memblokir panggilan alat berisiko yang memerlukan persetujuan eksplisit.",
  "settings.plugins.template.title": "Plugin baru",
  "settings.plugins.template.description": "Menghasilkan kerangka plugin dengan hook siklus hidup paling umum. Salin ke file dan tambahkan di atas.",
  "settings.plugins.template.copy": "Salin",
  "settings.plugins.template.copied": "Templat disalin ke clipboard",
  "settings.mcpServers.title": "Server MCP",
  "settings.mcpServers.description": "Hubungkan agen ke alat eksternal melalui server Model Context Protocol (MCP).",
  "settings.mcpServers.section.servers": "Server",
  "settings.mcpServers.section.add": "Tambah server",
  "settings.mcpServers.edit.title": "Sunting server",
  "settings.mcpServers.empty": "Belum ada server MCP yang dikonfigurasi",
  "settings.mcpServers.add.button": "Tambah server",
  "settings.mcpServers.save.button": "Simpan",
  "settings.mcpServers.cancel.button": "Batal",
  "settings.mcpServers.saving": "Menyimpan...",
  "settings.mcpServers.field.name": "Nama",
  "settings.mcpServers.field.name.placeholder": "filesystem",
  "settings.mcpServers.field.type": "Jenis",
  "settings.mcpServers.type.local": "Lokal (stdio)",
  "settings.mcpServers.type.remote": "Jarak jauh (HTTP/SSE)",
  "settings.mcpServers.field.command": "Perintah",
  "settings.mcpServers.field.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem /path",
  "settings.mcpServers.field.command.hint": "Tips: npx, uvx, node atau cmd /c npx di Windows",
  "settings.mcpServers.field.environment": "Lingkungan (KEY=VALUE per baris)",
  "settings.mcpServers.field.environment.placeholder": "API_KEY=sk-...",
  "settings.mcpServers.field.cwd": "Direktori kerja (opsional)",
  "settings.mcpServers.field.timeout": "Tenggat waktu dalam detik (opsional)",
  "settings.mcpServers.field.url": "URL",
  "settings.mcpServers.field.url.placeholder": "https://example.com/mcp",
  "settings.mcpServers.field.headers": "Header (KEY=VALUE per baris)",
  "settings.mcpServers.field.oauth": "OAuth",
  "settings.mcpServers.presets.title": "Pratetap",
  ...
  "settings.mcpServers.status.connected": "Terhubung",
  "settings.mcpServers.status.disabled": "Nonaktif",
  "settings.mcpServers.status.failed": "Error",
  "settings.mcpServers.status.needs_auth": "Perlu autentikasi",
  "settings.mcpServers.status.needs_client_registration": "Perlu pendaftaran",
  "settings.mcpServers.status.unknown": "Tidak diketahui",
  "settings.mcpServers.action.connect": "Hubungkan",
  "settings.mcpServers.action.disconnect": "Putuskan",
  "settings.mcpServers.action.edit": "Sunting",
  "settings.mcpServers.action.export": "Ekspor",
  "settings.mcpServers.action.remove": "Hapus",
  "settings.mcpServers.remove.confirm": "Hapus server \"{{name}}\"?",
  "settings.mcpServers.add.success": "Server disimpan",
  "settings.mcpServers.add.failed": "Gagal menyimpan server",
  "settings.mcpServers.export.success": "Konfigurasi disalin ke clipboard",
  "settings.mcpServers.export.failed": "Gagal menyalin konfigurasi",
  "settings.mcpServers.search.placeholder": "Cari server...",
  "settings.mcpServers.search.empty": "Tidak ada server yang cocok dengan pencarian Anda",
  "settings.mcpServers.group.connected": "Terhubung",
  "settings.mcpServers.group.errors": "Error",
  "settings.mcpServers.group.disabled": "Nonaktif",
  "settings.mcpServers.group.unknown": "Tidak diketahui",
  "settings.mcpServers.tools.count": "{{count}} alat",
  "settings.mcpServers.save.changes": "Simpan perubahan",
  "settings.mcpServers.discover.title": "Jelajahi",
  "settings.mcpServers.discover.description": "Server MCP populer yang dapat Anda tambahkan dengan sekali klik.",
  "settings.mcpServers.discover.requiresKey": "Memerlukan API key — sunting setelah menambahkan",
  "settings.mcpServers.discover.presets.android-emulator.name": "Android Emulator",
  "settings.mcpServers.discover.presets.android-emulator.description": "Kontrol emulator Android, layar, dan aplikasi dari agen.",
  "settings.mcpServers.discover.presets.node-repl.name": "Node REPL",
  "settings.mcpServers.discover.presets.node-repl.description": "Jalankan JavaScript dalam sesi REPL Node.js.",
  "settings.mcpServers.discover.presets.ios-simulator.name": "iOS Simulator",
  "settings.mcpServers.discover.presets.ios-simulator.description": "Kendalikan simulator iOS dan aplikasinya (memerlukan Xcode).",
  "settings.mcpServers.discover.presets.chrome-devtools.name": "Chrome DevTools",
  "settings.mcpServers.discover.presets.chrome-devtools.description": "Periksa, debug, dan otomatiskan halaman Chrome.",
  "settings.mcpServers.discover.presets.playwright.name": "Playwright",
  "settings.mcpServers.discover.presets.playwright.description": "Otomatisasi peramban dan pengujian web ujung ke ujung.",
  "settings.mcpServers.discover.presets.context7.name": "Context7",
  "settings.mcpServers.discover.presets.context7.description": "Dokumentasi terbaru untuk pustaka dan kerangka kerja populer.",
  "settings.mcpServers.discover.presets.agent-vision.name": "Agent Vision",
  "settings.mcpServers.discover.presets.agent-vision.description": "Memberi mata pada model tanpa visi: analisis gambar, tangkapan layar, dan dokumen (OCR) dengan API visi apa pun yang kompatibel dengan OpenAI (OpenAI, Gemini, Qwen-VL). Setelah mengaktifkan, tambahkan VISION_API_KEY di bawah Environment di editor server.",
  "capture.menu.title": "Tangkap tangkapan layar",
  "capture.screen": "Layar penuh",
  "capture.window": "Jendela aplikasi",
  "capture.area": "Pilih area…",
  "capture.preview": "Peramban internal",
  "capture.area.title": "Pilih area untuk ditangkap (Enter untuk konfirmasi, Esc untuk batal)",
  "capture.area.cancel": "Batal",
  "capture.area.confirm": "Tangkap area",
  "settings.mcpServers.discover.presets.aikido.name": "Aikido",
  "settings.mcpServers.discover.presets.aikido.description": "Pindai kode dan dependensi untuk masalah keamanan.",
  "settings.mcpServers.discover.presets.airwallex.name": "Airwallex",
  "settings.mcpServers.discover.presets.airwallex.description": "API pembayaran, treasury, dan penerbitan kartu.",
  "settings.mcpServers.discover.presets.canva.name": "Canva",
  "settings.mcpServers.discover.presets.canva.description": "Buat dan sunting desain Canva (OAuth).",
  "settings.mcpServers.discover.presets.circle.name": "Circle",
  "settings.mcpServers.discover.presets.circle.description": "Pembayaran USDC dan dompet yang dikendalikan pengembang.",
  "settings.mcpServers.discover.presets.appwrite.name": "Appwrite",
  "settings.mcpServers.discover.presets.appwrite.description": "Autentikasi, database, dan penyimpanan untuk aplikasi Anda (OAuth).",
  "settings.mcpServers.discover.presets.apollo.name": "Apollo",
  "settings.mcpServers.discover.presets.apollo.description": "Kueri grafik Apollo GraphOS Anda (OAuth).",
  "settings.mcpServers.discover.presets.graphos-tools.name": "GraphOS Tools",
  "settings.mcpServers.discover.presets.graphos-tools.description": "Kelola workspace dan skema Apollo GraphOS.",
  "settings.mcpServers.discover.presets.atlan.name": "Atlan",
  "settings.mcpServers.discover.presets.atlan.description": "Cari katalog data dan aset tata kelola Anda (OAuth).",
  "settings.mcpServers.discover.presets.awsknowledge.name": "AWS Knowledge",
  "settings.mcpServers.discover.presets.awsknowledge.description": "Dokumentasi layanan AWS dan basis pengetahuan.",
  "settings.github.title": "Github",
  "settings.github.description": "Hubungkan akun GitHub Anda untuk mengkloning repositori, membuat yang baru, dan menjalankan operasi git pada proyek Anda.",
  "settings.github.loading": "Memuat...",
  "settings.github.connect.title": "Hubungkan GitHub",
  "settings.github.connect.description": "Tempel token akses pribadi untuk mengautentikasi dengan GitHub. Token disimpan secara lokal dan digunakan untuk kloning dan operasi git terautentikasi.",
  "settings.github.connect.token.placeholder": "github_pat_... or ghp_...",
  "settings.github.connect.hint": "Buat token di github.com/settings/tokens (fine-grained dengan cakupan repo)",
  "settings.github.connect.button": "Hubungkan",
  "settings.github.connecting": "Menghubungkan...",
  "settings.github.connect.success": "Akun GitHub terhubung",
  "settings.github.connect.failed": "Gagal menghubungkan GitHub. Periksa token Anda dan coba lagi.",
  "settings.github.connected.title": "Terhubung sebagai",
  "settings.github.disconnect.button": "Putuskan",
  "settings.github.disconnect.confirm": "Putuskan akun GitHub Anda? Token yang tersimpan akan dihapus.",
  "settings.github.disconnect.success": "Akun GitHub terputus",
  "settings.github.disconnect.failed": "Gagal memutuskan GitHub",
  "settings.github.refresh": "Segarkan",
  "settings.github.repos.title": "Repositori",
  "settings.github.repos.search.placeholder": "Cari repositori Anda...",
  "settings.github.repos.empty": "Tidak ada repositori ditemukan",
  "settings.github.repo.private": "Pribadi",
  "settings.github.repo.public": "Publik",
  "settings.github.repo.clone": "Kloning",
  "settings.github.repo.cloning": "Mengkloning...",
  "settings.github.repo.clone.success": "Dikloning ke {{directory}}",
  "settings.github.repo.clone.failed": "Gagal mengkloning repositori",
  "settings.github.create.title": "Buat repositori",
  "settings.github.create.name": "Nama",
  "settings.github.create.name.placeholder": "my-repository",
  "settings.github.create.private": "Pribadi",
  "settings.github.create.button": "Buat",
  "settings.github.create.success": "Repositori dibuat",
  "settings.github.create.failed": "Gagal membuat repositori",
  "settings.github.project.title": "Proyek saat ini",
  "settings.github.project.noRemote": "Proyek ini belum memiliki git remote — buat repositori di GitHub dan tambahkan remote-nya.",
  "settings.github.commit.placeholder": "Pesan commit...",
  "settings.github.commit.button": "Commit",
  "settings.github.commit.success": "Terkirim",
  "settings.github.commit.failed": "Commit gagal",
  "settings.github.push.button": "Push",
  "settings.github.push.success": "Terpush",
  "settings.github.push.failed": "Push gagal",
  "settings.github.pull.button": "Pull",
  "settings.github.pull.success": "Terpull",
  "settings.github.pull.failed": "Pull gagal",
  "settings.voices.title": "Suara",
  "settings.voices.description": "Pilih suara untuk membacakan respons asisten dengan lantang dan uji model suara gratis.",
  "settings.voices.desktopOnly": "Suara tersedia di aplikasi desktop.",
  "settings.voices.loading": "Memuat...",
  "settings.voices.download.title": "Model suara belum terpasang",
  "settings.voices.download.description": "Unduh model suara kokoro gratis (~325MB) untuk mensintesis ucapan di komputer Anda. Suara tidak akan pernah meninggalkan perangkat Anda.",
  "settings.voices.download.button": "Unduh model suara",
  "settings.voices.download.downloading": "Mengunduh model suara...",
  "settings.voices.download.progress": "Mengunduh {{file}}",
  "settings.voices.download.failed": "Gagal mengunduh model suara",
  "settings.voices.ready.title": "Pilih suara",
  "settings.voices.voices.empty": "Tidak ada suara yang tersedia",
  "settings.voices.voice.probe": "Uji",
  "settings.voices.voice.speaking": "Berhenti",
  "settings.voices.voice.probe.failed": "Gagal memutar suara ini",
  "settings.voices.voice.unsupported": "Hanya bahasa Inggris",
  "settings.voices.select.title": "Suara aktif",
  "settings.voices.autoSpeak.title": "Bacakan respons dengan lantang",
  "settings.voices.autoSpeak.description": "Membacakan respons model secara real-time saat sedang dihasilkan, menggunakan suara yang dipilih.",
  "settings.voices.gender.female": "Perempuan",
  "settings.voices.gender.male": "Laki-laki",
  "settings.voices.filter.all": "Semua",
  "settings.voices.filter.female": "Perempuan",
  "settings.voices.filter.male": "Laki-laki",
  "settings.voices.filter.spanish": "Spanyol",
  "settings.voices.pagination.prev": "Sebelumnya",
  "settings.voices.pagination.next": "Berikutnya",
  "settings.voices.pagination.page": "Halaman {{current}} dari {{total}}",
  "settings.voices.voice.info": "Detail suara",
  "settings.voices.voice.download": "Unduh",
  "settings.voices.voice.downloading": "Mengunduh…",
  "settings.voices.voice.delete": "Hapus",
  "settings.voices.voice.delete.confirm": "Hapus file yang diunduh untuk {{name}}?",
  "settings.voices.voice.builtin": "Bawaan",
  "settings.voices.voice.engine.kokoro": "Kokoro",
  "settings.voices.voice.engine.piper": "Piper",
  "settings.voices.voice.license": "Lisensi",
  "settings.voices.voice.enabled": "Aktif",
  "settings.voices.voice.size": "{{size}} MB",
  "settings.voices.voice.download.success": "Suara diunduh",
  "settings.voices.voice.download.failed": "Gagal mengunduh suara",
  "settings.voices.voice.delete.success": "Suara dihapus",
  "settings.voices.voice.delete.failed": "Gagal menghapus suara",
  "settings.tab.modelsHub": "Model Lokal",
  "settings.modelsHub.title": "Model Lokal",
  "settings.modelsHub.description": "Cari dan unduh model GGUF dari HuggingFace untuk menjalankan AI secara lokal, seperti LM Studio.",
  "settings.modelsHub.search.placeholder": "Cari model... mis. llama 3.2",
  "settings.modelsHub.search.button": "Cari",
  "settings.modelsHub.empty": "Tidak ada model ditemukan. Coba pencarian lain.",
  "settings.modelsHub.download": "Unduh",
  "settings.modelsHub.download.downloading": "Mengunduh",
  "settings.modelsHub.download.paused": "Dijeda",
  "settings.modelsHub.download.resume": "Lanjutkan",
  "settings.modelsHub.download.delete": "Hapus",
  "settings.modelsHub.download.completed": "Selesai",
  "settings.modelsHub.download.failed": "Gagal",
  "settings.modelsHub.downloads.title": "Unduhan",
  "settings.modelsHub.recommended": "Disarankan",
  "settings.modelsHub.detail.files": "File",
  "settings.modelsHub.runtime.title": "Runtime",
  "settings.modelsHub.runtime.description": "Runtime inferensi lokal yang terdeteksi di mesin ini.",
  "settings.modelsHub.runtime.available": "Tersedia",
  "settings.modelsHub.runtime.notDetected": "Tidak terdeteksi",
  "settings.modelsHub.provider.setup": "Siapkan sebagai penyedia",
  "settings.modelsHub.provider.ready": "Penyedia lokal siap (model: {name})",
  "settings.modelsHub.provider.failed": "Tidak dapat menyiapkan penyedia lokal",
  "settings.modelsHub.recommended.title": "Model yang disarankan untuk GPU Anda",
  "settings.modelsHub.recommended.forYourGpu": "berdasarkan VRAM terdeteksi Anda",
  "settings.modelsHub.recommended.download": "Unduh",
  "settings.modelsHub.runtime.hint": "Jalankan model lokal melalui Ollama atau LM Studio dan tambahkan sebagai penyedia di Penyedia.",
  "settings.modelsHub.runtime.install": "Pasang",
  "settings.modelsHub.runtime.install.downloading": "Mengunduh",
  "settings.modelsHub.runtime.install.installing": "Memasang…",
  "settings.modelsHub.runtime.install.success": "{{name}} terpasang. Buka aplikasi sekali untuk menyelesaikan penyiapan.",
  "settings.modelsHub.runtime.install.failed": "Gagal memasang runtime",
  "settings.modelsHub.system.ram": "RAM",
  "settings.modelsHub.system.vram": "Memori GPU (VRAM)",
  "settings.modelsHub.system.vramFree": "bebas:",
  "settings.modelsHub.memory.title": "Mode memori",
  "settings.modelsHub.memory.gpu": "Gunakan memori GPU (VRAM) sebagai utama",
  "settings.modelsHub.memory.ram": "Gunakan RAM sistem sebagai cadangan",
  "settings.modelsHub.system.dir": "Folder model",
  "settings.modelsHub.system.disk": "Disk kosong",
  "settings.modelsHub.system.gpu": "GPU",
  "settings.modelsHub.system.cpu": "CPU",
  "settings.modelsHub.fit.fullGpu": "Offload GPU Penuh Dimungkinkan",
  "settings.modelsHub.fit.partialGpu": "Offload GPU Sebagian Dimungkinkan",
  "settings.modelsHub.fit.ramOnly": "Muat tanpa GPU",
  "settings.modelsHub.fit.noFit": "Tidak akan muat",
  "settings.modelsHub.desc.text-generation": "Generasi teks",
  "settings.modelsHub.desc.image-text-to-text": "Visi",
  "settings.modelsHub.desc.text-to-image": "Generasi gambar",
  "settings.modelsHub.desc.image-to-image": "Penyuntingan gambar",
  "settings.modelsHub.desc.image-classification": "Klasifikasi gambar",
  "settings.modelsHub.desc.token-classification": "Klasifikasi token",
  "settings.modelsHub.desc.text-classification": "Klasifikasi teks",
  "settings.modelsHub.desc.question-answering": "Tanya jawab",
  "settings.modelsHub.desc.summarization": "Perangkuman",
  "settings.modelsHub.desc.translation": "Terjemahan",
  "settings.modelsHub.desc.fill-mask": "Isi mask",
  "settings.modelsHub.desc.feature-extraction": "Ekstraksi fitur",
  "settings.modelsHub.desc.automatic-speech-recognition": "Pengenalan ucapan",
  "settings.modelsHub.desc.text-to-speech": "Teks ke ucapan",
  "settings.modelsHub.desc.depth-estimation": "Estimasi kedalaman",
  "settings.modelsHub.desc.image-segmentation": "Segmentasi gambar",
  "settings.modelsHub.desc.object-detection": "Deteksi objek",
  ...
  "settings.modelsHub.desc.hint.code": "Pengodean",
  "settings.modelsHub.desc.hint.reasoning": "Penalaran",
  "settings.modelsHub.desc.hint.quantized": "Quantized",
  "onboarding.title": "Selamat datang di Tiancode",
  "onboarding.step": "Langkah {{current}} dari {{total}}",
  "onboarding.disclaimer.p1": "Tiancode adalah agen AI yang bekerja bersama Anda: ia dapat menjalankan perintah, menyunting file, dan mengelola tugas di komputer Anda sementara Anda tetap memegang kendali.",
  "onboarding.disclaimer.p2": "Prompt dan isi file Anda dapat dikirim ke penyedia model AI yang Anda konfigurasi untuk menghasilkan respons.",
  "onboarding.disclaimer.p3": "Anda bertanggung jawab atas cara Anda menggunakan Tiancode. Tinjau perubahan dengan saksama sebelum menerimanya dan jangan pernah menjalankan perintah yang tidak Anda pahami.",
  "onboarding.accept": "Terima & Lanjutkan",
  "onboarding.preferences.title": "Buat sesuai keinginan Anda",
  "onboarding.preferences.description": "Pilih bagaimana Tiancode tampil dan berbicara kepada Anda. Anda dapat mengubahnya kapan saja di Pengaturan.",
  "onboarding.theme.title": "Tampilan",
  ...
  "onboarding.start": "Mulai menggunakan Tiancode",
}
