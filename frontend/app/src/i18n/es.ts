...
"prompt.action.stop": "Detener",
  ...
  "settings.subAgents.form.tools.all": "Permisos predeterminados",
  "settings.subAgents.form.tools.custom": "Herramientas personalizadas",
  ...
  "settings.plugins.add.placeholder": "opencode-wakatime, @my-org/custom-plugin o ./plugins/mi-plugin.ts",
  ...
  "settings.pets.selected": "Seleccionado",
...
"settings.mcpServers.group.unknown": "Desconocidos",
  ...
  "settings.mcpServers.discover.presets.unreal.description": "Controla un proyecto de Unreal Engine (Web Remote Control): abre el editor, ejecuta Python y comandos, lee logs y actores del nivel. Requiere la carpeta unreal-opencode-mcp instalada.",
  ...
  "settings.voices.autoSpeak.description": "Lee la respuesta del modelo en tiempo real mientras se genera, con la voz seleccionada.",
