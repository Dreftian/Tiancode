...
"prompt.action.stop": "Detener",
  ...
  "settings.plugins.catalog.npm.biome.description": "Linter y formateador rápido para JavaScript y TypeScript.",
  "settings.plugins.catalog.npm.playwrightMcp.description": "Automatización de navegador y pruebas E2E para aplicaciones web.",
  "settings.plugins.catalog.npm.octokitRest.description": "Cliente de la API de GitHub para pull requests, issues y repositorios.",
  "settings.plugins.catalog.npm.slackWebApi.description": "Cliente oficial de la API Web de Slack para mensajes y conversaciones.",
  "settings.plugins.catalog.npm.notionClient.description": "Cliente oficial de la API de Notion para páginas, bases de datos y bloques.",
  "settings.plugins.catalog.npm.sentryCli.description": "Monitorización de errores de Sentry, releases y subida de source maps.",
  "settings.plugins.catalog.npm.agentNotify.description": "Envía notificaciones cuando las tareas del agente terminan o fallan.",
  "settings.plugins.catalog.npm.chimeClaude.description": "Notificaciones de Telegram para eventos del ciclo de vida del agente.",
