...
"prompt.action.stop": "Detener",
  ...
  "settings.connections.description": "Integra Tiancode con Telegram, WhatsApp, Discord, Slack y Webhooks inspirados en OpenClaw y Hermes Agent.",
  "settings.connections.telegram.title": "Telegram Bot Gateway",
  "settings.connections.telegram.token": "Bot Token",
  "settings.connections.telegram.tokenMissing": "Introduce el Token del Bot de Telegram",
  "settings.connections.telegram.testSuccess": "¡Conexión exitosa con Telegram!",
  "settings.connections.telegram.chatId": "Chat ID / Usuario",
  "settings.connections.telegram.pairing": "Pairing interactivo bidireccional",
  "settings.connections.telegram.pairingDescription": "Permite a Tiancode recibir comandos /run, /status y aprobar permisos críticos directamente desde Telegram.",
  "settings.connections.telegram.notifyBuilds": "Notificaciones de compilación",
  "settings.connections.whatsapp.title": "WhatsApp Gateway",
  "settings.connections.whatsapp.phone": "Número / ID de WhatsApp",
  "settings.connections.whatsapp.phoneMissing": "Introduce tu número de WhatsApp",
  "settings.connections.whatsapp.pairedSuccess": "Código de Pairing generado",
  "settings.connections.whatsapp.pairingMode": "Método de Vinculación",
  "settings.connections.whatsapp.notifyBuilds": "Notificaciones de compilación y pruebas",
  "settings.connections.whatsapp.notifyErrors": "Alertas de excepciones críticas",
  "settings.connections.discord.title": "Discord",
  "settings.connections.discord.authMode": "Método de Conexión",
  "settings.connections.discord.channel": "Canal de avisos",
  "settings.connections.discord.notifyBuilds": "Notificaciones de builds y commits",
  "settings.connections.discord.missingTarget": "Introduce una Webhook URL o Token de Discord",
  "settings.connections.discord.testSuccess": "Mensaje enviado a Discord",
  "settings.connections.slack.title": "Slack",
  "settings.connections.slack.webhook": "Incoming Webhook URL",
  "settings.connections.slack.channel": "Canal Predeterminado",
  "settings.connections.slack.notifyBackground": "Notificaciones de background",
  "settings.connections.slack.missingUrl": "Introduce la URL del Incoming Webhook de Slack",
  "settings.connections.slack.testSuccess": "Webhook de Slack verificado",
  ...
  "settings.connections.webhooks.missingUrl": "Introduce la URL del Endpoint",
  "settings.connections.webhooks.testSuccess": "Payload de prueba enviado",
