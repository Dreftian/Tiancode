...
"prompt.action.stop": "Detener",
  ...
  "settings.computerUse.autoApprove": "Permitir al agente controlar aplicaciones",
  "settings.computerUse.autoApprove.description": "Aprueba automáticamente las acciones de tipo computer use cuando el modelo las solicita",
  "settings.computerUse.autoApprove.note": "El control directo de aplicaciones depende del proveedor del modelo; Tiancode permite aprobar automáticamente las acciones de tipo computer use cuando el modelo las soporta.",
  "settings.computerUse.screenshot": "La captura de pantalla está incluida: puedes fotografiar la pantalla, una ventana o la vista en vivo y adjuntarla en la conversación.",
...
"settings.mcpServers.group.unknown": "Desconocidos",
  ...
  "settings.voices.filter.female": "Femeninas",
  "settings.voices.filter.male": "Masculinas",
  "settings.voices.filter.spanish": "Español",
  ...
  "prompt.optimize.empty": "Por favor, introduzca primero el texto.",
  "prompt.optimize.optimizing": "Optimizando texto...",
  ...
  "settings.intelligence.autoSkill": "Auto-Destilación de Habilidades (/learn)",
  "settings.intelligence.autoSkill.desc": "Sugiere empaquetar flujos complejos exitosos en archivos SKILL.md reutilizables automáticamente.",
  "settings.intelligence.section.codegraph": "Grafo de Código y AST",
  ...
  "settings.intelligence.monaco": "Visor de Diffs Monaco",
  "settings.intelligence.monaco.desc": "Muestra comparaciones visuales lado a lado con resaltado de sintaxis antes de aplicar parches.",
  "settings.intelligence.section.safety": "Seguridad Web y de Ejecución",
  "settings.intelligence.cleanWeb": "Extracción Web Limpia (Firecrawl Engine)",
  "settings.intelligence.cleanWeb.desc": "Descarta scripts, cookies y menús para convertir páginas web en Markdown puro optimizado para LLMs.",
  "settings.intelligence.guardrails": "Pipeline de Guardrails y Redacción de Secretos",
  "settings.intelligence.guardrails.desc": "Enmascara contraseñas, tokens y claves privadas antes de enviar consultas a proveedores externos.",
  "settings.intelligence.sandbox": "Modo de Ejecución Sandbox",
