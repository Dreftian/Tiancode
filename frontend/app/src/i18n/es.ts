export const dict = {
  ...
  "settings.subAgents.section.agents": "Agentes",
  "settings.subAgents.section.create": "Crear agente",
  "settings.subAgents.empty": "Aún no hay sub-agentes creados",
  "settings.subAgents.create.name": "Nombre",
  "settings.subAgents.create.name.placeholder": "mi-subagente",
  "settings.subAgents.create.description": "Descripción",
  "settings.subAgents.create.description.placeholder": "Para qué es bueno este agente",
  "settings.subAgents.create.mode": "Modo",
  "settings.subAgents.create.mode.subagent": "Sub-agente",
  "settings.subAgents.create.mode.primary": "Principal",
  "settings.subAgents.create.model": "Modelo",
  "settings.subAgents.create.model.placeholder": "proveedor/modelo (opcional)",
  "settings.subAgents.create.color": "Color",
  "settings.subAgents.create.color.placeholder": "#RRGGBB (opcional)",
  "settings.subAgents.create.button": "Crear agente",
