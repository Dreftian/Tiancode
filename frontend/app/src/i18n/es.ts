...
export const dict = {
  ...
  "settings.modelsHub.dir.restart": "Los modelos nuevos se descargan en esta carpeta a partir del próximo inicio de Tiancode. Los ya descargados siguen disponibles donde están.",
