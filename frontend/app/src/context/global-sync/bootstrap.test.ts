...
import type { Config, OpencodeClient, Project } from "@tiancode-ai/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@tiancode-ai/client/promise"
