import type { TiancodeEvent } from "@tiancode-ai/client/promise"
import type { Event } from "@tiancode-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: TiancodeEvent }
...
export function adaptServerEvent(event: TiancodeEvent): ServerEvent {
...
function currentDelta(event: TiancodeEvent | undefined): CurrentDelta | undefined {
  if (
