import type { TiancodeEvent, SessionMessageInfo, SessionPendingMessage } from "@tiancode-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: TiancodeEvent): V2SessionReduction | undefined => {
