...
import { createEffect, createMemo, createRoot, type Owner } from "solid-js"
...
export const { use: useGlobal, provider: GlobalProvider } = createSimpleContext({
  ...
  init: () => {
    ...
    // solid-js/web types getOwner() as `unknown`; the runtime value is Owner | null.
    const owner = getOwner() as Owner | null
    ...
    return {
      ...
      // Explicit return type: the method name shadows the closure below, which otherwise
      // makes TS infer this as circular and fall back to `any`.
      ensureServerCtx(conn: ServerConnection.Any): ReturnType<typeof createServerCtx> {
