                      ...
                      return (
                        <div class="settings-v2-mcp-servers-item">
                          <div class="settings-v2-mcp-servers-item-copy">
                            <div class="settings-v2-mcp-servers-item-name">{serverName}</div>
                          ...
                          <div class="settings-v2-mcp-servers-item-actions">
                            ...
                            <Show
                              when={connected}
                              fallback={
                                <ButtonV2 type="button" variant="outline" size="small" onClick={() => void connect(serverName)}>
              ...
              <div class="settings-v2-mcp-servers-actions">
                ...
                >
                  {saving()
                    ...
                    : language.t("settings.mcpServers.save.button")}
                </ButtonV2>
              </div>
            </div>
          </div>
