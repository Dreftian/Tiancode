...
const BUILTIN_PLUGINS = [
  {
    ...
    desc: "Provides Android development workflows and emulator automation for ZCode.",
    icon: "🤖",
    category: "desarrollo",
  },
  {
  ...
  },
  {
    ...
    desc: "Built-in DOCX and PDF document production skills, published as an official ZCode plugin.",
    icon: "📄",
  ...
  },
  {
    id: "ios-simulator",
    name: "iOS Simulator",
    desc: "Provides iOS development workflows and simulator automation for ZCode.",
    icon: "📱",
    category: "desarrollo",
  },
  {
    ...
    desc: "Select and restore legacy ACP-era ZCode sessions into the new ZCode task and session store.",
    icon: "💾",
    category: "sistema",
  },
  {
    id: "skill-creator",
    name: "Skill Creator",
    desc: "Create, edit, iterate local ZCode skills.",
    icon: "✏️",
    category: "ia",
  },
  {
    id: "zcode-guide",
    name: "ZCode Guide",
    desc: "ZCode usage and self-diagnosis guide: teaches agents and users how to configure MCP servers, commands, skills, hooks, and extensions.",
    icon: "📖",
