...
beforeAll(async () => {
  ...
  mock.module("@tiancode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@tiancode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@tiancode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@tiancode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
