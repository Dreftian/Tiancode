...
import { LS_KEYS, readLS, writeLS } from './utils.js?v=1.0.0';

export const I18N = {
  es: {
  "page.title": "Tiancode — Inteligencia Agéntica Autónoma para Desarrolladores",
  "page.description": "Tiancode 1.0.0 para Windows: chat al estilo Claude Code con control de esfuerzo, envío dentro del cuadro, modos de permiso en vivo, ajustes sin desplazamiento y logotipos oficiales en MCP y plugins.",
  "loader.text": "Cargando Tiancode v1.0.0…",
  "nav.showcase": "Studio",
  ...
  "hero.sub": "Agentes de IA con OpenClaw y Hermes, Conexiones Gateway, OpenDesign UI, Sandbox Keep-Alive, 120+ skills y modelos locales GGUF en Windows.",
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.0)",
  ...
  "f.skills.title": "120+ skills de ingeniería",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.0: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "skills.title": "120+ Skills Especializadas de Ingeniería",
  ...
  "cta.note": "Windows 10 y 11 · 64 bits · ~345 MB",
  ...
  "docs.s1l1": "Instalador NSIS (Tiancode.exe, ~345 MB): instalación clásica con asistente, accesos directos y actualizaciones sencillas.",
  "docs.s1l2": "Versión portable (Tiancode-portable.exe, ~345 MB): sin instalación, se ejecuta desde cualquier carpeta o USB.",
  ...
  "guide.s1d": "Elige el instalador NSIS (~345 MB) o la versión portable (~345 MB) desde la página de descarga. La versión 1.0.0 soporta Windows 10 y 11.",
  ...
  "faq.sessionRecoveryQuestion": "¿Cómo se conservan las sesiones y qué ocurre tras una interrupción?",
  "faq.sessionRecoveryAnswer": "El historial y la configuración se guardan localmente. El escritorio utiliza V1; el núcleo V2 del repositorio continúa en desarrollo. V2 admite entradas de forma durable, pero no reintenta automáticamente el trabajo del proveedor tras un fallo del proceso: la continuación debe solicitarse explícitamente.",
  ...
  "news.sub": "Chat al estilo Claude Code: esfuerzo con control deslizante, envío dentro del cuadro, modos de permiso en vivo y ajustes sin desplazamiento. La versión 1.0.0 reinicia la numeración y conserva tus datos.",
  "news.v1": "Versión 1.0.0",
  "news.date": "16 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Un chat más limpio y ajustes sin desplazamiento",
  "news.new1": "El razonamiento se elige con un control deslizante de Más rápido a Más inteligente, con Ultracode como último nivel y Rápido dentro del mismo panel. El signo de interrogación explica el esfuerzo.",
  "news.new2": "El botón Enviar vive dentro del cuadro y solo aparece al escribir; ofrece Enviar y Enviar y permanecer aquí (Ctrl+Enter). El gatito indica cuándo la IA piensa o escribe.",
  "news.new3": "Los modos Auto, Manual, Aceptar ediciones, Plan y Omitir permisos sustituyen a Build, Plan y Web App, y pueden cambiarse mientras la IA trabaja.",
  "news.new4": "General, Inteligencia, Voces, Skills, Sub-Agentes, MCP y Plugins y Mascotas se organizan con pestañas superiores, como Conexiones, para que cada sección quepa sin desplazamiento.",
  "news.new5": "MCP, plugins y especialistas muestran los logotipos oficiales de GitHub, Slack, Notion, Figma, PostgreSQL, Docker, Python y muchos más; las categorías de Skills son iconos con descripción al pasar el cursor.",
  "news.new6": "La memoria y las habilidades aprendidas (MEMORY.md, USER.md, SKILL.md) se guardan en los datos de Tiancode, no en tus proyectos, como en Claude Code Desktop.",
  "news.new7": "General permite ocultar los iconos de terminal, vista previa, voz, captura, estado, búsqueda y árbol de archivos; la captura de pantalla pasa junto a Estado.",
  "news.impTitle": "Mejoras",
  "news.imp1": "La insignia azul CODEX pasa a ser Coding, con el icono de código.",
  "news.imp2": "Rápido se muestra solo como icono y conserva su nombre al pasar el cursor.",
  "news.imp3": "Ultracode se ofrece únicamente con modelos de razonamiento de Claude y OpenAI; los demás proveedores conservan sus niveles nativos y ya no quedan en bucle.",
  "news.imp4": "GitHub pagina los repositorios de cinco en cinco.",
  "news.imp5": "La actualización a 1.0.0 se instala manualmente sobre 1.0.0 y conserva claves, sesiones, configuración y respaldos.",
  "news.fixTitle": "Correcciones",
  "news.fix1": "El micrófono vuelve a detectar la voz: el contexto de audio se reanuda antes de grabar, el nivel real mueve la onda y la frase se transcribe sola tras una pausa.",
  "news.fix2": "Los interruptores de General vuelven a tener efecto en la cabecera del chat.",
  "news.fix3": "Voces agrupa micrófono, dictado, síntesis y catálogo en pestañas, sin filas fuera de su sección.",
  "port.title": "Modo portable",
  "port.sub": "Tiancode donde lo necesites: sin instalación, con tu configuración a cuestas.",
  "port.intro": "La versión portable (Tiancode-portable.exe, ~345 MB) ejecuta la aplicación completa sin instalarla. Es la misma Tiancode, pero todo — el ejecutable, la configuración y los modelos — vive en la carpeta que tú elijas.",
  ...
  "nav.benchmarks": "Novedades",
  "nav.architecture": "Arquitectura",
  "nav.downloadPill": "Descargar v1.0.0",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Reiniciar animación cósmica de TIANCODE",
  "hero.cosmicBadge": "MODELO DE INTELIGENCIA CÓSMICA · TIANCODE 1.0.0",
  "hero.eyebrowPill": "COMUNICADO DE PRODUCTO",
  "hero.eyebrowMeta": "SEPTIEMBRE 2026 · TIANCODE 1.0.0",
  "hero.title": "Tu proyecto, tus herramientas. Un flujo de trabajo más claro.",
  "hero.lead": "Tiancode 1.0.0 estrena el chat al estilo Claude Code: esfuerzo con control deslizante, envío dentro del cuadro y modos de permiso que cambian en plena tarea. Los ajustes se organizan en pestañas sin desplazamiento y la memoria vive en la app, no en tus proyectos.",
  "hero.ctaPortable": "Descargar Portable (.exe)",
  "hero.cmdCopyTitle": "Abrir las notas y archivos de la versión",
  "hero.metaReleaseLabel": "Lanzamiento",
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.0",
  ...
  "hero.metaArchVal": "Local-First · TypeScript · SQLite",
  "hero.metaArchSub": "Sesiones locales y 14 especialistas",
  "hero.metaPrivacyLabel": "Privacidad & Ejecución",
  "hero.metaPrivacyVal": "Modelos locales o proveedor elegido",
  "hero.metaPrivacySub": "El destino de tus peticiones depende del proveedor",
  "showcase.windowTitle": "Tiancode Studio · demostración ilustrativa",
  "showcase.statusPill": "Ejemplo interactivo · sin ejecución de IA",
  ...
  "cap.5.num": "05",
  "cap.5.title": "Historial local en SQLite",
  "cap.5.desc": "Conserva tus conversaciones en el equipo. El núcleo V2 en desarrollo añade admisión durable de entradas; la continuación tras un fallo requiere una acción explícita.",
  "cap.6.num": "06",
  "cap.6.title": "Protocolo MCP & 120+ Skills Activas",
  ...
  "arch.step4.desc": "El historial persistido permite revisar la sesión. Una interrupción del proceso no reintenta automáticamente el trabajo del proveedor.",
  ...
  "dl.installerBtn": "Descargar Tiancode.exe (~345 MB)",
  ...
  "cap.c1.desc": "Delega trabajo en especialistas con herramientas y permisos definidos. Revisa sus resultados desde la conversación y usa worktrees cuando tu proyecto requiera aislar cambios.",
  ...
  "cap.c2.desc": "Descarga modelos GGUF de Hugging Face y ejecútalos con el motor local. La aceleración y el contexto disponible dependen del modelo, la memoria y el hardware.",
  ...
  "cap.c4.title": "Historial local y evolución del núcleo V2",
  "cap.c4.desc": "El escritorio utiliza el servidor V1. El repositorio incluye un núcleo V2 en desarrollo que persiste la entrada antes de despertar su coordinador. La recuperación de ejecuciones tras un fallo requiere una continuación explícita.",
  "cap.c4.tag1": "Runtime Effect-TS",
  "cap.c4.tag2": "Log Transaccional SQLite",
  "cap.c4.tag3": "Continuación explícita",
  ...
  "benchmarks.eyebrow": "Versión 1.0.0",
  "benchmarks.title": "Qué cambia en esta versión",
  "benchmarks.sub": "Funciones conectadas al trabajo real, con correcciones y pruebas disponibles en el repositorio.",
  "bench.nav.swe": "Modelos y especialistas",
  "bench.nav.lat": "Vista previa",
  "bench.nav.tok": "Controles del chat",
  "bench.nav.off": "Actualizaciones",
  "bench.stat1Label": "Tasa de resolución verificada en problemas reales de ingeniería de software.",
  "bench.stat2Label": "Instalador y portable para Windows x64.",
  "bench.stat3Label": "Metadatos y binarios verificados antes de publicar.",
  "architecture.eyebrow": "Ingeniería",
  "architecture.title": "Historial local y ejecución coordinada",
  "architecture.sub": "Un monorepo en TypeScript puro impulsado por Bun, Effect-TS, SolidJS y SQLite.",
  "arch.blockTitle": "Persistencia con límites claros",
  "arch.blockP1": "Tiancode Desktop conserva sus conversaciones y configuración en el equipo y utiliza el servidor V1. El repositorio también incluye un núcleo V2 en desarrollo, con un coordinador de sesiones y admisión durable de entradas.",
  "arch.blockP2": "En V2, las entradas se guardan en SQLite antes de activar el coordinador. Las instrucciones nuevas se incorporan en límites seguros de turno y las entradas en cola esperan a que la sesión esté disponible. Tras un fallo del proceso, el trabajo del proveedor requiere una continuación explícita.",
  ...
  "downloads.installerF1": "Actualizaciones automáticas no destructivas (v1.0.39+)",
  ...
  "footer.status": "Windows · Desktop v1.0.0",
  "footer.ecosystem": "Ecosistema",
  "footer.docs": "Documentación",
  "footer.guide": "Guía de inicio",
  "footer.skills": "Catálogo 120+ Skills",
  ...
  "page.description": "Tiancode 1.0.0 for Windows: Claude Code-style chat with an effort slider, send inside the box, live permission modes, settings without scrolling and official marks for MCP and plugins.",
  "loader.text": "Loading Tiancode v1.0.0…",
  "nav.showcase": "Studio",
  ...
  "hero.sub": "AI agents with OpenClaw & Hermes, Connections Gateway, OpenDesign UI, Sandbox Keep-Alive, 120+ skills, and local GGUF models on Windows.",
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.0)",
  ...
  "f.skills.title": "120+ engineering skills",
  ...
  "preview.sub": "This is Tiancode v1.0.0: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "skills.title": "120+ Specialized Engineering Skills",
  ...
  "cta.note": "Windows 10 and 11 · 64-bit · ~345 MB",
  ...
  "docs.s1l1": "NSIS installer (Tiancode.exe, ~345 MB): classic wizard-based install with shortcuts and easy updates.",
  "docs.s1l2": "Portable build (Tiancode-portable.exe, ~345 MB): no install, runs from any folder or USB drive.",
  ...
  "guide.s1d": "Pick the NSIS installer (~345 MB) or the portable build (~345 MB) from the download page. Version 1.0.0 supports Windows 10 and 11.",
  ...
  "faq.sessionRecoveryQuestion": "How are sessions saved, and what happens after an interruption?",
  "faq.sessionRecoveryAnswer": "History and configuration are stored locally. Desktop uses V1; the repository's V2 core remains under development. V2 admits inputs durably, but does not automatically retry provider work after a process crash: continuation must be explicitly requested.",
  ...
  "news.sub": "Claude Code-style chat: an effort slider, send inside the box, live permission modes and settings without scrolling. Version 1.0.0 restarts the numbering and keeps your data.",
  "news.v1": "Version 1.0.0",
  "news.date": "September 16, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "A cleaner chat and settings without scrolling",
  "news.new1": "Reasoning effort is picked with a slider from Faster to Smarter, with Ultracode as the last notch and Fast inside the same panel. The question mark explains effort.",
  "news.new2": "Send lives inside the box and only appears once you type; it offers Send and Send and stay here (Ctrl+Enter). The cat shows when the AI is thinking or writing.",
  "news.new3": "Auto, Manual, Accept edits, Plan and Skip permissions replace Build, Plan and Web App, and can be changed while the AI is working.",
  "news.new4": "General, Intelligence, Voices, Skills, Sub-Agents, MCP and Plugins and Pets use top tabs, like Connections, so each section fits without scrolling.",
  "news.new5": "MCP servers, plugins and specialists show the official marks of GitHub, Slack, Notion, Figma, PostgreSQL, Docker, Python and many more; Skills categories are icons with a hover description.",
  "news.new6": "Memory and learned skills (MEMORY.md, USER.md, SKILL.md) live in Tiancode's own data, not inside your projects, like Claude Code Desktop.",
  "news.new7": "General can hide the terminal, preview, voice, capture, status, search and file tree icons; screenshot capture moves next to Status.",
  "news.impTitle": "Improvements in v1.0.0",
  "news.imp1": "The blue CODEX badge becomes Coding, with the code glyph.",
  "news.imp2": "Fast shows only its icon and keeps its name on hover.",
  "news.imp3": "Ultracode is offered only with Claude and OpenAI reasoning models; other providers keep their native levels and no longer loop.",
  "news.imp4": "GitHub pages repositories five at a time.",
  "news.imp5": "Updating to 1.0.0 is a manual install over 1.0.0 and keeps keys, sessions, settings and backups.",
  "news.fixTitle": "Fixes",
  "news.fix1": "The microphone detects speech again: the audio context resumes before recording, the real level drives the waveform and the phrase is transcribed after a pause.",
  "news.fix2": "General switches take effect in the chat header again.",
  "news.fix3": "Voices groups microphone, dictation, synthesis and catalogue into tabs, with no rows outside their section.",
  "port.title": "Portable Mode",
  "port.sub": "Tiancode wherever you need it: no installation, your configuration travels with you.",
  "port.intro": "The portable build (Tiancode-portable.exe, ~345 MB) runs the full application without installing it. It is the same Tiancode, but everything — the executable, the configuration, and the models — lives in a folder of your choice.",
  ...
  "nav.benchmarks": "What's new",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.0",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.0",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.0",
  "hero.title": "Your project, your tools. A clearer workflow.",
  "hero.lead": "Tiancode 1.0.0 brings a Claude Code-style chat: an effort slider, send inside the box and permission modes that switch mid-task. Settings are organised in tabs without scrolling and memory lives in the app, not in your projects.",
  "hero.ctaPortable": "Download Portable (.exe)",
  "hero.cmdCopyTitle": "Open release notes and downloads",
  "hero.metaReleaseLabel": "Release",
  "hero.metaReleaseVal": "September 2026 · v1.0.0",
  ...
  "hero.metaArchVal": "Local-First · TypeScript · SQLite",
  "hero.metaArchSub": "Local sessions and 14 specialists",
  "hero.metaPrivacyLabel": "Privacy & Execution",
  "hero.metaPrivacyVal": "Local models or your chosen provider",
  "hero.metaPrivacySub": "Your provider determines where requests are sent",
  "showcase.windowTitle": "Tiancode Studio · illustrative demo",
  "showcase.statusPill": "Interactive example · no AI execution",
  ...
  "cap.5.num": "05",
  "cap.5.title": "Local history in SQLite",
  "cap.5.desc": "Keep conversations on your device. The V2 core under development adds durable input admission; continuing after a crash requires an explicit action.",
  "cap.6.num": "06",
  "cap.6.title": "MCP Protocol & 120+ Active Skills",
  ...
  "arch.step4.desc": "Persisted history lets you review the session. A process interruption does not automatically retry provider work.",
  ...
  "dl.installerBtn": "Download Tiancode.exe (~345 MB)",
  ...
  "cap.c1.desc": "Delegate work to specialists with defined tools and permissions. Review their results in the conversation and use worktrees when your project needs isolated changes.",
  ...
  "cap.c2.desc": "Download GGUF models from Hugging Face and run them with the local engine. Acceleration and available context depend on the model, memory and hardware.",
  "cap.c2.tag1": "HuggingFace GGUF",
  "cap.c2.tag2": "Ollama & LM Studio",
  ...
  "cap.c4.title": "Local history and V2 core development",
  "cap.c4.desc": "Desktop uses the V1 server. The repository includes a V2 core under development that persists inputs before waking its coordinator. Recovering execution after a crash requires explicit continuation.",
  "cap.c4.tag1": "Effect-TS Runtime",
  "cap.c4.tag2": "SQLite Transaction Log",
  "cap.c4.tag3": "Explicit continuation",
  ...
  "benchmarks.eyebrow": "Version 1.0.0",
  "benchmarks.title": "What changes in this release",
  "benchmarks.sub": "Features connected to real work, with fixes and tests available in the repository.",
  "bench.nav.swe": "Models and specialists",
  "bench.nav.lat": "Live preview",
  "bench.nav.tok": "Chat controls",
  "bench.nav.off": "Updates",
  "bench.stat1Label": "Verified task resolution rate on real-world software engineering issues.",
  "bench.stat2Label": "Installer and portable for Windows x64.",
  "bench.stat3Label": "Metadata and binaries verified before publishing.",
  "architecture.eyebrow": "Engineering",
  "architecture.title": "Local history and coordinated execution",
  "architecture.sub": "A pure TypeScript monorepo powered by Bun, Effect-TS, SolidJS, and SQLite.",
  "arch.blockTitle": "Persistence with clear boundaries",
  "arch.blockP1": "Tiancode Desktop stores conversations and configuration on your device and uses the V1 server. The repository also includes a V2 core under development, with a session coordinator and durable input admission.",
  "arch.blockP2": "In V2, inputs are saved in SQLite before the coordinator is activated. New instructions are incorporated at safe turn boundaries, and queued inputs wait until the session is available. After a process crash, provider work requires explicit continuation.",
  ...
  "downloads.installerF1": "Automatic non-destructive updates (v1.0.39+)",
  ...
  "footer.skills": "120+ Skills Catalog",
