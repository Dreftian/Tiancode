...
import { registerTiancodeTheme } from "@tiancode-ai/ui/context/marked-theme-register"

registerTiancodeTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for Tiancode, as I think 8 might be
