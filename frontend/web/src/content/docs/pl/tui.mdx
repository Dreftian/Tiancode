---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala tiancode.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

tiancode zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie tiancode uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI tiancode, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do tiancode. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij tiancode. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `tiancode.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Tiancode czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `tiancode.default`.
