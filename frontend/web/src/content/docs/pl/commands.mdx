...
Utwórz `.tiancode/commands/test.md`:
...
Możesz zdefiniować polecenia w `tiancode.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji tiancode:
...
- Globalnie: `~/.config/tiancode/commands/`
- Na projekt: `.tiancode/commands/`
...
tiancode zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
