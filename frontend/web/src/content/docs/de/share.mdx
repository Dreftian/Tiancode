---
title: Teilen
description: Teile Tiancode-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Tiancode-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Tiancode Folgendes:
...
Tiancode hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Tiancode den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`tiancode.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du tiancode in deiner Organisation einsetzt.
