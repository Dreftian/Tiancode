...
Erstellen Sie `.tiancode/commands/test.md`:
...
Sie können benutzerdefinierte Befehle über die Tiancode-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Tiancode [config](/docs/config):
...
Tiancode enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
