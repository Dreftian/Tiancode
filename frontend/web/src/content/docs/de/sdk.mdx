---
title: SDK
description: Typsicherer JS-Client fuer den tiancode-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das tiancode JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und tiancode programmatisch steuern.
...
Erstelle eine tiancode-Instanz:
...
`tiancode.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn tiancode bereits laeuft, kannst du nur einen Client erstellen und verbinden:
