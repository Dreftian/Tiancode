---
title: SDK
description: Type-safe JS client for tiancode server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The tiancode JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control tiancode programmatically.
...
Create an instance of tiancode:
...
You can pass a configuration object to customize behavior. The instance still picks up your `tiancode.json`, but you can override or add configuration inline:
...
If you already have a running instance of tiancode, you can create a client instance to connect to it:
