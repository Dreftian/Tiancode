---
title: TUI
description: Korištenje korisničkog interfejsa Tiancode terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Tiancode pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Tiancode pokreće TUI za trenutni direktorij.
...
Kada koristite Tiancode TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Tiancode. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Tiancode. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `tiancode.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Tiancode čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `tiancode.default`.
