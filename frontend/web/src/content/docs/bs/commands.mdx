...
Kreiraj `.tiancode/commands/test.md`:
...
Možete dodati prilagođene komande kroz Tiancode konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Tiancode [config](/docs/config):
...
- Globalno: `~/.config/tiancode/commands/`
- Po projektu: `.tiancode/commands/`
...
Tiancode uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
