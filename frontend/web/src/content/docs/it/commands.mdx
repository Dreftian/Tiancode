...
Crea `.tiancode/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Tiancode o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Tiancode:
...
- Globale: `~/.config/tiancode/commands/`
- Per progetto: `.tiancode/commands/`
...
tiancode include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
