...
Crear `.tiancode/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Tiancode o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Tiancode [config](/docs/config):
...
- Por proyecto: `.tiancode/commands/`
...
tiancode incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
