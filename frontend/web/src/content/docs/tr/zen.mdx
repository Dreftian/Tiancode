---
title: Zen
description: tiancode tarafından sağlanan seçilmiş modeller listesi.
---
...
Tiancode Zen, Tiancode ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Tiancode'daki diğer sağlayıcılar gibi çalışır. Tiancode Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Tiancode kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Tiancode ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Tiancode Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Tiancode Zen, Tiancode'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Tiancode Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Tiancode Zen'i seçin ve API anahtarınızı yapıştırın.
...
Tiancode yapılandırmanızdaki [model id](/docs/config/#models) `tiancode/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `tiancode/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. Tiancode, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Tiancode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Tiancode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Laguna S 2.1 Free, sınırlı bir süre için Tiancode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Ling-3.0-flash Free, sınırlı bir süre için Tiancode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- LongCat-2.0 Free, sınırlı bir süre için Tiancode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Tiancode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Tiancode'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Tiancode'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Tiancode Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Tiancode ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
