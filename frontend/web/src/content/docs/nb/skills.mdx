...
Agentferdigheter lar Tiancode oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går tiancode opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
tiancode viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `tiancode.json`:
