---
title: LSP-servere
description: tiancode integreres med LSP-serverne dine.
---

Tiancode kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Tiancode kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `TIANCODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og tiancode åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Tiancode-konfigurasjonen.
