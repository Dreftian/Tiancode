...
Opprett `.tiancode/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Tiancode-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Tiancode [config](/docs/config):
...
- Per prosjekt: `.tiancode/commands/`
...
Tiancode inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
