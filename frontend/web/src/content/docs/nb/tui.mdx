---
title: TUI
description: Bruke tiancode-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Tiancode gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Tiancode starter TUI for gjeldende katalog.
...
Når du bruker Tiancode TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Tiancode. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Tiancode. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `tiancode.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Tiancode venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `tiancode.default`.
