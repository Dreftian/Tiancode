...
สร้าง `.tiancode/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Tiancode:
...
- ระดับผู้ใช้ (Global): `~/.config/tiancode/commands/`
- ระดับโปรเจ็กต์: `.tiancode/commands/`
...
Tiancode มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
