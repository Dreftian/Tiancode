---
title: TUI
description: Brug af Tiancode-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Tiancode giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Tiancode starter TUI for den nuværende mappe.
...
Når du bruger Tiancode TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Tiancode. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Tiancode. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `tiancode.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Tiancode venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `tiancode.default`.
