...
Brug den til at bygge integrasjoner og kontrollere tiancode programmatisk.
...
Opret en forekomst av tiancode:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `tiancode.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av tiancode, kan du oprete en klientforekomst for at koble til den:
