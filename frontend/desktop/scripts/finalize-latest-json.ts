...
const releaseId = process.env.TIANCODE_RELEASE
if (!releaseId) throw new Error("TIANCODE_RELEASE is required")

const version = process.env.TIANCODE_VERSION
if (!version) throw new Error("TIANCODE_VERSION is required")
...
const macxTarGz = "tiancode-desktop-mac-x64.app.tar.gz"
const macaTarGz = "tiancode-desktop-mac-arm64.app.tar.gz"
