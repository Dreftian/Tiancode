export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Tiancode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Tiancode is gedownload. Wil je deze installeren en Tiancode opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'tiancode' te gebruiken.",
