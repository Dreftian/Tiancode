export const dict = {
  ...
  "desktop.updater.none.message": "Tiancode'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Tiancode'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'tiancode' komutunu kullanmak için terminalinizi yeniden başlatın.",
