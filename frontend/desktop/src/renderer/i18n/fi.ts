export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Tiancoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Tiancoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Tiancoden uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'tiancode'-komentoa.",
