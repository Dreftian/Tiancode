export const dict = {
  ...
  "desktop.updater.none.message": "Artıq Tiancode-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "Tiancode-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'tiancode' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
