export const dict = {
  ...
  "desktop.updater.none.message": "تسی پہلے ای Tiancode دا تازہ ترین ورژن استعمال کر رئے او",
  ...
  "desktop.updater.downloaded.prompt":
    "Tiancode دا ورژن {{version}} ڈاؤن لوڈ کر دتا گیا اے، کی تسی اینوں انسٹال کرنا تے دوبارہ لانچ کرنا چاہندے او؟",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} تے انسٹال کیتا گیا\n\n'tiancode' کمانڈ ورتن لئی اپنے ٹرمینل نوں دوبارہ شروع کرو۔",
