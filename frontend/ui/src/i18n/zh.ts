...
export const dict = {
  ...
  "ui.documentViewer.loading": "正在加载文档...",
  "ui.documentViewer.error": "无法渲染文档",
  "ui.documentViewer.zoomIn": "放大",
  "ui.documentViewer.zoomOut": "缩小",
  "ui.documentViewer.pages": "{{current}} / {{total}}",
  "ui.documentViewer.previousPage": "上一页",
  "ui.documentViewer.nextPage": "下一页",
  "ui.documentViewer.pageLabel": "第 {{page}} 页",
  "ui.documentViewer.sheet": "工作表",
  ...
  "dialog.usageExceeded.freeTier.description": "订阅 Tiancode Go，可靠地使用最佳开源模型，每月 $5 起。",
