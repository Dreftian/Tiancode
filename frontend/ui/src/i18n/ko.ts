export const dict = {
  ...
  "ui.promptInput.effort.description": "노력 수준이 높을수록 더 완전한 답변을 제공하지만 시간이 더 걸리고 사용 한도를 더 빨리 소모합니다.",
  "ui.promptInput.effort.help": "노력 수준 정보",
  "ui.promptInput.effort.ultracodeUnavailable": "Ultracode는 Claude 및 OpenAI 추론 모델에서 사용할 수 있습니다. 다른 공급자는 자체 노력 수준을 유지합니다.",
  "ui.promptInput.effort.faster": "더 빠르게",
  "ui.promptInput.effort.deeper": "더 똑똑하게",
  "ui.promptInput.effort.default": "자동",
  "ui.promptInput.effort.none": "없음",
  "ui.promptInput.effort.minimal": "최소",
  "ui.promptInput.effort.low": "낮음",
  "ui.promptInput.effort.medium": "중간",
  "ui.promptInput.effort.high": "높음",
  "ui.promptInput.effort.xhigh": "매우 높음",
  "ui.promptInput.effort.max": "최대",
  ...
  "ui.documentViewer.loading": "문서를 불러오는 중...",
  "ui.documentViewer.error": "문서를 렌더링할 수 없습니다",
  "ui.documentViewer.zoomIn": "확대",
  "ui.documentViewer.zoomOut": "축소",
  "ui.documentViewer.pages": "{{current}} / {{total}}",
  "ui.documentViewer.previousPage": "이전 페이지",
  "ui.documentViewer.nextPage": "다음 페이지",
  "ui.documentViewer.pageLabel": "페이지 {{page}}",
  "ui.documentViewer.sheet": "시트",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Tiancode Go를 구독하여 최고의 오픈 소스 모델에 안정적으로 액세스하세요. 월 $5부터 시작합니다.",
