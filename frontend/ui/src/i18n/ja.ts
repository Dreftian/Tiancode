export const dict = {
  "ui.promptInput.addFolder": "フォルダーを追加",
  "ui.promptInput.sendStay": "送信してここに留まる",
  "ui.promptInput.working": "AI が作業中",
  "ui.promptInput.effort.title": "エフォート",
  "ui.promptInput.effort.description": "エフォートを上げるとより完全な回答になりますが、時間がかかり、利用上限を早く消費します。",
  "ui.promptInput.effort.help": "エフォートについて",
  "ui.promptInput.effort.ultracodeUnavailable": "Ultracode は Claude と OpenAI の推論モデルで利用できます。その他のプロバイダーは独自のエフォートレベルを使用します。",
  "ui.promptInput.effort.faster": "速い",
  "ui.promptInput.effort.deeper": "賢い",
  "ui.promptInput.effort.default": "自動",
  "ui.promptInput.effort.none": "なし",
  "ui.promptInput.effort.minimal": "最小",
  "ui.promptInput.effort.low": "低",
  "ui.promptInput.effort.medium": "中",
  "ui.promptInput.effort.high": "高",
  "ui.promptInput.effort.xhigh": "特高",
  "ui.promptInput.effort.max": "最大",
  ...
  "ui.documentViewer.loading": "ドキュメントを読み込み中...",
  "ui.documentViewer.error": "ドキュメントをレンダリングできませんでした",
  "ui.documentViewer.zoomIn": "拡大",
  "ui.documentViewer.zoomOut": "縮小",
  "ui.documentViewer.pages": "{{current}} / {{total}}",
  "ui.documentViewer.previousPage": "前のページ",
  "ui.documentViewer.nextPage": "次のページ",
  "ui.documentViewer.pageLabel": "ページ {{page}}",
  "ui.documentViewer.sheet": "シート",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Tiancode Go にサブスクライブして、最高のオープンソースモデルに安定してアクセスできます。月額 $5 から。",
