export const dict = {
  "ui.promptInput.addFolder": "Добавить папку",
  "ui.promptInput.sendStay": "Отправить и остаться здесь",
  "ui.promptInput.working": "ИИ работает",
  "ui.promptInput.effort.title": "Усилие",
  "ui.promptInput.effort.description": "Чем выше усилие, тем полнее ответы, но они занимают больше времени и быстрее расходуют лимиты.",
  "ui.promptInput.effort.help": "Об усилии",
  "ui.promptInput.effort.ultracodeUnavailable": "Ultracode доступен для моделей с рассуждениями от Claude и OpenAI. Остальные провайдеры сохраняют собственные уровни усилия.",
  "ui.promptInput.effort.faster": "Быстрее",
  "ui.promptInput.effort.deeper": "Умнее",
  "ui.promptInput.effort.default": "Авто",
  "ui.promptInput.effort.none": "Нет",
  "ui.promptInput.effort.minimal": "Минимальное",
  "ui.promptInput.effort.low": "Низкое",
  "ui.promptInput.effort.medium": "Среднее",
  "ui.promptInput.effort.high": "Высокое",
  "ui.promptInput.effort.xhigh": "Очень высокое",
  "ui.promptInput.effort.max": "Максимум",
  ...
  "ui.documentViewer.loading": "Загрузка документа...",
  "ui.documentViewer.error": "Не удалось отобразить документ",
  "ui.documentViewer.zoomIn": "Увеличить",
  "ui.documentViewer.zoomOut": "Уменьшить",
  "ui.documentViewer.pages": "{{current}} / {{total}}",
  "ui.documentViewer.previousPage": "Предыдущая страница",
  "ui.documentViewer.nextPage": "Следующая страница",
  "ui.documentViewer.pageLabel": "Страница {{page}}",
  "ui.documentViewer.sheet": "Лист",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Подпишитесь на Tiancode Go для надёжного доступа к лучшим моделям с открытым исходным кодом, от $5/месяц.",
