export const dict: Record<string, string> = {
  ...
  "ui.promptInput.effort.description": "Higher effort means more complete responses, but takes longer and uses your limits faster.",
  "ui.promptInput.effort.help": "About effort",
  "ui.promptInput.effort.ultracodeUnavailable": "Ultracode is available with Claude and OpenAI reasoning models. Other providers keep their own effort levels.",
  "ui.promptInput.effort.faster": "Faster",
  "ui.promptInput.effort.deeper": "Smarter",
  "ui.promptInput.effort.default": "Auto",
  "ui.promptInput.effort.none": "None",
  "ui.promptInput.effort.minimal": "Minimal",
  "ui.promptInput.effort.low": "Low",
  "ui.promptInput.effort.medium": "Medium",
  "ui.promptInput.effort.high": "High",
  "ui.promptInput.effort.xhigh": "Extra",
  "ui.promptInput.effort.max": "Max",
  ...
  "ui.documentViewer.loading": "Loading document...",
  "ui.documentViewer.error": "Could not render the document",
  "ui.documentViewer.zoomIn": "Zoom in",
  "ui.documentViewer.zoomOut": "Zoom out",
  "ui.documentViewer.pages": "{{current}} / {{total}}",
  "ui.documentViewer.previousPage": "Previous page",
  "ui.documentViewer.nextPage": "Next page",
  "ui.documentViewer.pageLabel": "Page {{page}}",
  "ui.documentViewer.sheet": "Sheet",
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscribe to Tiancode Go for reliable access to the best open-source models, starting at $5/month.",
