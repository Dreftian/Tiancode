...
import { TIANCODE_BASE_MODE, useBindings, useCommandShortcut, useOpencodeKeymap } from "../../keymap"
...
const GO_UPSELL_PROVIDERS = new Set(["tiancode", "tiancode-go"])
    ...
    <>
      <For each={props.parts}>
        {(part, index) => {
          ...
          return (
            <Show when={component()}>
              {/* The guard above guarantees `part` is one of the three mapped variants. */}
              <Dynamic
                last={index() === props.parts.length - 1}
                component={component()}
                part={part as TextPart & ToolPart & ReasoningPart}
