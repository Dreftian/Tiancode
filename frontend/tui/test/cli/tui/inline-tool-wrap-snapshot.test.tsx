...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "TIANCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/tiancode/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/tiancode (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/tiancode/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/tiancode/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const TIANCODE_DB|TIANCODE_DB|TIANCODE_DEV|Global\\.Path\\.data|data =" in packages/tiancode/src (115 matches)',
  },
] as const
