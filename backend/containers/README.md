...
```
REGISTRY=ghcr.io/anomalyco TAG=24.04 bun ./backend/containers/script/build.ts
REGISTRY=ghcr.io/anomalyco TAG=24.04 bun ./backend/containers/script/build.ts --push
```
