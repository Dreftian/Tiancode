import { Tiancode } from "@tiancode-ai/client/effect"
...
import { createEmbeddedRoutes } from "@tiancode-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Tiancode.create")(function* () {
  ...
  const client = yield* Tiancode.make({ baseUrl: "http://tiancode.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@tiancode-ai/sdk-next/Tiancode") {}
