...
import type {
  ...
  GithubConnectResponses,
  GithubCreateRepoErrors,
  GithubCreateRepoPayload,
  GithubCreateRepoResponses,
  GithubDisconnectErrors,
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Tiancode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Tiancode system.
   */
...
export class Capabilities extends HeyApiClient {
   ...
   *
   * Get experimental features enabled on the Tiancode server.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Tiancode state.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Tiancode configuration settings and preferences.
   */
   ...
   *
   * Update global Tiancode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      config?: Config3
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Tiancode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Tiancode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Tiancode instances, releasing all resources.
   */
   ...
   * Upgrade tiancode
   *
   * Upgrade tiancode to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Tiancode configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Tiancode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Github extends HeyApiClient {
   ...
   *
   * Validate a GitHub personal access token and store it for authenticated git operations.
   */
  public connect<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      githubConnectPayload?: GithubConnectPayload
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { key: "githubConnectPayload", map: "body" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<GithubConnectResponses, GithubConnectErrors, ThrowOnError>({
      url: "/github/connect",
      ...options,
      ...params,
      headers: {
   ...
   *
   * Report whether a GitHub account is connected. An invalid or expired token is removed.
   */
  public status<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
  ...
  public disconnect<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<GithubDisconnectResponses, GithubDisconnectErrors, ThrowOnError>({
   ...
   *
   * List the authenticated user's repositories, optionally filtered by a search query.
   */
  public repos<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<GithubReposResponses, GithubReposErrors, ThrowOnError>({
      url: "/github/repos",
      ...options,
      ...params,
    })
   ...
   */
  public createRepo<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      githubCreateRepoPayload?: GithubCreateRepoPayload
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
      ...
      [
        {
          args: [
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { key: "githubCreateRepoPayload", map: "body" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<GithubCreateRepoResponses, GithubCreateRepoErrors, ThrowOnError>({
      url: "/github/repos",
      ...options,
      ...params,
      headers: {
...
export class Project extends HeyApiClient {
   ...
   * Clone project
   *
   * Clone a git repository into the local repos directory and register it as a project.
   */
      ...
      [
        {
          args: [
            { in: "query", key: "directory" },
            { in: "query", key: "workspace" },
            { key: "cloneProjectPayload", map: "body" },
          ],
        },
      ],
    )
    return (options?.client ?? this.client).post<ProjectCloneResponses, ProjectCloneErrors, ThrowOnError>({
      url: "/project/clone",
      ...options,
      ...params,
      headers: {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Tiancode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Tiancode is working with.
   */
...
export class Vcs extends HeyApiClient {
   ...
   * Commit changes
   *
   * Stage all changes and create a commit in the target directory.
   */
  public commit<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
      workspace?: string
      vcsCommitPayload?: VcsCommitPayload
    },
    options?: Options<never, ThrowOnError>,
  ) {
    const params = buildClientParams(
   ...
   * Get remote URL
   *
   * Report the origin remote URL of the target directory.
   */
  public remote<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<VcsRemoteResponses, VcsRemoteErrors, ThrowOnError>({
      url: "/vcs/remote",
      ...options,
      ...params,
    })
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Tiancode instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Tiancode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Mcp extends HeyApiClient {
  ...
  /**
   * Remove an MCP server and persist the removal in config.
   */
  public remove<ThrowOnError extends boolean = false>(
    parameters: {
      name: string
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Tiancode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Tiancode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Tiancode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Tiancode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Interrupt active execution owned by this Tiancode process. Idle interruption is a no-op.
   */
