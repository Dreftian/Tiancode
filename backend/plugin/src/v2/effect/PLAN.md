...
- Effect plugins import `@tiancode-ai/plugin/v2/effect`, not `@tiancode-ai/core`.
- Public domain values use generated `@tiancode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@tiancode-ai/plugin/v2/effect`.
