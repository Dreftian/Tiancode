...
import { compile, emitEffectImported, emitPromise, write } from "@tiancode-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "TiancodeEventEncoded",
              import: 'import type { TiancodeEventEncoded } from "@tiancode-ai/protocol/groups/event"',
            },
          },
        }),
