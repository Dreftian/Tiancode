...
import compareVideo from "../../asset/lander/tiancode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/tiancode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="tiancode:auth" content={loggedin() ? "true" : "false"} />
