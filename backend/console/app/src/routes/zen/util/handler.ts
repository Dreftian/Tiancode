...
import { and, Database, eq, isNull, lt, or, sql } from "@tiancode-ai/console-core/drizzle/index.js"
import { KeyTable } from "@tiancode-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@tiancode-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@tiancode-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@tiancode-ai/console-core/util/date.js"
import { Identifier } from "@tiancode-ai/console-core/identifier.js"
import { Billing } from "@tiancode-ai/console-core/billing.js"
import { Actor } from "@tiancode-ai/console-core/actor.js"
import { WorkspaceTable } from "@tiancode-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@tiancode-ai/console-core/model.js"
import { Subscription } from "@tiancode-ai/console-core/subscription.js"
import { BlackData } from "@tiancode-ai/console-core/black.js"
import { UserTable } from "@tiancode-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@tiancode-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@tiancode-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@tiancode-ai/console-core/lite.js"
import { Resource } from "@tiancode-ai/console-resource"
...
import { Workspace } from "@tiancode-ai/console-core/workspace.js"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-tiancode-session") ?? ""
    const requestId = input.request.headers.get("x-tiancode-request") ?? ""
    const ocClient = input.request.headers.get("x-tiancode-client") ?? ""
    const projectId = input.request.headers.get("x-tiancode-project") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWithRetryableStatus(
        reqUrl,
        {
          ...
          headers: (() => {
            ...
            headers.delete("x-tiancode-request")
            headers.delete("x-tiancode-session")
            headers.delete("x-tiancode-project")
            headers.delete("x-tiancode-client")
            return headers
          })(),
          body: reqBody,
      ...
      if (isNewInference) {
        const resEndpointId = res.headers.get("x-tiancode-endpoint-id")
        const resEndpointModelId = res.headers.get("x-tiancode-upstream-model-id")
