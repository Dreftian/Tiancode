import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@tiancode-ai/sdk/v2"
import { SessionTurn } from "@tiancode-ai/session-ui/session-turn"
import { SessionReview } from "@tiancode-ai/session-ui/session-review"
import { DataProvider } from "@tiancode-ai/session-ui/context"
import { FileComponentProvider } from "@tiancode-ai/ui/context/file"
import { WorkerPoolProvider } from "@tiancode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@tiancode-ai/ui/logo"
import { IconButton } from "@tiancode-ai/ui/icon-button"
import { ProviderIcon } from "@tiancode-ai/ui/provider-icon"
import { iife } from "@tiancode-ai/core/util/iife"
...
import { MessageNav } from "@tiancode-ai/session-ui/message-nav"
import { FileSSR } from "@tiancode-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@tiancode-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/tiancode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | Tiancode</Title>
              </Show>
              <Meta name="description" content="tiancode - The AI coding agent built for the terminal." />
