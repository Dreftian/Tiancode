...
declare const TIANCODE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof TIANCODE_CLI_NAME === "string" ? TIANCODE_CLI_NAME : "tiancode", {
  description: "Tiancode 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
