...
const en = {
  "app.title": "AI Model Usage Rankings | Tiancode Data",
  "app.description":
    "Explore Tiancode Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Tiancode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Tiancode on GitHub",
  "header.github": "GitHub",
  "header.tryTiancode": "Try Tiancode",
  ...
  "home.topModelsDescription": "Usage of models across Tiancode Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique Tiancode Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Tiancode Data",
  "lab.description":
    "Compare {{lab}} models used in Tiancode Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Tiancode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Tiancode",
  ...
  "lab.shareOfUsage": "{{share}} of recent Tiancode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Tiancode Data",
  "model.description":
    "View {{model}} Tiancode Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Tiancode Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Tiancode Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's Tiancode Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Tiancode Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Tiancode Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "Tiancode Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No Tiancode Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent Tiancode Go token volume.",
