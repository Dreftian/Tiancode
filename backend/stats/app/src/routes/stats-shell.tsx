import tiancodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const themeStorageKey = "tiancode:stats-theme"
      ...
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://opencode.ai/">
            <strong>{i18n.t("header.tryTiancode")}</strong>
          </a>
          <button
...
function TiancodeMark() {
  return (
    <svg data-slot="tiancode-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const connect = [
    ...
    { href: "https://x.com/tiancode", label: "X" },
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={tiancodeWordmarkDark} alt="Tiancode" />
          <button
