export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Tiancode Data",
  "app.description":
    "Tiancode Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Tiancode Data logosu",
  ...
  "header.githubAria": "GitHub'da Tiancode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryTiancode": "Tiancode'u dene",
  ...
  "footer.homeAria": "Tiancode ana sayfası",
  ...
  "home.topModelsDescription": "Tiancode Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Tiancode Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Tiancode Data",
  "lab.description":
    "Tiancode Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Tiancode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Tiancode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Tiancode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Tiancode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Tiancode Data",
  "model.description":
    "{{model}} için Tiancode Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Tiancode Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki Tiancode Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Tiancode Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Tiancode Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son Tiancode Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Tiancode Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Tiancode Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Tiancode Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Tiancode Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan Tiancode Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen Tiancode Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son Tiancode Go token hacmine göre yakındaki modeller.",
