export const dict = {
  "app.title": "Rankingi użycia modeli AI | Tiancode Data",
  "app.description":
    "Przeglądaj użycie Tiancode Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Tiancode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Tiancode na GitHub",
  "header.github": "GitHub",
  "header.tryTiancode": "Wypróbuj Tiancode",
  ...
  "footer.homeAria": "Strona główna Tiancode",
  ...
  "home.topModelsDescription": "Użycie modeli w Tiancode Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Tiancode Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Tiancode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Tiancode Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Tiancode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Tiancode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Tiancode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Tiancode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Tiancode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Tiancode Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Tiancode Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Tiancode Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Tiancode Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Tiancode Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Tiancode Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Tiancode Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Tiancode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Tiancode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Tiancode Go.",
  ...
  "model.geoDescription": "Tokeny modelu Tiancode Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne Tiancode Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Tiancode Go.",
