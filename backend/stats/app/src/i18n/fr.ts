export const dict = {
  "app.title": "Classements d'utilisation des modèles d'IA | Tiancode Data",
  "app.description":
    "Explorez l'utilisation d'Tiancode Go par modèle d'IA, avec le volume de tokens, les classements, la part de marché, le prix des tokens, le coût par session, le taux de cache et les répartitions géographiques.",
  "app.unfurlAlt": "Logo textuel Tiancode Data sur un fond sombre à motif",
  ...
  "header.githubAria": "Ajouter une étoile à Tiancode sur GitHub",
  "header.github": "GitHub",
  "header.tryTiancode": "Essayer Tiancode",
  ...
  "footer.homeAria": "Accueil Tiancode",
  ...
  "modal.title": "Newsletter Tiancode",
  ...
  "home.topModelsDescription": "Utilisation des modèles dans Tiancode Go.",
  ...
  "home.uniqueUsersDescription": "Utilisateurs uniques quotidiens d'Tiancode Go par modèle.",
  ...
  "lab.title": "Utilisation et classements des modèles d'IA {{lab}} | Tiancode Data",
  "lab.description":
    "Comparez les modèles {{lab}} utilisés dans Tiancode Go, avec l'utilisation des tokens, les classements de modèles, les fenêtres de contexte, les dates de sortie, les coûts et les données propres aux modèles.",
  "lab.loadingTitle": "Laboratoire de modèles",
  "lab.loadingDescription": "Lecture de la disponibilité des modèles et de l'utilisation récente d'Tiancode.",
  "lab.notFound": "Aucun modèle ne correspondait à ce laboratoire.",
  "lab.heroPrefix": "Explorez {{count}} modèles {{lab}} utilisés dans Tiancode",
  ...
  "lab.shareOfUsage": "{{share}} de l'utilisation récente d'Tiancode",
  "lab.usageTitle": "Utilisation des tokens {{lab}}",
  "lab.usageDescription": "Volume quotidien de tokens Tiancode sur les deux derniers mois.",
  ...
  "lab.share": "Part",
  "model.title": "Utilisation, coût et rang de {{model}} | Tiancode Data",
  "model.description":
    "Consultez les données d'utilisation Tiancode Go de {{model}}, avec le volume de tokens, le rang hebdomadaire, la répartition des tokens, les coûts, le taux de cache, les sessions, les répartitions géographiques et les modèles proches.",
  ...
  "model.catalogFallback":
    "Faits du modèle issus de l'index partagé des modèles. L'utilisation Tiancode Go apparaîtra dès que ce modèle aura de l'activité.",
  "model.unranked": "Non classé dans l'utilisation Tiancode Go de la semaine dernière",
  "model.ranked": "Classé #{{rank}} dans l'utilisation Tiancode Go de la semaine dernière",
  ...
  "model.noCurrentUsage": "Aucune utilisation Tiancode Go dans la fenêtre de données actuelle.",
  ...
  "model.overviewDescription": "Tokens Tiancode Go récents, utilisateurs uniques et position sur le marché.",
  "model.noSummaryTitle": "Aucun résumé d'utilisation",
  "model.noSummaryDescription": "Ce modèle n'a pas encore de lignes d'utilisation Tiancode Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume quotidien de tokens Tiancode Go sur la fenêtre récente de deux mois.",
  ...
  "model.usersDescription": "Utilisateurs uniques quotidiens d'Tiancode Go sur la fenêtre récente de deux mois.",
  ...
  "model.efficiencyDescription": "Coût, comportement du cache et forme moyenne des sessions Tiancode Go.",
  ...
  "model.geoDescription": "Tokens du modèle Tiancode Go utilisés par pays.",
  "model.noGeoTitle": "Aucune donnée géographique",
  "model.noGeoDescription": "Aucune ligne géographique Tiancode Go ne correspondait à ce modèle.",
  "model.worldMap": "Carte mondiale de l'utilisation des tokens du modèle par pays",
  "model.peersDescription": "Modèles proches par volume récent de tokens Tiancode Go.",
