...
export const TypeId: TypeId = "~@tiancode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@tiancode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@tiancode-ai/effect-sqlite-node/NodeSqliteClient")
