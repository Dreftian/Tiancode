...
Practical reference for the current tool-migration state in `backend/opencode`.
...
Tool tests should use the existing Effect helpers in `backend/opencode/test/lib/effect.ts`:
