...
import type { Definition } from "@tiancode-ai/schema/event"
...
export const TiancodeEvent = event.schema
export type TiancodeEvent = typeof TiancodeEvent.Type
export type TiancodeEventEncoded = typeof TiancodeEvent.Encoded
