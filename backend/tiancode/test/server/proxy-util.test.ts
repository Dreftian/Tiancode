...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips tiancode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-tiancode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-tiancode-directory")).toBeNull()
      expect(result.get("x-tiancode-workspace")).toBeNull()
