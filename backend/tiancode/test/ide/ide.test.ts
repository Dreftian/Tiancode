...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders TIANCODE_CALLER", () => {
    process.env["TIANCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode TIANCODE_CALLER", () => {
    process.env["TIANCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown TIANCODE_CALLER", () => {
    process.env["TIANCODE_CALLER"] = "unknown"
