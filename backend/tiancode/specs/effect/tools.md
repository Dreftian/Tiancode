...
Practical reference for the current tool-migration state in `backend/tiancode`.
...
Tool tests should use the existing Effect helpers in `backend/tiancode/test/lib/effect.ts`:
