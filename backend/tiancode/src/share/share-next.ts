...
import type * as SDK from "@tiancode-ai/sdk/v2"
...
import { SessionShareTable } from "@tiancode-ai/core/share/sql"
...
const disabled = process.env["TIANCODE_DISABLE_SHARE"] === "true" || process.env["TIANCODE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/ShareNext") {}
