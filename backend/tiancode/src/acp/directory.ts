...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@tiancode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@tiancode/ACPDirectory") {}
