...
import type { AssistantMessage as TiancodeAssistantMessage, Message } from "@tiancode-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@tiancode-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<TiancodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<TiancodeAssistantMessage, "role"> &
  Partial<Pick<TiancodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@tiancode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@tiancode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@tiancode/ACPUsage") {}
