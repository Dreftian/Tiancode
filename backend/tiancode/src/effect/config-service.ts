 ...
 *   "@tiancode/ServerAuthConfig",
 *   {
 *     password: Config.string("TIANCODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("TIANCODE_SERVER_USERNAME").pipe(Config.withDefault("tiancode")),
 *   },
 * ) {}
 *
