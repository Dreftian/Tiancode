...
>()("@tiancode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@tiancode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.TIANCODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.TIANCODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-tiancode-directory"] || process.cwd()
}
