...
import { AccountStateTable, AccountTable } from "@tiancode-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/AccountRepo") {}
