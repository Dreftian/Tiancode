...
import { ProjectDirectoryTable, ProjectTable } from "@tiancode-ai/core/project/sql"
import { ProjectDirectories } from "@tiancode-ai/core/project/directories"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.TIANCODE_FAKE_VCS)
