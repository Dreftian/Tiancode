...
import type { Event, GlobalEvent, OpencodeClient } from "@tiancode-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@tiancode/RunStreamTransport") {}
