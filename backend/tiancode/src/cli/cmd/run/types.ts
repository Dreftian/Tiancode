// Shared type vocabulary for the direct interactive mode (`tiancode --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@tiancode-ai/sdk/v2"
