...
//
// The saved variant persists across sessions in ~/.local/state/tiancode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@tiancode/RunVariant") {}
