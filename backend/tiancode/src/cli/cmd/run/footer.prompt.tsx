...
import { normalizePromptContent } from "@tiancode-ai/tui/editor"
...
import { TIANCODE_BASE_MODE, useBindings } from "@tiancode-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Tiancode" } satisfies SlashOption,
    ]
