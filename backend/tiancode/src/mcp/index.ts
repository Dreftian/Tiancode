...
import { McpEvent } from "@tiancode-ai/schema/mcp-event"
...
function createClient(directory: string) {
  const client = new Client({ name: "tiancode", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/MCP") {}
