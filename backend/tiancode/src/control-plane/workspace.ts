...
import { EventSequenceTable, EventTable } from "@tiancode-ai/core/event/sql"
...
import { WorkspaceEvent } from "@tiancode-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        TIANCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        TIANCODE_WORKSPACE_ID: config.id,
        TIANCODE_EXPERIMENTAL_WORKSPACES: "true",
