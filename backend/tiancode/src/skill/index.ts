...
const TIANCODE_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
const SKILL_PATTERN = "**/SKILL.md"

// Built-in skill that ships with tiancode. The model's intuition for what an
// tiancode.json should look like is often wrong, and tiancode hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch tiancode's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_TIANCODE_SKILL_NAME = "customize-tiancode"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/Skill") {}
