import type { JsonSchema, LLMRequest, ProviderMetadata } from "@tiancode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@tiancode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @tiancode-ai/llm request objects from tiancode's session/AI SDK-shaped data.
  return LLM.request({
