...
import { llmClient } from "@tiancode-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@tiancode-ai/llm"
import { LLMClient } from "@tiancode-ai/llm/route"
import type { LLMClientService } from "@tiancode-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via tiancode's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @tiancode-ai/llm. It
