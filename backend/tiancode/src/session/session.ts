...
import { Slug } from "@tiancode-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@tiancode-ai/llm"
...
import { locationServiceMapLayer } from "@tiancode-ai/core/location-services"
...
import { PartTable, SessionTable } from "@tiancode-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@tiancode-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".tiancode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/Session") {}
