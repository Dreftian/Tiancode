...
import type { Plugin as PluginRuntime } from "@tiancode-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/v2/Plugin") {}
