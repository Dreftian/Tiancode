...
import { PermissionSaved } from "@tiancode-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/v2/PermissionSaved") {}
