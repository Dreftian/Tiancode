...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@tiancode-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/v2/ToolRegistry") {}
