...
import { FileSystemWatcher } from "@tiancode-ai/schema/filesystem-watcher"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.TIANCODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.TIANCODE_EXPERIMENTAL_FILEWATCHER)) {
