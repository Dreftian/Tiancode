...
import constraint_driven_development from "../../../../../skills/constraint-driven-development.md" with { type: "text" }
...
import database_drizzle_sqlite_pg from "../../../../../skills/database-drizzle-sqlite-pg.md" with { type: "text" }
...
import docx_document_creation from "../../../../../skills/docx-document-creation.md" with { type: "text" }
...
import mcp_builder from "../../../../../skills/mcp-builder.md" with { type: "text" }
...
import security_sast_owasp from "../../../../../skills/security-sast-owasp.md" with { type: "text" }
import sentry_observability_and_fixes from "../../../../../skills/sentry-observability-and-fixes.md" with { type: "text" }
...
import stripe_payments_integration from "../../../../../skills/stripe-payments-integration.md" with { type: "text" }
import subagent_driven_development from "../../../../../skills/subagent-driven-development.md" with { type: "text" }
import supabase_postgres_best_practices from "../../../../../skills/supabase-postgres-best-practices.md" with { type: "text" }
...
import systematic_debugging from "../../../../../skills/systematic-debugging.md" with { type: "text" }
...
import vibe_coding_workflow from "../../../../../skills/vibe-coding-workflow.md" with { type: "text" }
...
export const builtinAgentSkills: Record<string, string> = {
  ...
  "constraint-driven-development": constraint_driven_development,
  "context-engineering": context_engineering,
  "core-web-vitals": core_web_vitals,
  "database-drizzle-sqlite-pg": database_drizzle_sqlite_pg,
  ...
  "docx-document-creation": docx_document_creation,
  ...
  "security-sast-owasp": security_sast_owasp,
  "sentry-observability-and-fixes": sentry_observability_and_fixes,
  ...
  "stripe-payments-integration": stripe_payments_integration,
  "subagent-driven-development": subagent_driven_development,
  "supabase-postgres-best-practices": supabase_postgres_best_practices,
  ...
  "vibe-coding-workflow": vibe_coding_workflow,
