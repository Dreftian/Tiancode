...
import type { Data, Definition, Payload } from "@tiancode-ai/schema/event"
...
import { Durable } from "@tiancode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@tiancode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@tiancode-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/Event") {}
