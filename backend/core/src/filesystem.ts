...
import { Entry, FileSystem, FindInput, Match } from "@tiancode-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@tiancode-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/v2/FileSystem") {}
