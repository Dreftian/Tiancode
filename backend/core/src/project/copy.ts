...
import { Event } from "@tiancode-ai/schema/project-directories"
import { ProjectCopy } from "@tiancode-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@tiancode/ProjectCopy") {}
