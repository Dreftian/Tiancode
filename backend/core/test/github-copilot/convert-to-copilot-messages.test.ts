import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@tiancode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
