...
import { ProviderPlugins } from "@tiancode-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@tiancode-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://tiancode.vercel.app/", "X-Title": "tiancode" })
