...
class Database extends Context.Service<Database, DatabaseShape>()("@tiancode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@tiancode/example/UserStore") {
