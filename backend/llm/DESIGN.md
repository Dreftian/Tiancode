...
> current private `@tiancode-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@tiancode-ai/ai`
...
- Secondary audience: Tiancode and other durable agent runtimes
...
import { LLM } from "@tiancode-ai/ai"
import { OpenAI } from "@tiancode-ai/ai/providers/openai"
...
```ts
import { Message } from "@tiancode-ai/ai"
...
import { LLM, Tool } from "@tiancode-ai/ai"
...
Tiancode and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@tiancode-ai/ai/promise"
import { OpenAI } from "@tiancode-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@tiancode-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@tiancode-ai/ai/provider"
...
@tiancode-ai/ai/promise
  Promise/AsyncIterable LLM facade

@tiancode-ai/ai/schema
  serializable domain schemas

@tiancode-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@tiancode-ai/ai/providers/openai
@tiancode-ai/ai/providers/anthropic
@tiancode-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@tiancode-ai/llm`                      | `@tiancode-ai/ai`                                           |
...
Tiancode should migrate to `generateTurn` / `streamTurn`, preserving its durable
