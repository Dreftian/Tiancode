...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@tiancode-ai/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@tiancode-ai/llm/route"
import { OpenAI } from "@tiancode-ai/llm/providers"

/**
 * A runnable walkthrough of the LLM package use-site API.
 *
 * Run from `backend/llm` with an OpenAI key in the environment:
 *
