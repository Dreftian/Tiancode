...
export const I18N = {
  ...
  "page.description": "Tiancode v1.0.38: Estudio de desarrollo local-first para Windows con enjambre de agentes autónomos, Conexiones Gateway (WhatsApp/Telegram/Discord/Slack), resiliencia OpenClaw, memoria Hermes Agent, motor OpenDesign y Sandbox Keep-Alive.",
  "loader.text": "Cargando Tiancode v1.0.38…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.38 · Agente de IA local-first",
  "hero.tagline": "Tu asistente de IA para programar, directo en tu terminal.",
  "hero.sub": "Agentes de IA con OpenClaw y Hermes, Conexiones Gateway, OpenDesign UI, Sandbox Keep-Alive, 52+ skills y modelos locales GGUF en Windows.",
  "hero.ctaDownload": "Descargar Tiancode.exe (v1.0.38)",
  ...
  "preview.sub": "Así se ve Tiancode v1.0.38: Live Preview con Sandbox Keep-Alive, Inspector DOM interactivo, terminal integrada, Conexiones Gateway y skills.",
  ...
  "stats.sub": "Datos reales de la versión 1.0.38.",
  ...
  "docs.s1p": "Tiancode 1.0.38 se distribuye en dos formatos para Windows 10 y 11 (64 bits):",
  ...
  "guide.s1d": "Elige el instalador NSIS (~375 MB) o la versión portable (~375 MB) desde la página de descarga. La versión 1.0.38 soporta Windows 10 y 11.",
  ...
  "news.sub": "Todo lo que trae Tiancode v1.0.38: Conexiones Gateway, Resiliencia OpenClaw, Memoria Hermes Agent, OpenDesign UI y Sandbox Keep-Alive.",
  "news.v1": "Versión 1.0.38",
  "news.date": "6 de septiembre de 2026",
  "news.chip": "Última versión",
  "news.newTitle": "Novedades Principales",
  "news.new1": "Conexiones (Messaging & API Gateway): Vincula WhatsApp (código interactivo TIAN-XXXX-WAPP), Telegram Bot (pairing y test ping en vivo), Discord (webhooks/bot), Slack y Webhooks personalizados con firma HMAC-SHA256.",
  "news.new2": "Resiliencia OpenClaw: Reparación sintáctica automática de llamadas a herramientas (JSON auto-repair) y detector avanzado de bucles infinitos con SHA-256 (circuit breaker inteligente a 25 llamadas repetitivas).",
  "news.new3": "Inteligencia y Memoria Hermes Agent: Búsqueda histórica profunda en SQLite (session_search), compactación de contexto con protección Head/Tail y scrubber streaming para modelos de razonamiento <think> (DeepSeek R1 / Qwen QwQ).",
  "news.new4": "OpenDesign & Claude Design UI Engine: Habilidades anti-clichés de IA, calibración previa de gusto con 3 diales (DESIGN_VARIANCE, MOTION_INTENSITY, VISUAL_DENSITY) y física táctil de micro-interacciones (Emil Kowalski).",
  "news.new5": "Sandbox Keep-Alive & Inspector DOM: 100% retención de estado, inputs y scroll al alternar entre Código y Vista Previa sin recarga del iframe, Inspector DOM interactivo (Ctrl+Alt+I) con cotas en píxeles y botón 1-click 'Reparar con Tiancode'.",
  "news.new6": "Presets de Diseño Canónicos: 4 presets de interfaz (Linear Dark, Claude Editorial, Vercel Precision, Stripe Modern) y disciplina tipográfica estricta de 3 pesos con tracking negativo para títulos.",
  "news.impTitle": "Mejoras",
  "news.imp1": "Actualizaciones automáticas no destructivas (v1.0.38+): preserva todas tus claves de proveedores, configuraciones y sesiones intactas.",
  "news.imp2": "Terminal integrada ultra-rápida con terminación limpia de árboles de procesos PTY y soporte para múltiples shells.",
  "news.imp3": "Extracción y aislamiento en streaming de bloques de razonamiento en modelos DeepSeek y Qwen sin saturar el historial visible.",
  "news.imp4": "Optimización del Live Preview con detección automática de pantalla blanca y sugerencias de corrección asistida.",
  "news.imp5": "Ecosistema de 52+ skills de ingeniería y catálogo extendido de 15+ servidores Model Context Protocol (MCP).",
  "news.fixTitle": "Correcciones",
  "news.fix1": "Solucionada la pérdida de estado y reinicio de inputs en el iframe del sandbox al cambiar entre pestañas del editor.",
  "news.fix2": "Prevenidos bucles infinitos y bloqueos de sesión cuando un modelo genera argumentos de herramientas idénticos repetidamente.",
  "news.fix3": "Corregida la fuga de etiquetas de pensamiento sin cerrar en la ventana de chat para modelos de razonamiento.",
  ...
  "dl.sub": "Tiancode 1.0.38 para Windows 10 y 11 (64 bits). Gratis, sin registro. El instalador y la versión portable son el mismo software: elige el que mejor se adapte a tu flujo.",
  ...
  "hero.metaReleaseVal": "Septiembre 2026 · v1.0.38",
  ...
  "downloads.installerF1": "Actualizaciones automáticas no destructivas (v1.0.38+)",
  ...
  "footer.status": "Todos los Sistemas Operativos · Desktop v1.0.38",
  ...
  "page.description": "Tiancode v1.0.38: Sovereign, local-first agentic coding desktop app for Windows with multi-agent swarms, OpenClaw resilience, Hermes Agent memory, Connections Gateway (WhatsApp/Telegram/Discord/Slack), OpenDesign UI engine, and Sandbox Keep-Alive.",
  "loader.text": "Loading Tiancode v1.0.38…",
  "nav.showcase": "Studio",
  ...
  "hero.badge": "v1.0.38 · Local-first AI agent",
  "hero.tagline": "Your AI coding assistant, right in your terminal.",
  "hero.sub": "AI agents with OpenClaw & Hermes, Connections Gateway, OpenDesign UI, Sandbox Keep-Alive, 52+ skills, and local GGUF models on Windows.",
  "hero.ctaDownload": "Download Tiancode.exe (v1.0.38)",
  ...
  "preview.sub": "This is Tiancode v1.0.38: Live Preview with Sandbox Keep-Alive, interactive DOM Inspector, integrated terminal, Connections Gateway, and skills.",
  ...
  "stats.sub": "Real numbers from version 1.0.38.",
  ...
  "docs.s1p": "Tiancode 1.0.38 ships in two formats for Windows 10 and 11 (64-bit):",
  ...
  "guide.s1d": "Pick the NSIS installer (~375 MB) or the portable build (~375 MB) from the download page. Version 1.0.38 supports Windows 10 and 11.",
  ...
  "news.sub": "Everything Tiancode v1.0.38 brings: Connections Gateway, OpenClaw Resilience, Hermes Agent Memory, OpenDesign UI, and Sandbox Keep-Alive.",
  "news.v1": "Version 1.0.38",
  "news.date": "September 6, 2026",
  "news.chip": "Latest release",
  "news.newTitle": "Major New Features in v1.0.38",
  "news.new1": "Connections (Messaging & API Gateway): Pair WhatsApp (interactive pairing code TIAN-XXXX-WAPP), Telegram Bot (pairing and live test ping), Discord, Slack, and custom Webhooks with HMAC-SHA256 signature verification.",
  "news.new2": "OpenClaw Resilience: Syntactic JSON tool-call auto-repair for broken LLM responses, and advanced infinite loop detector with SHA-256 call hashing (intelligent circuit breaker at 25 repeat calls).",
  "news.new3": "Hermes Agent Intelligence & Memory: Deep SQLite historical search (session_search), Head/Tail context compaction preserving goals and recency, and real-time streaming scrubber for <think> reasoning tags (DeepSeek R1 / Qwen QwQ).",
  "news.new4": "OpenDesign UI Engine: Anti-AI slop design rules, 3-dial taste calibration (DESIGN_VARIANCE, MOTION_INTENSITY, VISUAL_DENSITY), and tactile micro-interactions (Emil Kowalski).",
  "news.new5": "Sandbox Keep-Alive & DOM Inspector: 100% state, inputs, and scroll retention when toggling between Code and Live Preview without iframe reload, real-time pixel bounding box inspector (Ctrl+Alt+I), and 1-click 'Fix with Tiancode' white screen detector.",
  "news.new6": "Canonical Design Presets & Typography: Strict 3-weight typographic discipline and 4 canonical presets: Linear Dark, Claude Editorial, Vercel Precision, and Stripe Modern.",
  "news.impTitle": "Improvements in v1.0.38",
  "news.imp1": "Automatic non-destructive updates (v1.0.38+): keeps all your active provider keys, sessions, and configurations intact.",
  "news.imp2": "Blazing fast integrated terminal with clean PTY process tree termination and multi-shell capabilities.",
  "news.imp3": "Streaming extraction and isolation of reasoning blocks for DeepSeek and Qwen models without polluting visible history.",
  "news.imp4": "Live preview performance optimization with rasterization nudges and white screen self-healing.",
  "news.imp5": "Expanded catalog of 52+ software engineering skills and 15+ Model Context Protocol (MCP) servers.",
  "news.fixTitle": "Fixes",
  "news.fix1": "Fixed form input state loss and iframe reset in Sandbox when toggling back and forth from the code editor.",
  "news.fix2": "Prevented infinite loops and agent freezing when models generate identical repetitive tool arguments.",
  "news.fix3": "Eliminated unescaped thinking tag leakage in chat transcripts for reasoning models.",
  ...
  "dl.sub": "Tiancode 1.0.38 for Windows 10 and 11 (64-bit). Free, no sign-up required. The installer and the portable build are the same software: pick the one that fits your workflow.",
  ...
  "dl.news": "What is new in 1.0.38? Read the changelog.",
  "nav.overview": "Overview",
  "nav.capabilities": "Capabilities",
  "nav.benchmarks": "Benchmarks",
  "nav.architecture": "Architecture",
  "nav.downloadPill": "Download v1.0.38",
  "hero.cosmicLeft": "TIAN",
  "hero.cosmicRight": "CODE",
  "hero.cosmicReplayAria": "Restart cosmic TIANCODE animation",
  "hero.cosmicBadge": "COSMIC INTELLIGENCE MODEL · TIANCODE 1.0.38",
  "hero.eyebrowPill": "PRODUCT ANNOUNCEMENT",
  "hero.eyebrowMeta": "SEPTEMBER 2026 · TIANCODE 1.0.38",
  ...
  "hero.metaReleaseVal": "September 2026 · v1.0.38",
  ...
  "downloads.installerF1": "Automatic non-destructive updates (v1.0.38+)",
  ...
  "footer.status": "All Systems Operational · Desktop v1.0.38",
  "footer.ecosystem": "Ecosistema",
