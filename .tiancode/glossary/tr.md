...
- `Tiancode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `tiancode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Tiancode` in prose, `tiancode` only for exact technical identifiers
...
- Avoid changing `tiancode` to `Tiancode` inside commands, URLs, package names, or code literals
