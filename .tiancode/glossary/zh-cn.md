...
- `Tiancode` (preserve casing in prose; keep `tiancode` only when it is part of commands, package names, paths, or code)
- `Tiancode Zen`
- `Tiancode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `tiancode` in prose when referring to the product name; use `Tiancode`
