...
Desktop application and browser-based app issues, including `tiancode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core tiancode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Tiancode Zen, Tiancode Go, and billing issues.
